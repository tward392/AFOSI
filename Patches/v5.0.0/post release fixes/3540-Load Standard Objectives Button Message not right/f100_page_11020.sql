...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:17 Friday February 4, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110204131601',
...
declare
  ...
  l_length number := 1;
begin
p:=p||':SUCCESS_MSG:=to_char(osi_generic_file.load_standard_objectives(:p0_obj)) || '' standard objectives loaded.'';';
