...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:19 Tuesday February 8, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110208071803',
...
wwv_flow_api.create_page_button(
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '',
  p_button_condition=> ':P0_OBJ_TYPE_CODE = ''ACT.FINGERPRINT.MANUAL'''||chr(10)||
'AND'||chr(10)||
':P0_WRITABLE=''Y''',
  p_button_condition_type=> 'PLSQL_EXPRESSION',
...
wwv_flow_api.create_page_item(
  ...
  p_label_alignment  => 'LEFT',
  p_field_alignment  => 'LEFT',
  p_display_when=>':P0_WRITABLE=''Y'' and :P22705_PARTIC_VER is null',
