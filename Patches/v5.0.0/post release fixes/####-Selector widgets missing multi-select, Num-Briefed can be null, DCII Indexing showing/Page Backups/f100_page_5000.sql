...
wwv_flow_api.create_page_item(
  ...
  p_post_element_text=>'<a href="javascript:popupLocator(350,''P5000_PERSONNEL'',''N'');">&ICON_LOCATOR.</a>'||chr(10)||
'',
...
''||chr(10)||
'<a href="javascript:popup({page:150,name:''PRSNLLOC&P0_OBJ.'',clear_cache:''150'',item_names:''P150_VIEW,P150_RETURN_ITEM'',item_values:''OSI.LOC.PERSONNEL,P5000_PERSONNEL''});">&ICON_LOCATOR.</a>');
