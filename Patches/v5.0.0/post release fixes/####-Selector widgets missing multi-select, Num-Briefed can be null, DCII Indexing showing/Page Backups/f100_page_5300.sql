...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101129141642',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '29-Nov-2010 J.Faris - fixed type on js button attribute for &BTN_EXPORT. (High Risk Org region).');
...
wwv_flow_api.create_page_button(
  ...
  p_button_redirect_url=> 'javascript:popupLocator(400,''P5300_SEL_PARTICIPANT'',''N'',''&P5300_EXCLUDE.'',''OPEN'',''P400_PARTIC_TYPE_LIST'',''~PART.NONINDIV.COMP~PART.NONINDIV.ORG~'');',
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:popupLocator(400,''P5300_SEL_PARTICIPANT'',''N'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:popupLocator(400,''P5300_SEL_PARTICIPANT'',''N'','''',''PART.NONINDIV.ORG'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_redirect_url=> 'javascript:popupLocator(400,''P5300_SEL_PARTICIPANT'',''N'',''&P5300_EXCLUDE.'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5300,
  p_branch_action=> 'f?p=&APP_ID.:5300:&SESSION.:&REQUEST.:&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
'    if (:request = ''P5300_SEL_PARTICIPANT'') then'||chr(10)||
'        :p5300_participant_ver := osi_participant.get_current_version(:p5300_sel_participant);'||chr(10)||
''||chr(10)||
'        if (:p5300_role_count = 1 and :p0_obj_type_code <> ''ACT.BRIEFING'') then'||chr(10)||
'            insert into t_osi_partic_involvement'||chr(10)||
'                        (obj, participant_version, involvement_role)'||chr(10)||
'                 v';

p:=p||'alues (:p0_obj, :p5300_participant_ver, :p5300_role)'||chr(10)||
'              returning sid'||chr(10)||
'                   into :p5300_sid;'||chr(10)||
'             /* clear the DIRTY variable for the page, and '||chr(10)||
'                    apply title substitution, if applicable  */'||chr(10)||
...
'            insert into t_dcii_intentions'||chr(10)||
'                        (fyle, participant, include_in_index)'||chr(10)||
'                 values (:p5300_obj, :p5300_sel_participant, ''Y'');'||chr(10)||
...
p:=p||' ''~'' || x.participant_version;'||chr(10)||
'    end loop;'||chr(10)||
''||chr(10)||
