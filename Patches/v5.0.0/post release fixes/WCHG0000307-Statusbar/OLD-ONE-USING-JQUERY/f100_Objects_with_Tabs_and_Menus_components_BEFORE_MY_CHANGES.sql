...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:56 Wednesday December 8, 2010
--   Exported By:     TWARD
--   Flashback:       0
...
c1:=c1||'hort: [''Sun'',''Mon'',''Tue'',''Wed'',''Thu'',''Fri'',''Sat''],'||chr(10)||
...
'<script src="#IMAGE_PREFIX#jquery/dime';

c1:=c1||'nsions/jquery.dimensions.js" type="text/javascript"></script>'||chr(10)||
...
c1:=c1||'erHelp'').each( function(i) {'||chr(10)||
