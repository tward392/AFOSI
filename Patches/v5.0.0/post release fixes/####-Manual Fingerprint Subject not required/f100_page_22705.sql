...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:41 Tuesday February 1, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110201073711',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22705,
  p_branch_action=> 'f?p=&APP_ID.:22705:&SESSION.:&REQUEST.:&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(400,''P22705_PARTIC_VER'',''N'',''&P22705_PARTIC_VER.'',''PART.INDIV'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  ...
  p_label_alignment  => 'LEFT',
  p_field_alignment  => 'LEFT',
  p_display_when=>':P0_OBJ_TYPE_CODE = ''ACT.FINGERPRINT.MANUAL''',
...
wwv_flow_api.create_page_item(
  ...
  p_field_alignment  => 'LEFT',
  p_display_when=>':P22105_PARTIC_VER is null and'||chr(10)||
':P0_OBJ_TYPE_CODE = ''ACT.FINGERPRINT.MANUAL''',
  p_display_when_type=>'SQL_EXPRESSION',
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
