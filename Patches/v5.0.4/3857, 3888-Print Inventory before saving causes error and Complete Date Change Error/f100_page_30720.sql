...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:00 Wednesday July 13, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
ph:=ph||'               '':OPEN:NO:30700:P0_OBJ:&P0_OBJ.'';'||chr(10)||
'   }'||chr(10)||
'}'||chr(10)||
''||chr(10)||
...
ph:=ph||'ocator(350,''NEW_AGENT_INVOLVED_SID'',''N'');'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110713075615',
...
'                                 Added a Condition to the print button.');
...
wwv_flow_api.create_page_process(
  ...
  p_process_when=>':P30720_INVENTORY_REASON_CODE in (''ACC'',''PCC'')'||chr(10)||
'AND'||chr(10)||
':REQUEST NOT IN (''P30720_INVENTORY_REASON_SID'')'||chr(10)||
'AND'||chr(10)||
':REQUEST NOT LIKE ''EDIT_%''',
