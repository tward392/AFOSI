...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:22 Friday September 2, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20110902102548',
...
'     $v(''P30710_EV_STATUS'')==''S'')'||chr(10)||
'    vOk = confirm(''You can no longer edit the Description once you '' +'||chr(10)||
'                      ''exit this form.  Do you want to continue?'');'||chr(10)||
'     '||chr(10)||
'   if (vOk)'||chr(10)||
'     {'||chr(10)||
'      if($v(''P30710_AUTO_PRINT_TAG'')==''I2MS'')'||chr(10)||
'        {'||chr(10)||
'javascript';

ph:=ph||':newWindow({page:800,clear_cache:'''',name:'''',item_names:''P800_REPORT_TYPE,P0_OBJ,P800_PARAM_2'',item_values:''&P30710_I2MS_RPT.,&P0_OBJ.,&P30710_SEL_EVIDENCE.,'',request:''OPEN''});'||chr(10)||
'       }'||chr(10)||
''||chr(10)||
'      if($v(''P30710_AUTO_PRINT_TAG'')==''AFF52'')'||chr(10)||
'        {'||chr(10)||
'javascript:newWindow({page:800,clear_cache:'''',name:'''',item_names:''P800_REPORT_TYPE,P0_OBJ,P800_PARAM_2'',item_values:''&P30710_ORIG_RPT.,&P0_OBJ.,&P30710_SEL_E';

ph:=ph||'VIDENCE.,'',request:''OPEN''});'||chr(10)||
'       }'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'TWARD',
  p_last_upd_yyyymmddhh24miss => '20110902090143',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
...
'                                   New Close Button for Error Region.');
...
wwv_flow_api.create_page_plug (
  ...
  p_plug_display_when_condition => ':P30710_ERRORS is null and :P30710_EV_STATUS=''S''',
  p_plug_header=> '<center>',
  p_plug_footer=> '</center>',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
  p_plug_comment=> ' ---and :P30710_TRANS_TYPE = ''LOGIN''');
end;
/
declare
  s varchar2(32767) := null;
...
'            osi_evidence.reject_evi';

p:=p||'dence(core_list.get_list_element(:p30710_trans_sids, 1),'||chr(10)||
'                                            :p30710_effective_date,'||chr(10)||
'                                            :p30710_purpose);'||chr(10)||
'        else'||chr(10)||
'            null;'||chr(10)||
...
p:=p||'and description = ''I2MS Version'';'||chr(10)||
'         end if;'||chr(10)||
''||chr(10)||
'         if :P30710_ORIG_RPT is null then'||chr(10)||
...
'         :P30710_STORAGE_LOCATION := v_evide';

p:=p||'nce.storage_location;'||chr(10)||
...
p:=p||'SE := ''Recalling Transferred Evidence'';'||chr(10)||
'               else'||chr(10)||
...
p:=p||'30710_TITLE := ''Log Out'';'||chr(10)||
...
'         :P30710_PURPOSE := ''Derivative Evidence from Tag Number';
...
p:=p||'30710_TITLE := ''Dispose'';'||chr(10)||
