...
--- Changes:                                                ---
---                                                         ---
---  1.  New Table T_OSI_A_INIT_NOTIF_OFFENSE               ---
---  2.  New Tab for Initial Notification Activity          ---
---  3.  Changes to Page 11130 (auto load specs)            ---
---  4.  New Page (22007) for Initial Notification Activity ---
---  5.  OSI_INVESTIGATION (SPEC and BODY)                  ---
---  6.  OSI_INIT_NOTIFICATION (SPEC ONLY)                  ---
---                                                         ---
---------------------------------------------------------------
...
INSERT INTO T_OSI_TAB ( SID, OBJ_TYPE, TAB_LEVEL, PARENT_TAB, SEQ, TAB_LABEL, PAGE_NUM, IS_DEFAULT, TAB_PARAMS, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACTIVE, AUTH_ACTION, OVERRIDE ) VALUES ( '33317NLM', '22200000KZN', 2, '22200000L0O', 15, 'Matters Investigated', 22007, 'N', NULL, 'timothy.ward',  TO_Date( '07/06/2011 11:44:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/06/2011 11:44:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'Y', NULL, 'N'); 
COMMIT;
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:50 Thursday July 7, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110707075027',
...
'                               Notification.'||chr(10)||
'                                Changed Auto Load Specs process.');
...
'begin'||chr(10)||
''||chr(10)||
' osi_investigation.auto_load_specs(:P0_OBJ);'||chr(10)||
''||chr(10)||
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:04 Thursday July 7, 2011
--   Exported By:     TWARD
--   Flashback:       0
--   Export Type:     Page Export
--   Version: 3.2.0.00.27
...
PROMPT ...Remove page 22007
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>22007);
 
end;
/

 
--application/pages/page_22007
prompt  ...PAGE 22007: Matters Investigated - Initial Notification
--
...
wwv_flow_api.create_page(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> '',
  p_name   => 'Matters Investigated - Initial Notification',
  p_step_title=> 'Matters Investigated - Initial Notification',
  p_html_page_onload=>'onLoad="javascript:setFocus(''P22007_OFFENSE_CODE'');"',
  p_step_sub_title => 'Matters Investigated - Initial Notification',
  p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS',
...
' {'||chr(10)||
'  var mode = document.getElementById(''P22007_MODE'');'||chr(10)||
'  var ele = document.getElementById(PageItem);'||chr(10)||
''||chr(10)||
'  //var ele_selector = document.getElementById(''P22007_OFFENSE_SELECTOR'');'||chr(10)||
''||chr(10)||
...
' {'||chr(10)||
'  var excludes = document.getElementById(''P22007_EXCLUDE_SIDS'');'||chr(10)||
'  var ele_selector = document.getElementById(''P22007_OFFENSE_SELECTOR'');'||chr(10)||
''||chr(10)||
'  if(ele_selector!=null)'||chr(10)||
'    {'||chr(10)||
'     popupLocator(550,''P22007_OFFENSE'',''Y'', excludes.value);'||chr(10)||
'    }'||chr(10)||
' }'||chr(10)||
'</script>',
  p_footer_text => '<script type="text/javascript">'||chr(10)||
'  if(''&REQUEST.'' == ''CREATE'' && ''&P22007_SEL_OFFENSE.'' == ''''){'||chr(10)||
...
'    if(   ''&P22007_PRIMARY_EXISTS.'' == ''Y'''||chr(10)||
'       && ''&P22007_PRIORITY.'' == ''&P22007_PRIMARY_SID.''){'||chr(10)||
'      if(window.confirm(message)){'||chr(10)||
'        $s(''P22007_NEW_PRIMARY'',''Y'');'||chr(10)||
'      }else{'||chr(10)||
'        $s(''P22007_NEW_PRIMARY'',''N'');'||chr(10)||
...
'</script>',
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'TWARD',
  p_last_upd_yyyymmddhh24miss => '20110707070442',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '07-Jul-2011  Tim Ward      CR#3571 - Add Matters Investigated '||chr(10)||
'                                    (Offenses) to Initial Notification.'||chr(10)||
'                                    Copied from 11120 (Investigations).');
 
wwv_flow_api.set_html_page_header(p_flow_id=>wwv_flow.g_flow_id,p_flow_step_id=>22007,p_text=>ph);
end;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 6613310884161139 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22007,
  ...
  p_plug_display_when_condition => ':P22007_SEL_OFFENSE is not null or :P22007_MODE = ''ADD''',
  p_pagination_display_position=>'BOTTOM_RIGHT',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
  p_plug_comment=> '');
...
'       decode(:P22007_SEL_OFFENSE, io.sid, ''Y'', ''N'') "Current"'||chr(10)||
'  from t_osi_a_init_notif_offense io,'||chr(10)||
'       t_dibrs_offense_type off,'||chr(10)||
'       t_osi_reference pri'||chr(10)||
' where';

s:=s||' io.activity = :P0_OBJ'||chr(10)||
'   and io.offense = off.sid'||chr(10)||
'   and pri.sid(+) = io.priority';

wwv_flow_api.create_report_region (
  p_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22007,
  p_name=> 'Offenses',
  p_region_name=>'',
  ...
  p_query_desc_image=> 'arrow_up_gray_dark.gif',
  p_query_desc_image_attr=> 'width="13" height="12" alt=""',
  p_plug_query_exp_filename=> '&P22007_EXPORT_NAME.',
  p_plug_query_strip_html=> 'Y',
  p_comment=>'');
end;
/
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6613704249161144 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'SID',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6613815080161145 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6613919638161145 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6614024335161145 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6614102049161145 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6614214189161145 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6614302605161145 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 6614401385161145 + wwv_flow_api.g_id_offset,
  p_region_id=> 6613528668161142 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 6615323263161148 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22007,
  p_button_sequence=> 50,
  p_button_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
  p_button_name    => 'ADD',
  p_button_image   => 'template:'||to_char(179221063608554498+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 6615105845161147 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22007,
  p_button_sequence=> 10,
  p_button_plug_id => 6613310884161139+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(179221063608554498+wwv_flow_api.g_id_offset),
  p_button_image_alt=> '&BTN_SAVE.',
  p_button_position=> 'REGION_TEMPLATE_CREATE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '',
  p_button_condition=> 'P22007_SEL_OFFENSE',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 6615511405161148 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22007,
...
wwv_flow_api.create_page_button(
  p_id             => 6615717256161148 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22007,
...
wwv_flow_api.create_page_button(
  p_id             => 6616105646161148 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22007,
  p_button_sequence=> 70,
  p_button_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
  ...
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:void(0);',
  p_button_cattributes=>'onclick="javascript:getCSV(null, this,22007);"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 6616315808161148 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22007,
  p_button_sequence=> 20,
  p_button_plug_id => 6613310884161139+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>6622628825161165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_branch_action=> 'f?p=&APP_ID.:&TAB_PAGE.:&SESSION.:TAB:&DEBUG.:&TAB_PAGE.::',
  p_branch_point=> 'AFTER_PROCESSING',
...
wwv_flow_api.create_page_branch(
  p_id=>6622422721161164 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_branch_action=> 'f?p=&APP_ID.:22007:&SESSION.:&REQUEST.:&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_sequence=> 20,
  p_save_state_before_branch_yn=>'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>6616507726161150 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_OFFENSE_SELECTOR',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 105,
  p_item_plug_id => 6613310884161139+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_post_element_text=>'<a href="javascript:popupLocator(550,''P22007_OFFENSE'',''Y'', ''&P22007_EXCLUDE_SIDS.'');">&ICON_LOCATOR.</a>'||chr(10)||
'',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  ...
  p_label_alignment  => 'RIGHT',
  p_field_alignment  => 'LEFT',
  p_display_when=>'P22007_SEL_OFFENSE',
...
begin
wwv_flow_api.create_page_item(
  p_id=>6616718895161150 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_EXPORT_NAME',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 5,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'HIDDEN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>6616906368161150 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_PRIMARY_EXISTS',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'P22007_PRIMARY_EXISTS=',
  p_source_type=> 'STATIC',
  p_display_as=> 'HIDDEN',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>6617123528161151 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_NEW_PRIMARY',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 15,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6617331625161151 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_PRIMARY_SID',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6617523917161151 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_EXCLUDE_SIDS',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 130,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6617705765161151 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_SEL_OFFENSE',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 25,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6617917198161151 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_ACTIVITY',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6618103599161151 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_OFFENSE',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 35,
  p_item_plug_id => 6613528668161142+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6618319852161151 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_OFFENSE_CODE',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 100,
  p_item_plug_id => 6613310884161139+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6618531401161153 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_OFFENSE_DESCRIPTION',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 110,
  p_item_plug_id => 6613310884161139+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6618728354161153 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_PRIORITY',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 120,
  p_item_plug_id => 6613310884161139+wwv_flow_api.g_id_offset,
...
'end;',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'COMBOBOX',
  p_lov => 'STATIC2:&P22007_PRIORITY_LOV.',
  p_lov_columns=> 1,
  p_lov_display_null=> 'YES',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>6618924503161153 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_PRIORITY_LOV',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 115,
  p_item_plug_id => 6613310884161139+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>6619119678161153 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_name=>'P22007_MODE',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 6619423052161155 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_computation_sequence => 10,
  p_computation_item=> 'P22007_PRIMARY_EXISTS',
  p_computation_point=> 'AFTER_SUBMIT',
  p_computation_type=> 'QUERY',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'select decode(count(sid), 0, ''N'', ''Y'')'||chr(10)||
'  from t_osi_a_init_notif_offense o'||chr(10)||
' where o.activity = :p0_obj and o.priority = osi_reference.lookup_ref_sid(''OFFENSE_PRIORITY'', ''P'');',
  p_compute_when => '',
  p_compute_when_type=>'');
...
wwv_flow_api.create_page_computation(
  p_id=> 6619628960161155 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22007,
  p_computation_sequence => 10,
  p_computation_item=> 'P22007_PRIMARY_SID',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'PLSQL_EXPRESSION',
  p_computation_processed=> 'REPLACE_EXISTING',
...
wwv_flow_api.create_page_validation(
  p_id => 6619816789161155 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_validation_name => 'P22007_OFFENSE not null',
  p_validation_sequence=> 10,
  p_validation => 'P22007_OFFENSE_DESCRIPTION',
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => 'Offense must be specified.',
  p_validation_condition=> 'CREATE,SAVE',
  p_validation_condition_type=> 'REQUEST_IN_CONDITION',
  p_associated_item=> 6618319852161151 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 6620012450161158 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_validation_name => 'P22007_PRIORITY not null',
  p_validation_sequence=> 20,
  p_validation => 'P22007_PRIORITY',
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => 'Priority must be specified.',
  p_validation_condition=> 'CREATE,SAVE,DELETE',
  p_validation_condition_type=> 'REQUEST_IN_CONDITION',
  p_associated_item=> 6618728354161153 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
'        insert into t_osi_a_init_notif_offense'||chr(10)||
'                    (activity, offense, priority)'||chr(10)||
'             values (:p22007_activity, :p22007_offense, :p22007_priority)'||chr(10)||
'          returning sid'||chr(10)||
'               into :p22007_sel_offense;'||chr(10)||
''||chr(10)||
'        if (:p22007_new_primary = ''Y'') then'||chr(10)||
'            update t_osi_a_init_notif_offense'||chr(10)||
'               set priority = ';

p:=p||'osi_reference.lookup_ref_sid(''OFFENSE_PRIORITY'', ''R'')'||chr(10)||
'             where activity = :p0_obj'||chr(10)||
'               and priority = :p22007_primary_sid'||chr(10)||
'               and sid <> :p22007_sel_offense;'||chr(10)||
'        end if;'||chr(10)||
'    elsif(:request = ''SAVE_SP'') then'||chr(10)||
'        if (:p22007_new_primary = ''Y'') then'||chr(10)||
'            update t_osi_a_init_notif_offense'||chr(10)||
'               set priority = osi_reference.lookup_ref_sid(''OFFENSE_';

p:=p||'PRIORITY'', ''R'')'||chr(10)||
'             where activity = :p0_obj'||chr(10)||
'               and priority = :p22007_primary_sid'||chr(10)||
'               and sid <> :p22007_sel_offense;'||chr(10)||
''||chr(10)||
'            update t_osi_a_init_notif_offense'||chr(10)||
'               set priority = :p22007_primary_sid'||chr(10)||
'             where sid = :p22007_sel_offense;'||chr(10)||
'        else'||chr(10)||
'            update t_osi_a_init_notif_offense'||chr(10)||
'               set offense = :p22007_offense,'||chr(10)||
' ';

p:=p||'                  priority = :p22007_priority'||chr(10)||
'             where sid = :p22007_sel_offense;'||chr(10)||
'        end if;'||chr(10)||
'    elsif(:request = ''DELETE'') then'||chr(10)||
'         '||chr(10)||
'         delete from t_osi_a_init_notif_offense where sid = :p22007_sel_offense;'||chr(10)||
''||chr(10)||
'    end if;'||chr(10)||
''||chr(10)||
'end;';
...
wwv_flow_api.create_page_process(
  p_id     => 6621112881161159 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
...
declare
  ...
  l_length number := 1;
begin
p:=p||':P22007_SEL_OFFENSE := substr(:REQUEST,6);';

wwv_flow_api.create_page_process(
  p_id     => 6621330465161161 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
'        :p22007_sel_offense := null;'||chr(10)||
'    end if;'||chr(10)||
''||chr(10)||
'    if (:request in (''ADD'', ''DELETE'', ''CANCEL'') or :request like ''EDIT_%'') then'||chr(10)||
'        :p22007_offense := null;'||chr(10)||
'        :p22007_priority := null;'||chr(10)||
'    end if;'||chr(10)||
''||chr(10)||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 6621503211161161 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'if :request in (''ADD'',''CREATE'',''P22007_OFFENSE'') then'||chr(10)||
'  :p22007_mode := ''ADD'';'||chr(10)||
'else'||chr(10)||
'  :p22007_mode := null;'||chr(10)||
'end if;';

wwv_flow_api.create_page_process(
  p_id     => 6621700889161161 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
...
'             usage = ''PARTICIPANTS'' and';

p:=p||' '||chr(10)||
'             obj_type = core_obj.lookup_objtype(''ACT.INIT_NOTIF'');'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_process(
  p_id     => 6621925822161161 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 50,
  p_process_point=> 'AFTER_SUBMIT',
...
''||chr(10)||
'begin'||chr(10)||
'     v_temp := replace(:P22007_OFFENSE, '':'', ''~'');'||chr(10)||
''||chr(10)||
...
'     select count(*) into v_prime_count from t_osi_a_init_notif_offense'||chr(10)||
'       where activity=:p0_obj and priority=v_prime_role;'||chr(10)||
''||chr(10)||
'     for i in 1 .. core_list.count_list_elements(v_temp)'||chr(10)||
'     loop'||chr(10)||
'         v_off_sid := core_list.get_list_element(v_temp,i); '||chr(10)||
'         '||chr(10)||
'         select count(*) into v_off_count from t_osi_a_init_notif_offense '||chr(10)||
'      ';

p:=p||'         where activity=:p0_obj and offense=v_off_sid;'||chr(10)||
'         '||chr(10)||
'         if v_off_count = 0 then'||chr(10)||
''||chr(10)||
'           if v_prime_count = 0 then'||chr(10)||
''||chr(10)||
'             insert into t_osi_a_init_notif_offense (activity, offense, priority)'||chr(10)||
'                        values (:p0_obj, v_off_sid, v_prime_role)'||chr(10)||
'                              returning sid into :P22007_SEL_OFFENSE;'||chr(10)||
''||chr(10)||
'             v_prime_count := v_prime_count ';
...
wwv_flow_api.create_page_process(
  p_id     => 6620903962161159 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 60,
  p_process_point=> 'AFTER_SUBMIT',
...
begin
p:=p||'begin'||chr(10)||
'    :p22007_primary_sid := osi_reference.lookup_ref_sid(''OFFENSE_PRIORITY'', ''P'');'||chr(10)||
''||chr(10)||
'    select decode(count(sid), 0, ''N'', ''Y'')'||chr(10)||
'      into :p22007_primary_exists'||chr(10)||
'      from t_osi_a_init_notif_offense o'||chr(10)||
'     where o.activity = :p0_obj and o.priority = :p22007_primary_sid;'||chr(10)||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 6622125445161162 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 1,
  p_process_point=> 'BEFORE_HEADER',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:T_OSI_A_INIT_NOTIF_OFFENSE:P22007_SEL_OFFENSE:SID';

wwv_flow_api.create_page_process(
  p_id     => 6620317060161158 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 10,
  p_process_point=> 'BEFORE_HEADER',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when=>'P22007_SEL_OFFENSE',
  p_process_when_type=>'ITEM_IS_NOT_NULL',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
...
declare
  ...
  l_length number := 1;
begin
p:=p||':P22007_PRIORITY_LOV := osi_reference.get_lov(''OFFENSE_PRIORITY'', :P22007_PRIORITY);';

wwv_flow_api.create_page_process(
  p_id     => 6620514039161159 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 20,
  p_process_point=> 'BEFORE_HEADER',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when=>':P22007_SEL_OFFENSE is not null or :P22007_MODE = ''ADD''',
  p_process_when_type=>'PLSQL_EXPRESSION',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
...
'                FROM t_osi_a_init_notif_offense O'||chr(10)||
'               WHERE O.activity = :p0_obj)'||chr(10)||
'    loop'||chr(10)||
'        v_sid_list := v_sid_list || ''~'' || k.offense;'||chr(10)||
'    end loop;'||chr(10)||
''||chr(10)||
'    :p22007_exclude_sids := v_sid_list;'||chr(10)||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 6620724273161159 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22007,
  p_process_sequence=> 60,
  p_process_point=> 'BEFORE_HEADER',
...
---------------------------------------
-- ...updatable report columns for page 22007
--
...
--        return clob;
    ...
    procedure auto_load_specs(p_obj in varchar2);
...
begin
     ...
     loop
         ...
         osi_investigation.auto_load_specs(v_file_sid);
