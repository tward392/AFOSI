...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:49 Thursday June 30, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20110609075550',
...
'                                   unarchived to the unit that owns it, only'||chr(10)||
'                                   to another unit.'||chr(10)||
'                                   Changed "Pre-Load Status Change'||chr(10)||
'                                   Information" to default unit to current,'||chr(10)||
'                                   if we are doing an "UNARCHIVE" and to not'||chr(10)||
'                                   exclude the current unit at all for any'||chr(10)||
'                                   status changes.');
