...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:47 Thursday June 23, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
c1:=c1||'EFIX#jquery/cluetip-0.9.8/jquery.cluetip.js" type="text/javascript"></script>'||chr(10)||
' '||chr(10)||
'<script type="text/javascript">'||chr(10)||
'//<![CDATA['||chr(10)||
' '||chr(10)||
...
'            get.add(''TEMP_ITEM'', $item.';

c1:=c1||'attr(''for''));'||chr(10)||
...
c1:=c1||'uery/Hover help stuff -->'||chr(10)||
'</head>'||chr(10)||
