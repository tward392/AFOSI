...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:45 Thursday June 23, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101027100240',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '07-OCT-2010 J.FARIS WCHG0000360 - Split out times from date picker, new update time process.');
...
''||chr(10)||
':P11130_ENTRY_METHOD_LOV := di';

p:=p||'brs_reference.get_lov(''ENTRY_METHOD'',:P11130_ENTRY_METHOD);'||chr(10)||
''||chr(10)||
...
p:=p||'ffense_location_type'||chr(10)||
...
p:=p||'_NUM_PREM_ENTERED := null;'||chr(10)||
'   :P11130_MULTI_ENTRIES_STATE := :DISABLE_TEXT;'||chr(10)||
'end if;';
