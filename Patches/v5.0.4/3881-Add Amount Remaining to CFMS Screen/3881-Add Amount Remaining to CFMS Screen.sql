INSERT INTO T_HTML_TEMPLATE ( NAME, DT, FLOWERBOX, MODIFY_BY, MODIFY_ON ) VALUES ( 'cfunds_home_page_guts',  TO_Date( '07/25/2011 07:30:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 'HQSBUXIID0726A',  TO_Date( '07/25/2011 07:30:56 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
COMMIT;
...
*/
    ...
    PROCEDURE begin_serve_page(
        ppagetitle        IN   VARCHAR2 := 'C-Funds',
    ...
    BEGIN
        ...
        vp_ci_comments :=
            NVL(Web_Util_Pkg.get_flex_parameter(name_array, value_array, 'pCIComments'),
                'System generated comment: Update done using CFMS.');
        vp_sia_comments :=
        ...
        begin_serve_page('C-Funds Adjust AFOSI Limitations',
                         TRUE,
                         TRUE,
                         ' ',
                         'C-Funds Adjust AFOSI Limitations',
                         'DoHistory');
...
--  Query Processing/General
    ...
    BEGIN
        ...
        --v_self := '!' || WEB_UTIL_PKG.Get_Self;
        v_self := '!' || REPLACE(Web_Util_Pkg.get_self, '!', '');
        begin_serve_page('C-Funds AFOSI Limitations List',
                         TRUE,
                         TRUE,
                         ' ',
                         'C-Funds AFOSI Limitations List',
                         'DoHistory');
    ...
    BEGIN
        ...
        begin_serve_page('C-Funds Advances by Personnel',
                         TRUE,
                         TRUE,
                         ' ',
                         'C-Funds Advances by Personnel',
                         'home_page');
...
--    setvparams(v_params); -- not used here, because this only is used for pages where the previous page has filters.
    ...
    BEGIN
        IF pparams IS NULL THEN
            begin_serve_page('C-Funds Advance Details',
                             TRUE,
                             TRUE,
                             ' ',
                             'C-Funds Advance Details',
                             'Home_Page');
        ELSE
            begin_serve_page('C-Funds Advance Details',
                             TRUE,
...
-- EFT Information
    ...
    BEGIN
        Web_Util_Pkg.send_comment('Current user: ' || Core_Context.personnel_name);
        begin_serve_page('C-Funds EFT Info', TRUE, TRUE, ' ', 'C-Funds EFT Info', 'DoHistory');
...
-- xxx find next and prev in one shot, no workie
        ...
        IF ppersid IS NULL THEN
            begin_serve_page('C-Funds Expense Details',
                             TRUE,
                             TRUE,
                             ' ',
                             'C-Funds Expense Details',
                             'Home_Page');
        ELSE
            begin_serve_page('C-Funds Expense Details',
                             TRUE,
...
--        v_ok := WEB_TEMPLATE_PKG.Replace_Tag( v_template, 'CFUNDS_CUST_NAME_UNIT', ' ??? how to find this ???' );
    ...
    PROCEDURE expenses_by_personnel(
        ...
        BEGIN
            ...
            v_form_caption := 'C-Funds Expenses by Personnel';
            v_unit_constructor := ' for ';
            RETURN 'FilteredList';
        END get_form_usage;
    BEGIN
...
--                OWA_CORE_LISTPRINT(V_CURSOR, 'pUnitPick', 1, FALSE);
    ...
    BEGIN
        ...
        -- find the name of this unit whose expenses are showing.
        v_unit_name := Cfunds_Pkg.lookup_cfunds_unit(v_unit).unit_name;
        begin_serve_page('C-Funds Expenses for Individual in ' || v_unit_name,
                         TRUE,
                         TRUE,
                         NULL,
                         'C-Funds Expenses for Individual',
    ...
    BEGIN
        ...
        -- since there isn't a priv for accessing C-Funds Custodian
        ...
        begin_serve_page('C-Funds Validate Claimant in ' || v_unit_name,
                         FALSE,
                         FALSE,
                         'C-Funds Validate Claimant',
                         'in ' || v_unit_name);
        ...
        BEGIN
         ...
         NOT EXISTS (SELECT 'x' FROM T_CFUNDS_XFR x1, T_CFUNDS_XFR_EXP e1 WHERE e1.XFR = x1.SID AND
            ...
            BEGIN
                    ...
                    IF u.PARENT IS NULL THEN
                        ...
                        ELSE
                            v_error_detail :=
                                ...
                                || 'This will result in C-Funds expense repayments not being made.  Please call the I2MS help desk.';
                            RAISE a_stink;
                        END IF;
                    ELSE
                ...
                begin_serve_page('C-Funds Home',
                                 TRUE,
                                 FALSE,
                                 'C-Funds Management System',
                                 'Welcome ' || v_user_info || '!');
            ...
            BEGIN
                ...
                --v_self := '!' || WEB_UTIL_PKG.Get_Self;
                v_self := '!' || REPLACE(Web_Util_Pkg.get_self, '!', '');
                begin_serve_page('C-Funds Manage CFMS', TRUE, TRUE, ' ', 'C-Funds Manage CFMS', 'DoHistory');
            ...
            BEGIN
                ...
                --v_self := '!' || WEB_UTIL_PKG.Get_Self;
                v_self := '!' || REPLACE(Web_Util_Pkg.get_self, '!', '');
                begin_serve_page('C-Funds Manage Limitations',
                                 TRUE,
                                 TRUE,
                                 ' ',
                                 'C-Funds Manage Limitations',
                                 'DoHistory');
                ...
                LOOP
                    ...
                    ELSIF v_tag = 'ORG_LIMIT_DEBUG_MSG' THEN
                        IF vp_debug <> 'FALSE' THEN
                            htp.prn
                                ('Note for debugging: Do not try to sum up the totals in the Org Limit column.  The Org Limit total for each unit does not always match the Current Limit for that unit.  The first row shows the Current Limit for that unit only, and the Org Limit column shows the total of all the limitations for the unit and subordinate units.  Other units have their Current Total column showing the Organizational Total if they are parents of C-Funds units.  Bottom-level units (Dets) will normally have their Org Total  showing as $0, this is normal.');
                        END IF;                   -- only print this header for debugging - more code below.
            ...
            BEGIN
                ...
                v_unit_name := Cfunds_Pkg.lookup_cfunds_unit(v_unit).unit_name;
                begin_serve_page('C-Funds Memos For Record',
                                 TRUE,
                                 TRUE,
                                 '',
                                 'C-Funds Memos For Record',
                                 'home_page');
            ...
            BEGIN
                ...
                --v_self := '!' || WEB_UTIL_PKG.Get_Self;
                v_self := '!' || REPLACE(Web_Util_Pkg.get_self, '!', '');
                begin_serve_page('C-Funds Memo For Record',
                                 TRUE,
                                 TRUE,
                                 ' ',
                                 'C-Funds Memo For Record',
                                 'DoHistory');
            ...
            PROCEDURE navigation(punit IN VARCHAR2, pfiscalyear IN VARCHAR2 := NULL) IS
                ...
                v_ok              BOOLEAN;
            BEGIN
                begin_serve_page('C-Funds Navigation', TRUE, TRUE, ' ', 'C-Funds Navigation', 'DoHistory');
            ...
            BEGIN
                begin_serve_page('C-Funds Payment Listing',
                                 TRUE,
                                 TRUE,
                                 'C-Funds Payment Listing',
                                 NULL,
...
/*                    UPDATE v_cfunds_expense_v3 e
            ...
            BEGIN
                ...
                -- find the name of this unit whose subordinate units are showing.
                v_unit_name := Cfunds_Pkg.lookup_cfunds_unit(v_unit).unit_name;
                begin_serve_page('C-Funds Payment Listings',
                                 TRUE,
                                 TRUE,
                                 '',
                                 'C-Funds Payment Listings',
                                 'home_page');
                ...
                LOOP
                    ...
                    IF v_tag = 'UNIT_LIST' THEN
                        ...
                        BEGIN
                            ...
                            --v_self := '!' || WEB_UTIL_PKG.Get_Self;
                            v_self := '!' || REPLACE(Web_Util_Pkg.get_self, '!', '');
                            begin_serve_page('C-Funds Reconcile Account',
                                             TRUE,
                                             TRUE,
                                             ' ',
                                             'C-Funds Reconcile Account',
                                             'DoHistory');
                        ...
                        BEGIN
                            ...
                            get_advance_id;
                            begin_serve_page('C-Funds Repayment Details',
                                             TRUE,
                                             TRUE,
                                             ' ',
                                             'C-Funds Repayment Details',
                        ...
                        BEGIN
                            ...
                            IF v_permission_exp = 'Y' AND v_permission_adv = 'Y' THEN
                                begin_serve_page('C-Funds Search Expenses/Advances',
                                                 TRUE,
                                                 TRUE,
                                                 '',
                                                 'C-Funds Management System',
                        ...
                        BEGIN
                            ...
                            -- find the name of this unit whose subordinate units are showing.
                            v_unit_name := Cfunds_Pkg.lookup_cfunds_unit(v_unit).unit_name;
                            begin_serve_page('C-Funds DFOs By Unit', TRUE, TRUE, '', 'C-Funds DFO By Unit',
                                             'home_page');
                            ...
                            BEGIN
                                ...
                                begin_serve_page('C-Funds Create DFO Transfers',
                                                 TRUE,
                                                 TRUE,
                                                 '',
                                                 'C-Funds Management System',
                            ...
                            BEGIN
                                begin_serve_page('C-Funds Transfer Details',
                                                 TRUE,
                                                 TRUE,
                                                 ' ',
                                                 'C-Funds Transfer Details',
                                                 'home_page');
                            ...
                            PROCEDURE transfers(punit IN VARCHAR2 := NULL, pfiscalyear IN VARCHAR2) IS
                                ...
                                v_unit            T_CFUNDS_UNIT.SID%TYPE;
                            BEGIN
                                begin_serve_page('C-Funds Transfers', TRUE, TRUE, ' ', 'C-Funds Transfers', 'home_page');
                            ...
                            BEGIN
                                ...
                                --  v_self := '!' || WEB_UTIL_PKG.Get_Self;
                                v_self := '!' || REPLACE(Web_Util_Pkg.get_self, '!', '');
                                begin_serve_page('C-Funds Setup Unit List',
                                                 TRUE,
                                                 TRUE,
                                                 ' ',
                                                 'C-Funds Setup Unit List',
                                                 'DoHistory');
                            ...
                            BEGIN
                                begin_serve_page('C-Funds Test Payment Listing',
                                                 FALSE,
                                                 FALSE,
                                                 ' ',
                                                 'C-Funds Test Payment Listing');
                                -- find the unit to default to if not sent in as a parameter
                                v_unit_sid := NVL(punit, Cfunds_Pkg.get_my_cfunds_unit);
