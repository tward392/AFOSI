...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:04 Wednesday July 13, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110713080402',
...
''||chr(10)||
'  ---Start at 2 to skip the Check/Uncheck All checkbox---'||chr(10)||
'  for i in 2..apex_application.g_f01.count loop'||chr(10)||
''||chr(10)||
...
'  end loop;'||chr(10)||
''||chr(10)||
'  if :P30700_TRANS_SIDS is nul';

p:=p||'l then'||chr(10)||
''||chr(10)||
'    if not core_list.add_item_to_list(:P30700_SEL_EVIDENCE, :P30700_TRANS_SIDS) then'||chr(10)||
''||chr(10)||
'      null;'||chr(10)||
''||chr(10)||
'    end if;'||chr(10)||
