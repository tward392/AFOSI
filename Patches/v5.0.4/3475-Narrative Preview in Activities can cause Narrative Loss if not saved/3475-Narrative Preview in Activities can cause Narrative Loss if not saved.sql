...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:28 Friday August 12, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'begin'||chr(10)||
''||chr(10)||
'  l_narrative := osi_investigation.Activity_Narrative_Preview(l_activity_sid,''HTML'');'||chr(10)||
'  '||chr(10)||
'  htp.p(l_narrative);'||chr(10)||
''||chr(10)||
'end;';
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   14:02 Friday August 12, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20110812132808',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '12-Aug-2011 - Tim Ward CR#3475 - Redid the Narrative Preview so it doesn''t reload the page.  This was causing '||chr(10)||
'                                 Narrative Loss if not saved');
