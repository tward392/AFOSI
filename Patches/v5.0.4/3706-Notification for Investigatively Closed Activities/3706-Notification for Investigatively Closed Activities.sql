INSERT INTO T_OSI_NOTIFICATION_EVENT_TYPE ( SID, CODE, DESCRIPTION, ACTIVE, IMMEDIATE_GENERATION, CREATE_ON, CREATE_BY, MODIFY_ON, MODIFY_BY ) VALUES ( '33317V6O', 'FILE.INV_CLOSED', 'File Investigatively Closed.', 'Y', 'N',  TO_Date( '07/13/2011 01:51:37 PM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/13/2011 01:51:37 PM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward'); 
COMMIT;

INSERT INTO T_OSI_NOTIFICATION_METHOD ( SID, CODE, DESCRIPTION, AGE_LIMIT, EVENT_TYPE, IMMEDIATE_DELIVERY, CUSTOM_DELIVERY, CREATE_ON, CREATE_BY, MODIFY_ON, MODIFY_BY ) VALUES ( '33317V6P', 'FILE.INV_CLOSED.EMAIL', 'Send via E-mail', 5, '33317V6O', 'N', 'N',  TO_Date( '07/13/2011 01:53:00 PM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/13/2011 01:53:00 PM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward'); 
COMMIT;
...
begin
     ...
     for o in (select dot.description from T_dibrs_offense_type dot, t_osi_f_inv_offense q
                 where dot.SID = q.offense
                   ...
                   and (dot.code like '0000A%' or dot.nibrs_code like '09%')
     ...
     for o in (select dot.description from t_dibrs_offense_type dot, t_osi_f_inv_offense g
                 where dot.SID = g.offense
                   and g.investigation = :new.obj
                   and (dot.code in('132-A-', '132-B-', '132-C-', '132-D-', '132-E-', '132-F-', '083-A-', '083-B-'))
              order by dot.description)
     loop
         v_cnt := v_cnt + 1;
         v_specifics := v_specifics || ' (' || v_cnt || ') ' || o.description;
