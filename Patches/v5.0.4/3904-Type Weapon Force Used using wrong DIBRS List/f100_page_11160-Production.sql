...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:10 Tuesday July 12, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20100121140032',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11160,
  p_branch_action=> 'f?p=&APP_ID.:11160:&SESSION.::&DEBUG.:::',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
declare
  ...
  l_length number := 1;
begin
p:=p||':P11160_ARMED_WITH_LOV := dibrs_reference.get_lov(''ARMED_WITH'', :P11160_ARMED_WITH);'||chr(10)||
'begin'||chr(10)||
'   select null'||chr(10)||
'     into :P11160_GUN_CAT_STATE'||chr(10)||
'     from dual'||chr(10)||
