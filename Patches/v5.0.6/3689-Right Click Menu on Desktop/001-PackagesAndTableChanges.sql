...
alter table t_osi_personnel_recent_objects add keep_on_top date;CREATE TABLE WEBI2MS.T_OSI_EMAILLINK
(
...
******************************************************************************/
    ...
    FUNCTION AddRankingToSelect(asNull in varchar2 := 'N', leadingComma in varchar2 := 'Y', trailingComma in varchar2 := 'N') return varchar2 is
    ...
    BEGIN
         ...
         IF FILTER IN ('RECENT','RECENT_UNIT') THEN
           ...
           SQLString := SQLString || AddRankingToSelect;

         ELSE

           SQLString := SQLString || AddRankingToSelect('Y');
    ...
    BEGIN
         ...
         IF FILTER IN ('RECENT','RECENT_UNIT') THEN
           ...
           SQLString := SQLString || AddRankingToSelect('N','N','Y');
         
         ELSE

           SQLString := SQLString || AddRankingToSelect('Y','N','Y');
    ...
    BEGIN
         ...
         SQLString := SQLString || 
                      ...
                      'osi_status.last_sh_date(f.sid,''OP'') as "Date Opened",' || 
                      'osi_status.last_sh_date(f.sid,''CL'') as "Date Closed",' || 
    ...
    BEGIN
         ...
         IF FILTER IN ('RECENT','RECENT_UNIT') THEN
           ...
           SQLString := SQLString || AddRankingToSelect('N','Y','Y');
         
         ELSE

           SQLString := SQLString || AddRankingToSelect('Y','Y','Y');
    ...
    BEGIN
         ...
         IF FILTER IN ('RECENT','RECENT_UNIT') THEN
           ...
           SQLString := SQLString || AddRankingToSelect('N','N','N');
         
         ELSE

           SQLString := SQLString || AddRankingToSelect('Y','N','N');
   ...
   END DesktopFullTextSearchSQL;
    ...
    BEGIN
         ...
         IF FILTER IN ('RECENT','RECENT_UNIT') THEN
           ...
           SQLString := SQLString || AddRankingToSelect('N','Y','N');
         
         ELSE

           SQLString := SQLString || AddRankingToSelect('Y','Y','N');
