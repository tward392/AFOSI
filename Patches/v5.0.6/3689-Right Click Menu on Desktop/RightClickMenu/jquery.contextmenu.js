 ...
 *
 * @version 1.1
 * @history 1.1 2012-03-26 Changed $(this).bind('contextmenu',function(e){cmenu.show(this,e);return false;}); to
 *	                           $(this).off('contextmenu').on('contextmenu',function(e){cmenu.show(this,e);return false;});
 *                         that way we don't get multiple bindings.  Requires JQuery 1.7.1+.
 * @history 1.1 2012-03-20 Added t and e a paremeters to beforeShow so we know what called the menu.
...
;(function($){
	$.contextMenu = {
		...
		beforeShow: function(t,e) { return true; },
