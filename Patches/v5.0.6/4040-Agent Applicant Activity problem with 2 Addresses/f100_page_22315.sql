...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:32 Tuesday April 24, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120424062710',
...
'23-Mar-2011 J.Faris - CR#3748 Activity Date missing validation.'||chr(10)||
''||chr(10)||
'24-Apr-2012 Tim Ward - CR#4040 - Address 1 and 2 not saving/clearing correctly.'||chr(10)||
'                        Added Update Address 2, change Update Address to '||chr(10)||
'                         Update Address 1.  Made Update Address 2 check the'||chr(10)||
'                         correct value.');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'osi_address.update_single_address(:p22315_sid, ''ADDRESS1'', :p22315_location_value);';
...
wwv_flow_api.create_page_process(
  ...
  p_process_name=> 'Update Address 1',
  p_process_sql_clob => p, 
...
declare
  ...
  l_length number := 1;
begin
p:=p||'osi_address.update_single_address(:p22315_sid, ''ADDRESS2'', :p22315_location2_value);';

wwv_flow_api.create_page_process(
  p_id     => 13117807525622412 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22315,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'Update Address 2',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Address Update Failed',
  p_process_when_button_id=>1974527725519978 + wwv_flow_api.g_id_offset,
  p_process_when=>':P22315_LOCATION2_VALUE is not null',
  p_process_when_type=>'PLSQL_EXPRESSION',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
