...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:16 Monday March 5, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 30400
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>30400);
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120305121631',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '26-OCT-2010 J.FARIS Bug 0542 - Reduced allowable first name, last name lengths to 30 to accomodate  a get_personnel_name value <= 100.'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P30400_UNIT_SID'',''N'',''&P30400_UNIT_SID.'',''OPEN'','''','''',''Choose Unit...'',''UNITS'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(500,''P30400_UNIT_SID'',''N'',''&P30400_UNIT_SID.'');">&ICON_LOCATOR.</a>');
