...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:11 Monday March 5, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120305111134',
...
wwv_flow_api.create_page_button(
  ...
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'','''',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''All%20Participant%20Types;ALL~Individuals%20by%20Name;PART.INDIV~Programs;PART.NONINDIV.PROG'',''Choose company/organization and then participant(s)...'',''PARTICIPANT'',''&P0_OBJ.'',''Y'');'||chr(10)||
'',
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'','''',''OPEN'','''','''',''Choose Participants...'',''PARTICIPANT'',''&P0_OBJ.'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'',''&P5300_EXCLUDE.'',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''All%20Participant%20Types;ALL~Individuals%20by%20Name;PART.INDIV~Programs;PART.NONINDIV.PROG~Companies;PART.NONINDIV.COMP'',''Choose Participants...'',''PARTICIPANT'',''&P0_OBJ.'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'','''',''OPEN'','''','''',''Choose Participants...'',''PARTICIPANT'',''&P0_OBJ.'');"'||chr(10)||
'',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_button_comment=>'javascript:popupLocator(400,''P5300_SEL_PARTICIPANT'',''Y'');',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'',''&P5300_EXCLUDE.'',''OPEN'','''','''',''Choose Participants...'',''PARTICIPANT'',''&P0_OBJ.'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
...
''||chr(10)||
'           if (:p0_obj_type_code <> ''ACT.BRIEFING'')';

p:=p||' then'||chr(10)||
''||chr(10)||
'             if (:P0_OBJ_TYPE_CODE = ''ACT.INTERVIEW.GROUP'') then'||chr(10)||
'                '||chr(10)||
...
p:=p||'                insert into t_osi_a_gi_involvement'||chr(10)||
...
p:=p||'                 values (:p0_obj, :p5300_participant_ver, :p5300_role, 1)'||chr(10)||
'                       returning sid into :p5300_sid;'||chr(10)||
''||chr(10)||
'           else'||chr(10)||
''||chr(10)||
...
p:=p||'RTY := replace(:P0_DIRTY, '':'' || :APP_PAGE_ID, '''');'||chr(10)||
