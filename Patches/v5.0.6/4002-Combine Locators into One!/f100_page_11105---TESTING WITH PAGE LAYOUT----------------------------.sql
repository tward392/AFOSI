...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:55 Friday February 10, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120210125100',
...
wwv_flow_api.create_page_plug (
  ...
  p_plug_column_width => 'style="width:100%;"',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Background                                    &P11105_FULL_ID.',
  ...
  p_cMaxlength=> 30000,
  p_cHeight=> 8,
  p_tag_attributes  => 'style="width:100%" &P11105_READONLY_HTML.',
  p_begin_on_new_line => 'YES',
  p_begin_on_new_field=> 'YES',
  p_colspan => 3,
  p_rowspan => 1,
...
wwv_flow_api.create_page_item(
  ...
  p_cHeight=> 1,
  p_cAttributes=> 'nowrap="nowrap"',
  p_tag_attributes  => 'style="width:30%"',
  p_begin_on_new_line => 'YES',
  p_begin_on_new_field=> 'YES',
  p_colspan => 1,
  p_rowspan => 1,
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a class="htmlButton" href="javascript:openLocator(''301'',''P11105_NOTIFY_UNITS_ADD'',''Y'',''&P11105_NOTIFY_UNITS.'',''OPEN'','''','''',''Choose Units to Notify...'',''UNITS'',''&P0_OBJ.'');">&BTN_ADD.</a>',
  p_source_type=> 'STATIC',
  ...
  p_protection_level => 'N',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_item_comment => '<a class="htmlButton" '||chr(10)||
'   href="javascript:popupLocator(500,'||chr(10)||
'                ''P11105_NOTIFY_UNITS_ADD'','||chr(10)||
'                ''Y'','||chr(10)||
'                ''&P11105_NOTIFY_UNITS.''.replace(/:/g,''~''));">&BTN_ADD.</a>'||chr(10)||
''||chr(10)||
'');
