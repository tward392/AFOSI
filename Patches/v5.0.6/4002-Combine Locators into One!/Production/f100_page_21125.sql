...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20100929133822',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(850,''P21125_OSI_SOURCE'',''N'',''&P21125_EXCLUDE.'',''FILE.SOURCE'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(400,''P21125_OTS_SOURCE'',''N'',''&P21125_EXCLUDE.'',''PART.INDIV'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(400,''P21125_OUSA_AGENCY'',''N'',''&P21125_EXCLUDE.'',''PART.NONINDIV.ORG'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(401,''P21125_OUSA_PARTIC'',''N'',''&P21125_EXCLUDE2.'',''PART.INDIV'', ''P401_OBJ,P401_COMPORG_FILTER'',''&P0_OBJ.,&P21125_OUSA_AGENCY.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
