...
ph:=ph||'text/css" href="#IMAGE_PREFIX#/themes/OSI/submodal/subModal.css"/>'||chr(10)||
'<script type="text/javascript" src="#IMAGE_PREFIX#/themes/OSI/submodal/common.js"></script>'||chr(10)||
'<script type="text/javascript" src="#IMAGE_PREFIX#/themes/OSI/submodal/subModal.js"></script>'||chr(10)||
'<!-- End Submodal stuff -->';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101203154859',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '03-DEC-2010 J.Faris WCHG0000386 Added submodal.js references to HTML Header.');
...
wwv_flow_api.create_page_item(
  ...
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Unit',
  p_post_element_text=>'<a href="javascript:popupLocator(500,''P950_UNIT_SID'',''N'',''&P950_UNIT_SID.~&P950_ORIG_UNIT_SID.'');">&ICON_LOCATOR.</a>',
