...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20100929140107',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '19-MAY-2010  Jason Faris     Fixed bug when dynamically setting P22810_DESCRIPTION to required or optional.');
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(400,''P22810_SEL_PARTICIPANT'',''N'',''&P22810_PART_EXCLUDE.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(850,''P22810_SEL_SOURCE'',''N'',''&P22810_SRC_EXCLUDE.'',''FILE.SOURCE'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
