...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:37 Tuesday February 28, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 11100
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>11100);
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120228133722',
...
wwv_flow_api.create_page_item(
  ...
  p_post_element_text=>'<a href="javascript:openLocator(''301'',''P11100_OFFENSE'',''N'','''',''OPEN'','''','''',''Choose Offense...'',''OFFENSE'',''&P0_OBJ.'');" style="vertical-align:bottom; padding-left:2px;">&ICON_LOCATOR.</a>'||chr(10)||
'',
...
' where sid = :P11100_OFFENSE',
  ...
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(550,''P11100_OFFENSE'',''N'');">&ICON_LOCATOR.</a>');
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P11100_VICTIM'',''N'','''',''OPEN'','''','''',''Choose Victim...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P111000_VICTIM'',''N'');">&ICON_LOCATOR.</a>');
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P11100_SUBJECT'',''N'','''',''OPEN'','''','''',''Choose Subject...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P11100_SUBJECT'',''N'');">&ICON_LOCATOR.</a>');
