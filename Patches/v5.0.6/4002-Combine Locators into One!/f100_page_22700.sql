...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:23 Tuesday February 28, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120228082321',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P22700_PARTICIPANT'',''N'','''',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''All Participant Types;ALL~Programs;PART.NONINDIV.PROG~Companies;PART.NONINDIV.COMP~Organizations;PART.NONINDIV.ORG'',''Choose Participant...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P22700_PARTICIPANT'',''N'','''',''PART.INDIV'');">&ICON_LOCATOR.</a>');
...
wwv_flow_api.create_page_validation(
  ...
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => 'Date Fingerprints Taken must be specified.',
  p_when_button_pressed=> 5488304227287804 + wwv_flow_api.g_id_offset,
