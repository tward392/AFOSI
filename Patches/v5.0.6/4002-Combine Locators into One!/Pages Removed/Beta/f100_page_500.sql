...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101109092045',
...
wwv_flow_api.set_page_help_text(p_flow_id=>wwv_flow.g_flow_id,p_flow_step_id=>500,p_text=>h);
end;
...
wwv_flow_api.create_page_plug (
  p_id=> 96130711471637576 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 500,
...
'                          '':'') "Include",'||chr(10)||
'       ''<a href="javascript:passBack('''''' || u.sid || '''''', '''''' || :p500_return_item'||chr(10)||
...
'             and (   (    :p500_filter = ''RECENT'''||chr(10)||
'                      and r1.personnel = :user_sid)'||chr(10)||
'                  or (    :p500_filter = ''RECENT_UNIT'''||chr(10)||
'                      and r1.unit = osi_personnel.get_current_unit(:user_sid))'||chr(10)||
'                  or (    :p500_filter = ''NONE'' '||chr(10)||
'                      ';

s:=s||'    and 1 = 2)'||chr(10)||
'                  or (:p500_filter in (''ALL'', ''OSI''))'||chr(10)||
'                  or ((    :p500_filter = ''ME'' or :p500_filter = ''UNIT'')'||chr(10)||
'                      and o1.sid ='||chr(10)||
'                          osi_personnel.get_current_unit(:user_sid))'||chr(10)||
'                  or (    :p500_filter = ''SUB_UNIT'''||chr(10)||
'                      and osi_unit.is_subordinate('||chr(10)||
'                          osi_personnel.get_current';

s:=s||'_unit(:user_sid),'||chr(10)||
'                          o1.sid)=''Y'')'||chr(10)||
'                  or (    :p500_filter = ''SUP_UNIT'''||chr(10)||
...
'   and instr(:p500_exclude, u.sid) = 0';

wwv_flow_api.create_page_plug (
  p_id=> 96130909602637578 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 500,
  p_plug_name=> '&P500_OBJ_TAGLINE.',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id => 96131114884637578+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 500,
  p_region_id => 96130909602637578+wwv_flow_api.g_id_offset,
  p_name => 'Activities',
  p_folder_id => null, 
  p_alias => '',
  p_report_id_item => '',
  ...
  p_page_items_to_submit => 'P500_FILTER',
  p_sort_asc_image       => '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 96131223563637578+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 500,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 96131330155637578+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 500,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5233431149931340+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5233527360931340+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5233606291931342+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5233732127931342+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5233829121931342+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 96131710614637579+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 500,
  p_worksheet_id => 96131114884637578+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 96131822904637579 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 500,
  p_button_sequence=> 10,
  p_button_plug_id => 96130909602637578+wwv_flow_api.g_id_offset,
  p_button_name    => 'RETURN',
  p_button_image   => 'template:'||to_char(179221063608554498+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Return Selections',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:passBack(''theList'',''&P500_RETURN_ITEM.'');',
  p_button_condition=> 'P500_MULTI',
...
wwv_flow_api.create_page_branch(
  p_id=>96133507789637585 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
...
wwv_flow_api.create_page_item(
  p_id=>5234213619935684 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_name=>'P500_FILTER',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 96130909602637578+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>96132011354637581 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_name=>'P500_EXCLUDE',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 40,
  p_item_plug_id => 96130711471637576+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default => 'Z',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
...
begin
wwv_flow_api.create_page_item(
  p_id=>96132206803637582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_name=>'P500_OBJ',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>96132417280637582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_name=>'P500_OBJ_TAGLINE',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
  p_item_plug_id => 96130711471637576+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>96132638650637582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_name=>'P500_MULTI',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>96132819271637582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_name=>'P500_RETURN_ITEM',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 96130711471637576+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>96133019606637584 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_name=>'P500_INITIALIZED',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  p_item_plug_id => 96130711471637576+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 5234317082936706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 500,
  p_computation_sequence => 10,
  p_computation_item=> 'P500_FILTER',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'STATIC_ASSIGNMENT',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'RECENT',
  p_compute_when => 'P500_FILTER',
...
':P500_INITIALIZED := ''Y'';'||chr(10)||
'if :P500_OBJ is not null then'||chr(10)||
'   :P500_OBJ_TAGLINE := core_obj.get_tagline(:P500_OBJ);'||chr(10)||
'end if;';

wwv_flow_api.create_page_process(
  p_id     => 96133238874637584 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 500,
  ...
  p_process_when=>'P500_INITIALIZED',
