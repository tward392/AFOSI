...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:57 Monday February 27, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120227125749',
...
'                         No locators on this page, but updated to auto select'||chr(10)||
'                         first liaison type and update title just like legacy.');
...
''||chr(10)||
'  for a in (select description, sid  from t_osi_reference'||chr(10)||
'              where usage = ''LIAISON_TYPE'' and(active = ''Y'''||chr(10)||
'                 or sid = nvl(:P21600_LIAISON_TYPE, ''null'')) order b';

p:=p||'y seq, description)'||chr(10)||
'  loop'||chr(10)||
'      :P21600_LIAISON_TYPE:=a.sid;'||chr(10)||
'      :P21600_TITLE:=a.description;'||chr(10)||
'      exit;'||chr(10)||
''||chr(10)||
'  end loop;'||chr(10)||
''||chr(10)||
