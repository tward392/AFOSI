...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:49 Thursday March 15, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120315074932',
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'','''',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''&P5300_ACTIVE_FILTER_EXCLUDES.'',''Choose Participants...'',''PARTICIPANT'',''&P0_OBJ.'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'','''',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''&P5300_ACTIVE_FILTER_EXCLUDES.'',''Choose Participants...'',''PARTICIPANT'',''&P0_OBJ.'');"'||chr(10)||
'',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_button_comment=>'javascript:popupLocator(400,''P5300_SEL_PARTICIPANT'',''Y'');',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P5300_SEL_PARTICIPANT'',''Y'',''&P5300_EXCLUDE.'',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''&P5300_ACTIVE_FILTER_EXCLUDES.'',''Choose Participants...'',''PARTICIPANT'',''&P0_OBJ.'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
