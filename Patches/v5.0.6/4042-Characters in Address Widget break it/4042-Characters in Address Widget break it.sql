...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:00 Wednesday April 25, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'   }'||chr(10)||
''||chr(10)||
' runJQueryPopWin(''Address'',itemNam';

c1:=c1||'es,itemVals);'||chr(10)||
'}'||chr(10)||
'</script>';
...
'                                   Changed to use JQuery Popup Window.',
 p_shortcut=> c1);
end;
null;
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:56 Monday May 7, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
' parent.$(''#JQueryPopWin'', window.parent.docu';

ph:=ph||'ment).remove();'||chr(10)||
'}'||chr(10)||
'</script>';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120507134250',
...
''||chr(10)||
'   begin'||chr(10)||
'        v_result := core_list.add_item_to_list(replace(p_item,''~'',''''), :P200_ADDRESS_FIELDS);'||chr(10)||
''||chr(10)||
'   end addItem;'||chr(10)||
''||chr(10)||
'begin'||chr(10)||
