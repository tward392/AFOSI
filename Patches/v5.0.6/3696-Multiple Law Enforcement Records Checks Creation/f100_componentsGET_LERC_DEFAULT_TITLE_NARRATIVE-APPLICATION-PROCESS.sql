...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:49 Tuesday March 20, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
''||chr(10)||
'begin'||chr(10)||
'     select description into vTypeDescription  from t_osi_reference where sid=vDocType;'||chr(10)||
'     select default_narrative into vDefaultNarrative from t_osi';

p:=p||'_a_records_check_results where code=vResult;'||chr(10)||
''||chr(10)||
'     vReturn := vTypeDescription || '' Records Check of SUBJECT'' || ''~`~`~`~`'' || replace(vDefaultNarrative,''~RECORD_TYPE~'',vTypeDescription);'||chr(10)||
''||chr(10)||
