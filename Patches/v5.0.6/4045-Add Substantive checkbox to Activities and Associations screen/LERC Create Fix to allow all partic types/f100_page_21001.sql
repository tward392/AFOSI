...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:33 Wednesday August 29, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'     v_TableName := ''t_osi_a_records_check'';'||chr(10)||
''||chr(10)||
'     for i in (SELECT * FROM T_OSI_A_RECORDS_CHECK_MULTI WHERE PERSONNEL=:USER_S';
...
''||chr(10)||
'         v_FieldValues := '''''''' || ''~^~P0_OBJ~^~'' || '''''''' || '','' || '''''''' || replace(i.doc_type,''%null%'',''null'') || '''''''' || '','' || '''''''' || '||chr(10)||
'                                          i.reference_number || '''''''';'||chr(10)||
''||chr(10)||
'        ';

p:=p||' v_sid := osi_activity.create_instance(:p21001_obj_type_sid,'||chr(10)||
'                                               v_ActivityDate,'||chr(10)||
'                                               i.title,'||chr(10)||
...
p:=p||'                                   replace(i.wh_mission,''%null%'',''null''),'||chr(10)||
'                                               i.wh_date,'||chr(10)||
'                                               i.wh_hours,'||chr(10)||
'                                               i.complete,'||chr(10)||
...
p:=p||'                :P21001_PARTIC_TYPE_EXCLUDES:='''';'||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a id="FindPartic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
...
p:=p||'                               :P21001_LIST_1_LABEL:=''Search Type'';'||chr(10)||
'                                       :P21001_LIST_1_LOV:=''- Select -;%null%,'';'||chr(10)||
'                                       for a in (select description d, sid r  '||chr(10)||
'                                                       from t_core_obj_type '||chr(10)||
'                                                         where code like substr(''ACT.SEARCH'', 1';
...
p:=p||'ST_1_LOV := rtrim(:P21001_LIST_1_LOV, '','');'||chr(10)||
'  '||chr(10)||
'                                       :P21001_LIST_2_LABEL := ''Search Based Upon'';'||chr(10)||
'                                       :P21001_LIST_2_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''SEARCH_BASIS'');'||chr(10)||
'  '||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a id="FindPartic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT''';
...
p:=p||'LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''CONTACT_METHOD'');'||chr(10)||
...
p:=p||'                               :P21001_ACTIVITY_DATE_LABEL:=''Requested Start Date'';'||chr(10)||
...
p:=p||'                                    :P21001_RADIOGROUP_1_LABEL:=''US Location'';'||chr(10)||
...
'                                       :P21001_LIST_1_LOV := ''- Select -;%null%,';

p:=p||''' || osi_reference.get_lov(''SURV_INFO_TYPE'');'||chr(10)||
...
'                                       :P21001_ACTIVITY_DATE_LABEL';

p:=p||':=''Requested Start Date'';'||chr(10)||
'                                       :P21001_LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''SUSPACT_CATEGORY'');'||chr(10)||
...
p:=p||'           if (substr(:P21001_OBJ_TYPE_CODE,1,16)=''ACT.CONSULTATION'') then'||chr(10)||
''||chr(10)||
...
p:=p||'                                          from V_OSI_CONSULT_CREATE_TYPES order by 1)'||chr(10)||
'                                         loop'||chr(10)||
'                                             :P21001_LIST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '',''; '||chr(10)||
'                                         end loop;'||chr(10)||
''||chr(10)||
...
p:=p||'               select sid into :P21001_LIST_1 from t_core_obj_type where code =''ACT.CONSULTATION.ACQUISITION'';'||chr(10)||
''||chr(10)||
'                                         exception when others then'||chr(10)||
'         '||chr(10)||
'                                                  null;'||chr(10)||
...
'                                         loop'||chr(10)||
'                                             :P21001_LIST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '',';
...
'                                       else'||chr(10)||
'                                         '||chr(10)||
'                                         if (:P21001_OBJ_TYPE_CODE IN (''ACT.CC_REVIEW'',''ACT.CHECK';

p:=p||'LIST'',''ACT.KFAT'',''ACT.OC_REVIEW'')) then'||chr(10)||
'                                         '||chr(10)||
'  '||chr(10)||
'                                           :P21001_ACTIVITY_DATE_LABEL:=''Review Date'';'||chr(10)||
''||chr(10)||
...
p:=p||'1001_pay_cat_lov := osi_reference.get_lov(''PERSONNEL_PAY_CATEGORY'');'||chr(10)||
''||chr(10)||
'end if;'||chr(10)||
''||chr(10)||
'if :P21001_duty_cat_lov is null then'||chr(10)||
