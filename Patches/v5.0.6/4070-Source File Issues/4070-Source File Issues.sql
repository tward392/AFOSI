update t_osi_tab set page_num='10200' where page_num='11325';
commit;
...
(SID, FILE_SID, FILE_ID, FILE_TITLE, FILE_TYPE_DESC, 
 ...
 ACTIVITY_CLOSE_DATE, ACTIVITY_DATE, ACTIVITY_SUSPENSE_DATE, ACTIVITY_UNIT_ASSIGNED, SUBSTANTIVE, SOURCE)
AS 
...
PROMPT ...Remove Source File Association Screen 11325..........
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:47 Monday May 21, 2012
--   Exported By:     TWARD
--   Flashback:       0
--   Export Type:     Page Export
--   Version: 3.2.0.00.27
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120521134656',
...
''||chr(10)||
'21-May-2012 - Tim Ward - CR#4070 - Source Files shouldn''t show filters.');
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'TWARD',
  p_last_upd_yyyymmddhh24miss => '20120521134338',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
...
'                                   association screen had wrong query.');
...
'or (this_file in (select file_sid from v_osi_assoc_fle_act where source=:P0_OBJ))';
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P10200_ASSOC_FILE'',''Y'',''&P10200_EXCLUDE_SIDS.'',''OPEN'','''','''',''Choose Files...'',''FILE'',''&P0_OBJ.'');'||chr(10)||
'',
