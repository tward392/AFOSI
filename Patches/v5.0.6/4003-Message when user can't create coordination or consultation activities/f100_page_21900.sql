...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:03 Tuesday February 28, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
' {'||chr(10)||
'  // Make sure there is at least one Consultation Type in the Select List //'||chr(10)||
'  var list = document.getElementById(''P21900_TYPE_CONSULTATION'');'||chr(10)||
'  if(list!=null)'||chr(10)||
'    {'||chr(10)||
'     if(list.length==1)'||chr(10)||
'       {'||chr(10)||
'        if(list[0].text=''- Select Type -'')'||chr(10)||
'          {'||chr(10)||
'           alert(''You are not authorized to create any ty';

ph:=ph||'pes of Consultation Activities.\n\nPlease talk to your Unit Commander about assigning you permissions for Consultation Activity Types that you need to create.'');'||chr(10)||
'           window.close();'||chr(10)||
'          }'||chr(10)||
'       }'||chr(10)||
'    }'||chr(10)||
''||chr(10)||
'  // Make sure there is at least one Coordination Type in the Select List //'||chr(10)||
'  var list = document.getElementById(''P21900_TYPE_COORDINATION'');'||chr(10)||
'  if(list!=null)'||chr(10)||
'    {'||chr(10)||
'     if(list.leng';
...
'        if(list[0].text=''- Select Type -'')'||chr(10)||
'          {'||chr(10)||
'           alert(''You are not authorized to create any types of Coordination Activities.\n\nPlease talk to your Unit Commander about assigning you permissions for Coordination Activity Types that you need to create.'');'||chr(10)||
'           window.close();'||chr(10)||
'          }'||chr(10)||
'       }'||chr(10)||
'    }'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120228075836',
...
'                         Item.'||chr(10)||
''||chr(10)||
'28-Feb-2012 - Tim Ward - CR#4003 - Show a message when the Type Lists are'||chr(10)||
'                         empty, this means they don''t have privileges to'||chr(10)||
'                         create Consultation or Coordination Activities.'||chr(10)||
'                         Added javascript checks to the HTML Header.');
