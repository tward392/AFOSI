...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120227121053',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P22400_SOURCE_SID'',''N'','''',''OPEN'','''','''',''Choose Source Number...'',''SOURCE'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(850,''P22400_SOURCE_SID'');">&ICON_LOCATOR.</a>');
