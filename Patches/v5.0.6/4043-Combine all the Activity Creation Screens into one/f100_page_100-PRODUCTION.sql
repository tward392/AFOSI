...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:30 Monday May 7, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'         window.top.document.getElementById("&P100_RETURN_ITEM.").value = '||chr(10)||
'            "&P100_DATE_VALUE.";'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20100902100424',
...
wwv_flow_api.create_page_button(
  p_id             => 5763213788159960 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 100,
