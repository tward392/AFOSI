...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:36 Wednesday May 23, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
s5:=s5||'USER;'||chr(10)||
':USER_URL := ''javascript:getObjURL('''''' || :USER_SID || '''''')'';'||chr(10)||
'/* was osi_object.get_object_url(:USER_SID); */'||chr(10)||
...
':ICON_FILE := CORE_UTIL.GET_CONFIG(''OSI.';

s5:=s5||'ICON_FILE'');'||chr(10)||
':ICON_FTS := CORE_UTIL.GET_CONFIG(''OSI.ICON_FTS'');'||chr(10)||
