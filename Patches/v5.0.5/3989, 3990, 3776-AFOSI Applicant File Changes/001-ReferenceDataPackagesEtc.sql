UPDATE T_CORE_OBJ_TYPE SET DESCRIPTION='AFOSI Applicant Activty - Education Activity' WHERE CODE='ACT.AAPP.EDUCATION';
UPDATE T_CORE_OBJ_TYPE SET DESCRIPTION='AFOSI Applicant Activty - Employment Activity' WHERE CODE='ACT.AAPP.EMPLOYMENT';
UPDATE T_CORE_OBJ_TYPE SET DESCRIPTION='AFOSI Applicant Activty - Records Check' WHERE CODE='ACT.AAPP.RECORDS_CHECK';
UPDATE T_CORE_OBJ_TYPE SET DESCRIPTION='AFOSI Applicant Activty - Interview' WHERE CODE='ACT.AAPP.INTERVIEW';
UPDATE T_CORE_OBJ_TYPE SET DESCRIPTION='AFOSI Applicant Activty - Document Review' WHERE CODE='ACT.AAPP.DOCUMENT_REVIEW';

UPDATE T_CORE_OBJ_TYPE SET DESCRIPTION='AFOSI Applicant File' WHERE CODE='FILE.AAPP';
COMMIT;


UPDATE T_OSI_OBJ_TYPE SET DEFAULT_TITLE=REPLACE(DEFAULT_TITLE,'OSI Application','AFOSI Applicant') WHERE DEFAULT_TITLE LIKE '%OSI Application%';
UPDATE T_OSI_OBJ_TYPE SET DEFAULT_TITLE=DEFAULT_TITLE || ' ~SUBJECT~' WHERE SID='22200000LU3';

UPDATE T_OSI_OBJ_TYPE SET DEFAULT_TITLE=REPLACE(DEFAULT_TITLE,'Agent Application','AFOSI Application') WHERE DEFAULT_TITLE LIKE '%Agent Application%';

COMMIT;


UPDATE T_OSI_REFERENCE SET ACTIVE='N' WHERE USAGE='AAPP_CATEGORY';
COMMIT;

INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GB', 'AAPP_CATEGORY', 'EAGENT', 'Enlisted Agent', 1, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:44:19 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:48:59 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GC', 'AAPP_CATEGORY', 'OAGENT', 'Officer Agent', 2, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:45:08 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:49:05 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GD', 'AAPP_CATEGORY', 'CAGENT', 'Civilian Agent', 3, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:45:22 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:49:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GF', 'AAPP_CATEGORY', 'RAGENT', 'Reserve Agent', 4, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:45:55 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:49:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GG', 'AAPP_CATEGORY', 'MPROSTAFF', 'Military Pro-Staff', 5, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:46:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:49:01 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GH', 'AAPP_CATEGORY', 'CPROSTAFF', 'Civilian Pro-Staff', 6, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:46:59 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:49:02 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GI', 'AAPP_CATEGORY', 'RPROSTAFF', 'Reserve Pro-Staff', 7, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:47:17 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:49:02 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
INSERT INTO T_OSI_REFERENCE ( SID, USAGE, CODE, DESCRIPTION, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, COMMENTS ) VALUES ( '333188GJ', 'AAPP_CATEGORY', 'JDET', 'JDET', 8, 'Y', 'timothy.ward',  TO_Date( '01/18/2012 08:47:36 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 08:49:01 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'AFOSI Applicant (110) File Categories'); 
COMMIT;

ALTER TABLE T_OSI_F_AAPP_FILE ADD INITIAL_SUSPENSE_DATE DATE;

UPDATE T_OSI_F_AAPP_FILE_OBJ_TYPE SET ACTIVE='N';
COMMIT;

INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HB', '31', '3-1 REFERENCE INTERVIEWS', NULL, 31, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:28:24 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HC', '32', '3-2 DEVELOPED REFERENCE(S)', NULL, 32, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:28:43 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HD', '33', '3-3 CREDIT BUREAU CHECK', NULL, 33, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:28:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HE', '34', '3-4 BACKGROUND QUESTIONNAIRE REVIEW', NULL, 34, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:29:05 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:51 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HF', '35', '3-5 QUALIFICATIONS TO POSSESS A FIREARM AND AMMUNITION', NULL, 35, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:29:07 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:51 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HG', '36', '3-6 REALITIES OF THE PROFESSIONS FORM', NULL, 36, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:29:53 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:56 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HH', '37', '3-7 PSYCHOLOGICAL TESTING REVIEW', NULL, 37, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:30:02 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:57 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HI', '38', '3-8 WRITING SAMPLE REVIEW', NULL, 38, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:30:13 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:57 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HJ', '39', '3-9 MEDICAL RECORDS REVIEW', NULL, 39, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:30:24 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:40:58 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HK', '310', '3-10 PERSONNEL RECORDS REVIEW', NULL, 310, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:30:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:41:01 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HL', '311', '3-11 LAW ENFORCEMENT RECORDS REVIEW', NULL, 311, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:30:45 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:41:02 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW~ACT.AAPP.DOCUMENT_REVIEW~ACT.AAPP.RECORDS_CHECK'); 
INSERT INTO T_OSI_F_AAPP_FILE_OBJ_TYPE ( SID, CODE, DESCRIPTION, HELP_TEXT, SEQ, ACTIVE, PRE_CAN_NARRATIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACT_TYPES ) VALUES ( '333188HM', '312', '3-12 APPLICANT INTERVIEW', NULL, 312, 'Y', NULL, 'timothy.ward',  TO_Date( '01/18/2012 09:30:56 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 09:41:04 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'ACT.AAPP.INTERVIEW'); 
COMMIT;

SET DEFINE OFF;

UPDATE T_OSI_ATTACHMENT_TYPE SET ACTIVE='N' WHERE CODE IN ('DLAB','COE','SOUFA','FIN_QUES','BACK_QUES','CARB_REC','151_DET','DOA','PIC','WRIT_SAMP','RO_INV');
COMMIT;

UPDATE T_OSI_ATTACHMENT_TYPE SET USAGE='REPORT' WHERE CODE='CROI';
COMMIT;

UPDATE T_OSI_ATTACHMENT_TYPE SET DESCRIPTION='Cognitive Testing Results' WHERE CODE='SHIPLEY';
COMMIT;

UPDATE T_OSI_ATTACHMENT_TYPE SET DESCRIPTION='Form 1288 (Reservists Only)' WHERE CODE='1288';
COMMIT;

INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333189E7', '22200000LU3', 'REPORT', 'DROI', 'Draft ROI (All Applicants)', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/23/2012 08:29:27 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/23/2012 08:29:27 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
COMMIT;

INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188I5', '22200000LU3', 'ATTACHMENT', 'AFOSIFORM61', 'AFOSI Form 61, AFOSI Applicant Questionnaire', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:16:17 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:16:17 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188I6', '22200000LU3', 'ATTACHMENT', 'AFOSIFORM79', 'AFOSI Form 79, AFOSI Applicant Eligibility Worksheet', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:16:59 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:16:59 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188I7', '22200000LU3', 'ATTACHMENT', 'AFOSIFORM84', 'AFOSI Form 84, Realities of the AFOSI Profession', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:17:36 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:17:36 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188I8', '22200000LU3', 'ATTACHMENT', 'AFOSIFORM87', 'AFOSI Form 87, Authorization for Release of Information', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:18:08 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:18:08 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188I9', '22200000LU3', 'ATTACHMENT', 'AFOSIFORM65', 'AFOSI Form 65, AFOSI Agent Applicant Writing Sample Instructions & Writing Sample', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:21:46 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:28:01 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188IA', '22200000LU3', 'ATTACHMENT', 'RESUME', 'Resume (Reserve and Civilians Only)', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:22:43 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:22:43 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188IB', '22200000LU3', 'ATTACHMENT', 'TERMINATION', 'Termination Report', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:23:51 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:23:51 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
INSERT INTO T_OSI_ATTACHMENT_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIME_DISPOSITION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, OVERRIDE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '333188IC', '22200000LU3', 'ATTACHMENT', 'ASIREQUEST', 'ASI Request', 'ATTACHMENT', NULL, NULL, NULL, NULL, 'Y', 'N', 'timothy.ward',  TO_Date( '01/18/2012 10:32:06 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/18/2012 10:32:06 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
COMMIT;

UPDATE T_OSI_ATTACHMENT_TYPE SET SEQ=NULL WHERE OBJ_TYPE='22200000LU3';
COMMIT;



update t_osi_attachment_type set description='SF86 hard copy w/signature pages' where CODE='SF86';
commit;


set define off;

UPDATE T_OSI_CHECKLIST_ITEM_TYPE SET DETAILS='Active and Reserve.' WHERE SID='22200000QLY';
UPDATE T_OSI_CHECKLIST_ITEM_TYPE SET TITLE='AFOSI FM 151 documents attached.',DESCRIPTION='Must have attached AFOSI FM 151 documents.' where sid='22200000QMO';
UPDATE T_OSI_CHECKLIST_ITEM_TYPE SET TITLE='Cognitive Testing Results documents attached.',DESCRIPTION='Must have attached Cognitive Testing Results documents.' WHERE SID='22200000QLW';
UPDATE T_OSI_CHECKLIST_ITEM_TYPE SET DETAILS='Reservists only.',DESCRIPTION='Must have attached Form 1288, Appplication for Ready Reserve Assignment documents.' WHERE SID='22200000QMQ';
COMMIT;

INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188ID', 'AF FM 422 documents attached.', 'Must have attached AF FM 422 documents.', 'OSI_CHECKLIST.AAPP_DOA_AF_422', 'Active and Reserve.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 06:44:45 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 06:44:45 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188IE', 'AFOSI Form 61 documents attached.', 'Must have attached AFOSI Form 61, AFOSI Applicant Questionnaire documents.', 'OSI_CHECKLIST.AAPP_DOA_AFOSIFORM61', 'All applicants.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 06:48:25 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:09:37 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188IF', 'AFOSI Form 65 documents attached.', 'Must have attached AFOSI Form 65, AFOSI Agent Applicant Writing Sample Instructions & Writing Sample documents.', 'OSI_CHECKLIST.AAPP_DOA_AFOSIFORM65', 'Agents only.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 06:51:44 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:09:37 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188IG', 'AFOSI Form 79 documents attached.', 'Must have attached AFOSI Form 79, AFOSI Applicant Eligibility Worksheet documents.', 'OSI_CHECKLIST.AAPP_DOA_AFOSIFORM79', 'All applicants.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 06:53:12 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:09:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188IH', 'AFOSI Form 84 documents attached.', 'Must have attached AFOSI Form 84, Realities of the AFOSI Profession documents.', 'OSI_CHECKLIST.AAPP_DOA_AFOSIFORM84', 'All applicants.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 06:54:32 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:09:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188II', 'AFOSI Form 87 documents attached.', 'Must have attached AFOSI Form 87, Authorization for Release of Information documents.', 'OSI_CHECKLIST.AAPP_DOA_AFOSIFORM87', 'All applicants.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 06:55:37 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:09:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188JO', 'Resume attached.', 'Must have a Resume attached.', 'OSI_CHECKLIST.AAPP_RESUME', 'All civilians and reservists.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 07:06:37 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:09:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333188JP', 'Termination Report attached.', 'Must have a Termination Report attached.', 'OSI_CHECKLIST.AAPP_TERMINATION', 'All applicants.', '222000005E3', 'timothy.ward',  TO_Date( '01/19/2012 07:07:54 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:09:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 

INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE ( SID, TITLE, DESCRIPTION, VERIFY_PROC, DETAILS, CONTAINING_TAB, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OBJ_TYPE ) VALUES ( '333189E8', 'Draft ROI Document attached', 'Must have a Draft ROI attached.', 'OSI_CHECKLIST.AAPP_DRAFT_ROI', 'All applicants.', '222000005E3', 'timothy.ward',  TO_Date( '01/23/2012 08:33:12 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/23/2012 08:33:12 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL); 
COMMIT;
...
COMMIT;
 ...
 UPDATE t_osi_status_change SET ACTIVE='N' 
  where obj_type='22200000LU3'
    and (UPPER(button_label) like '%CSO%' 
      OR UPPER(button_label) like '%HQ%' 
      OR UPPER(button_label) like '%CARB%' 
      OR UPPER(button_label) like '%AFCAF%');
COMMIT;

update t_osi_status_change set transition='DET Approval' where transition='DET Approvel';
commit;

--- Two New Status Changes ---
INSERT INTO T_OSI_STATUS_CHANGE ( SID, OBJ_TYPE, FROM_STATUS, TO_STATUS, TRANSITION, BUTTON_LABEL, COMMENT_TYPE, CONFIRM_MESSAGE, UNIT_REQUIRED, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, NOTE_CAT, SEQ, UNIT_TEXT_REQUIRED, CHECKLIST_BUTTON_LABEL, OVERRIDE, ACTIVE, AUTH_ACTION, ALLOW_DATE ) VALUES ( '333188OB', '22200000LU3', '22200000QGJ', '333188O9', 'Selected for AFOSI Duty', 'Selected for AFOSI Duty', 'N', NULL, 'N', 'timothy.ward',  TO_Date( '01/19/2012 09:05:17 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:06:47 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 600, 'N', 'Selected for AFOSI Duty Checklist', 'N', 'Y', NULL, 'Y'); 
INSERT INTO T_OSI_STATUS_CHANGE ( SID, OBJ_TYPE, FROM_STATUS, TO_STATUS, TRANSITION, BUTTON_LABEL, COMMENT_TYPE, CONFIRM_MESSAGE, UNIT_REQUIRED, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, NOTE_CAT, SEQ, UNIT_TEXT_REQUIRED, CHECKLIST_BUTTON_LABEL, OVERRIDE, ACTIVE, AUTH_ACTION, ALLOW_DATE ) VALUES ( '333188OC', '22200000LU3', '22200000QGJ', '333188OA', 'Not Selected for AFOSI Duty', 'Not Selected for AFOSI Duty', 'N', NULL, 'N', 'timothy.ward',  TO_Date( '01/19/2012 09:07:45 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:07:45 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, 601, 'N', 'Not Selected for AFOSI Duty Checklist', 'N', 'Y', NULL, 'Y'); 
COMMIT;

--- Allow Closure from Two New Status Changes ---
INSERT INTO T_OSI_STATUS_CHANGE ( SID, OBJ_TYPE, FROM_STATUS, TO_STATUS, TRANSITION, BUTTON_LABEL, COMMENT_TYPE, CONFIRM_MESSAGE, UNIT_REQUIRED, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, NOTE_CAT, SEQ, UNIT_TEXT_REQUIRED, CHECKLIST_BUTTON_LABEL, OVERRIDE, ACTIVE, AUTH_ACTION, ALLOW_DATE ) VALUES ( '333188OE', '22200000LU3', '333188O9', '222000005IZ', 'Close', 'Close', 'O', NULL, 'N', 'timothy.ward',  TO_Date( '01/19/2012 09:12:47 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:26:16 AM', 'MM/DD/YYYY HH:MI:SS AM'), '22200000QK4', 602, 'N', 'Closure Checklist', 'N', 'Y', NULL, 'Y'); 
INSERT INTO T_OSI_STATUS_CHANGE ( SID, OBJ_TYPE, FROM_STATUS, TO_STATUS, TRANSITION, BUTTON_LABEL, COMMENT_TYPE, CONFIRM_MESSAGE, UNIT_REQUIRED, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, NOTE_CAT, SEQ, UNIT_TEXT_REQUIRED, CHECKLIST_BUTTON_LABEL, OVERRIDE, ACTIVE, AUTH_ACTION, ALLOW_DATE ) VALUES ( '333188OF', '22200000LU3', '333188OA', '222000005IZ', 'Close', 'Close', 'O', NULL, 'N', 'timothy.ward',  TO_Date( '01/19/2012 09:13:06 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:26:22 AM', 'MM/DD/YYYY HH:MI:SS AM'), '22200000QK4', 603, 'N', 'Closure Checklist', 'N', 'Y', NULL, 'Y'); 
COMMIT;COMMIT;

--- Create Termination Checklist for all Termination Status' ---
update t_osi_status_change set checklist_button_label='Termination Checklist'
  where obj_type='22200000LU3' AND ACTIVE='Y' AND UPPER(TRANSITION)='TERMINATE';
COMMIT;


--- Remove all DOA checklist items ---
DELETE FROM T_OSI_CHECKLIST_ITEM_TYPE_MAP WHERE STATUS_CHANGE_SID IN ('22200000Q60');
COMMIT;

--- New DOA Checklist Items ---
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JQ', '22200000Q60', '333188ID', 'timothy.ward',  TO_Date( '01/19/2012 07:18:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:18:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JR', '22200000Q60', '22200000QLY', 'timothy.ward',  TO_Date( '01/19/2012 07:19:16 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:19:19 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JS', '22200000Q60', '333188IE', 'timothy.ward',  TO_Date( '01/19/2012 07:19:23 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:21:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JT', '22200000Q60', '333188IF', 'timothy.ward',  TO_Date( '01/19/2012 07:19:24 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:21:59 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JU', '22200000Q60', '333188IG', 'timothy.ward',  TO_Date( '01/19/2012 07:19:24 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:22:15 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JV', '22200000Q60', '333188IH', 'timothy.ward',  TO_Date( '01/19/2012 07:19:25 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:22:25 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JW', '22200000Q60', '333188II', 'timothy.ward',  TO_Date( '01/19/2012 07:19:25 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:22:37 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JX', '22200000Q60', '22200000QMI', 'timothy.ward',  TO_Date( '01/19/2012 07:19:32 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:22:53 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JY', '22200000Q60', '22200000QLW', 'timothy.ward',  TO_Date( '01/19/2012 07:19:45 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:23:08 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188JZ', '22200000Q60', '22200000QMD', 'timothy.ward',  TO_Date( '01/19/2012 07:19:45 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:23:29 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 0); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K0', '22200000Q60', '22200000QMF', 'timothy.ward',  TO_Date( '01/19/2012 07:19:46 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:23:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K1', '22200000Q60', '22200000QM5', 'timothy.ward',  TO_Date( '01/19/2012 07:19:46 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:23:56 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K2', '22200000Q60', '22200000QM0', 'timothy.ward',  TO_Date( '01/19/2012 07:19:46 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:24:11 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K3', '22200000Q60', '22200000QM4', 'timothy.ward',  TO_Date( '01/19/2012 07:19:47 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:24:21 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K4', '22200000Q60', '22200000QMQ', 'timothy.ward',  TO_Date( '01/19/2012 07:19:47 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:24:43 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K5', '22200000Q60', '22200000QMJ', 'timothy.ward',  TO_Date( '01/19/2012 07:19:47 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:25:07 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
---EMAIL NOTIF - NOT NEEDED ON DOA CHECKLIST------INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K6', '22200000Q60', '22200000QMS', 'timothy.ward',  TO_Date( '01/19/2012 07:19:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:25:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K7', '22200000Q60', '22200000QM2', 'timothy.ward',  TO_Date( '01/19/2012 07:19:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:25:46 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K8', '22200000Q60', '22200000QLV', 'timothy.ward',  TO_Date( '01/19/2012 07:19:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:26:13 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188K9', '22200000Q60', '333188JO', 'timothy.ward',  TO_Date( '01/19/2012 07:20:51 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:26:29 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
---SF86 - NOT NEEDED ON DOA CHECKLIST-----INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188KA', '22200000Q60', '22200000QMG', 'timothy.ward',  TO_Date( '01/19/2012 07:20:56 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 07:26:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
COMMIT;


--- Remove all Initial Unit Review checklist items ---
DELETE FROM T_OSI_CHECKLIST_ITEM_TYPE_MAP WHERE STATUS_CHANGE_SID IN ('22200000Q6O');
COMMIT;

--- New Initial Unit Review Checklist Items ---
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MM', '22200000Q6O', '333188ID', 'timothy.ward',  TO_Date( '01/19/2012 08:30:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MN', '22200000Q6O', '22200000QLY', 'timothy.ward',  TO_Date( '01/19/2012 08:30:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MO', '22200000Q6O', '333188IE', 'timothy.ward',  TO_Date( '01/19/2012 08:30:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MP', '22200000Q6O', '333188IF', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MQ', '22200000Q6O', '333188IG', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MR', '22200000Q6O', '333188IH', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MS', '22200000Q6O', '333188II', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MT', '22200000Q6O', '22200000QMI', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MU', '22200000Q6O', '22200000QLW', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MV', '22200000Q6O', '22200000QMD', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 0); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MW', '22200000Q6O', '22200000QMF', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MX', '22200000Q6O', '22200000QM5', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MY', '22200000Q6O', '22200000QM0', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188MZ', '22200000Q6O', '22200000QM4', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188N0', '22200000Q6O', '22200000QMQ', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188N1', '22200000Q6O', '22200000QMJ', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188N2', '22200000Q6O', '22200000QMS', 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:49 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188N3', '22200000Q6O', '22200000QM2', 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188N4', '22200000Q6O', '22200000QLV', 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188N5', '22200000Q6O', '333188JO', 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
---SF86 - NOT WANTED HERE NOW------INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188N6', '22200000Q6O', '22200000QMG', 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:30:50 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
COMMIT;


--- Remove all Final Unit Review checklist items ---
DELETE FROM T_OSI_CHECKLIST_ITEM_TYPE_MAP WHERE STATUS_CHANGE_SID IN ('22200000QGP');
COMMIT;

--- New Final Unit Review Checklist Items ---
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188ND', '22200000QGP', '22200000QLY', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NE', '22200000QGP', '333188IE', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NF', '22200000QGP', '333188IF', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NG', '22200000QGP', '333188IG', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NH', '22200000QGP', '333188IH', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NI', '22200000QGP', '333188II', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NJ', '22200000QGP', '22200000QMI', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NK', '22200000QGP', '22200000QLW', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NL', '22200000QGP', '22200000QMD', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 0); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NM', '22200000QGP', '22200000QMF', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NC', '22200000QGP', '333188ID', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NN', '22200000QGP', '22200000QM5', 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:30 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NO', '22200000QGP', '22200000QM0', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NP', '22200000QGP', '22200000QM4', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NQ', '22200000QGP', '22200000QMQ', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NR', '22200000QGP', '22200000QMJ', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NS', '22200000QGP', '22200000QMS', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NT', '22200000QGP', '22200000QM2', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NU', '22200000QGP', '22200000QLV', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NV', '22200000QGP', '333188JO', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NW', '22200000QGP', '22200000QMG', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NX', '22200000QGP', '22200000QLU', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188NY', '22200000QGP', '22200000QMP', 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 08:50:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333188PW', '22200000QGP', '333189E8', 'timothy.ward',  TO_Date( '01/19/2012 09:31:14 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:31:14 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
COMMIT;COMMIT;
...
--- New Closure Checklist items comming from Selected or Not Selected ---
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OG', '333188OE', '22200000QMO', 'timothy.ward',  TO_Date( '01/19/2012 09:17:05 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:28:12 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OH', '333188OE', '22200000QLU', 'timothy.ward',  TO_Date( '01/19/2012 09:17:44 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:17:44 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OI', '333188OE', '22200000QMP', 'timothy.ward',  TO_Date( '01/19/2012 09:17:58 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:17:58 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OJ', '333188OF', '22200000QMO', 'timothy.ward',  TO_Date( '01/19/2012 09:19:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:28:19 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OK', '333188OF', '22200000QLU', 'timothy.ward',  TO_Date( '01/19/2012 09:19:00 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:19:07 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OL', '333188OF', '22200000QMP', 'timothy.ward',  TO_Date( '01/19/2012 09:19:02 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:19:10 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OM', '333188OE', '22200000QLY', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188ON', '333188OE', '333188IE', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OO', '333188OE', '333188IF', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OP', '333188OE', '333188IG', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OQ', '333188OE', '333188IH', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OR', '333188OE', '333188II', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OS', '333188OE', '22200000QMI', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OT', '333188OE', '22200000QLW', 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:38 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OU', '333188OE', '22200000QMD', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 0); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OV', '333188OE', '22200000QMF', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OW', '333188OE', '333188ID', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OX', '333188OE', '22200000QM5', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OY', '333188OE', '22200000QM0', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188OZ', '333188OE', '22200000QM4', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P0', '333188OE', '22200000QMQ', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P1', '333188OE', '22200000QMJ', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P2', '333188OE', '22200000QMS', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P3', '333188OE', '22200000QM2', 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:39 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P4', '333188OE', '22200000QLV', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P5', '333188OE', '333188JO', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P6', '333188OE', '22200000QMG', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P7', '333188OE', '22200000QLU', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P8', '333188OE', '22200000QMP', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188P9', '333188OF', '22200000QLY', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PA', '333188OF', '333188IE', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PB', '333188OF', '333188IF', 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:40 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PC', '333188OF', '333188IG', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PD', '333188OF', '333188IH', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PE', '333188OF', '333188II', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PF', '333188OF', '22200000QMI', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PG', '333188OF', '22200000QLW', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PH', '333188OF', '22200000QMD', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 0); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PI', '333188OF', '22200000QMF', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PJ', '333188OF', '333188ID', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PK', '333188OF', '22200000QM5', 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PL', '333188OF', '22200000QM0', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PM', '333188OF', '22200000QM4', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PN', '333188OF', '22200000QMQ', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PO', '333188OF', '22200000QMJ', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PP', '333188OF', '22200000QMS', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PQ', '333188OF', '22200000QM2', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PR', '333188OF', '22200000QLV', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PS', '333188OF', '333188JO', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PT', '333188OF', '22200000QMG', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PU', '333188OF', '22200000QLU', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PV', '333188OF', '22200000QMP', 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:21:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
COMMIT;
...
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PX', '22200000QGG', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:07 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:37:51 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PY', '22200000Q6E', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:26 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:37:57 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188PZ', '22200000QET', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:26 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:38:03 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188Q0', '22200000QFZ', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:27 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:38:11 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188Q1', '22200000QJA', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:27 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:38:41 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188Q2', '22200000QGK', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:27 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:38:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188Q3', '22200000QGX', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:28 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:39:07 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188Q4', '22200000QHI', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:28 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:39:12 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188Q5', '22200000QI2', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:28 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:39:18 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( 
'333188Q6', '22203HWI', '333188JP', 'timothy.ward',  TO_Date( '01/19/2012 09:37:29 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 09:39:20 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
COMMIT;




---- Selected and Not Selected for AFOSI Duty Checklists ----
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333189E5', '333188OB', '22200000QMO', 'timothy.ward',  TO_Date( '01/23/2012 07:25:59 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/23/2012 07:25:59 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333189E6', '333188OC', '22200000QMO', 'timothy.ward',  TO_Date( '01/23/2012 07:26:13 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/23/2012 07:26:13 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
---MOVE ROI to CLOSURE ONLY---INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333189E9', '333188OB', '22200000QMN', 'timothy.ward',  TO_Date( '01/23/2012 08:41:42 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/23/2012 08:41:56 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
---MOVE ROI to CLOSURE ONLY---INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '333189EA', '333188OC', '22200000QMN', 'timothy.ward',  TO_Date( '01/23/2012 08:41:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/23/2012 08:42:57 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
COMMIT;



---- ROI check at closure (move from Forward to Region) -----
update t_osi_checklist_item_type_map set status_change_sid='22200000QK6' where status_change_sid='22200000QH2' and checklist_item_type_sid='22200000QMN';

INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '33318AJL', '333188OE', '22200000QMN', 'timothy.ward',  TO_Date( '01/31/2012 07:17:53 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/31/2012 07:18:12 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
INSERT INTO T_OSI_CHECKLIST_ITEM_TYPE_MAP ( SID, STATUS_CHANGE_SID, CHECKLIST_ITEM_TYPE_SID, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, USER_EDITABLE, COMPLETION_REQUIRED ) VALUES ( '33318AJM', '333188OF', '22200000QMN', 'timothy.ward',  TO_Date( '01/31/2012 07:18:21 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/31/2012 07:18:21 AM', 'MM/DD/YYYY HH:MI:SS AM'), 0, 1); 
COMMIT;
...
/*                                                                                                        */
    ...
    procedure aapp_doa_AFOSIFORM61(p_parent in varchar2, p_complete out number, p_msg out varchar2);

    /*AAPP (110 File): AFOSI Form 65, AFOSI Agent Applicant Writing Sample Instructions & Writing Sample Document attached. */
    procedure aapp_doa_AFOSIFORM65(p_parent in varchar2, p_complete out number, p_msg out varchar2);

    /*AAPP (110 File): AFOSI Form 79, AFOSI Applicant Eligibility Worksheet Document attached. */
    procedure aapp_doa_AFOSIFORM79(p_parent in varchar2, p_complete out number, p_msg out varchar2);
    
    /*AAPP (110 File): AFOSI Form 849, Realities of the AFOSI Profession Document attached. */
    procedure aapp_doa_AFOSIFORM84(p_parent in varchar2, p_complete out number, p_msg out varchar2);

    /*AAPP (110 File): AFOSI Form 87, Authorization for Release of Informaiton Document attached. */
    procedure aapp_doa_AFOSIFORM87(p_parent in varchar2, p_complete out number, p_msg out varchar2);

    /*AAPP (110 File): Resume attached. */
    procedure aapp_resume(p_parent in varchar2, p_complete out number, p_msg out varchar2);
    ...
    procedure aapp_termination(p_parent in varchar2, p_complete out number, p_msg out varchar2);
    ...
    /*AAPP (110 File): AF FM 422 documents attached. */
    procedure aapp_doa_AF_422(p_parent in varchar2, p_complete out number, p_msg out varchar2);
    ...
    procedure aapp_draft_roi(p_parent in varchar2, p_complete out number, p_msg out varchar2);
...
INSERT INTO T_CORE_TEMPLATE ( SID, TEMPLATE_NAME, TEMPLATE_INFO, MIME_TYPE, MIME_DISPOSITION, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ('333188QV', 'AGENT_APPLICANT_ROI', NULL, NULL, 'ATTACHMENT', 'timothy.ward',  TO_Date( '01/19/2012 12:23:32 PM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '01/19/2012 12:24:00 PM', 'MM/DD/YYYY HH:MI:SS AM')); 
COMMIT;



update t_osi_status_change_proc set active='N' where sid='22200000S55';
commit;
 ...
 * @author - Richard Norman Dibble
 /******************************************************************************
   ...
   19-Jan-2012  Tim Ward        CR#3990 - New File Requirements.  
                                 Changed generate_roi
                                Found Full-ID is being saved only on Page 11205 during a save.  Should be saved
                                 at creation only (as in Legacy).
...
******************************************************************************/
    ...
    function create_instance(p_obj_type in varchar2, p_title in varchar2, p_restriction in varchar2, p_subject in varchar2) return varchar2 is
    ...
    begin
         ...
         insert into t_osi_f_aapp_file (sid, synopsis, background) values (v_sid,
                     'This investigation was initiated to determine SUBJECT''s suitability for duty with AFOSI as ',
                     'This box is not used for ROI generation.');
             
         select sid into v_partic_role from t_osi_partic_role_type
               where obj_type member of osi_object.get_objtypes(v_sid) and usage = 'SUBJECT';
     
         insert into t_osi_partic_involvement i (obj, participant_version, involvement_role)
                                         values (v_sid, OSI_PARTICIPANT.GET_CURRENT_VERSION(p_subject), v_partic_role);

         v_id := osi_file.get_id(v_sid);
         v_unit := osi_object.get_assigned_unit(v_sid);

         update t_osi_file set full_id = osi_unit.get_code(v_unit) || '-OSIAPP-' || v_id where sid = v_sid;
...
function rpt_generate_add_info_sections(
    ...
    function rpt_generate_generic_act_sect(p_obj in varchar2, p_objective_type_code in varchar2, p_replace_tag in varchar2 := Null) return varchar2 is
    ...
    begin
         log_error('>>>osi_aapp_file.rpt_generate_generic_act_sect(' || p_obj || ',' || p_objective_type_code || ',' || p_replace_tag || ')');

         v_temp2 := '';           --- Clear the buffer ---
         v_chr_cnt := 1;          --- Reset Lettering Holder ---

        --- Loop through objectives --
        for k in (select objective_sid from v_osi_f_aapp_file_obj where obj_sid = p_obj and objective_type_code = p_objective_type_code)
        loop
            --- Loop through activities ---
            for j in (select * from v_osi_f_aapp_file_obj_act where objective_sid = k.objective_sid order by activity_date_from asc)
            loop
                for l in (select * from v_osi_a_aapp_activity where sid = j.activity_sid)
                loop
                    --- Set Letter ---
                    ...
                    case osi_object.get_objtype_code(core_obj.get_objtype(l.sid))
                        ...
                        when 'ACT.AAPP.INTERVIEW' then                                --- Interview ---
                            ...
                            v_temp := v_temp || 'Interview of: ' || l.int_of || ', ' || l.int_org || ', ' || l.address_2 || v_temp3 || v_newline;
                            ...
                            v_temp := v_temp || 'Date/Place: ' || to_char(l.activity_date, v_date_format) || '/' || l.address_1 || v_temp3 || v_newline;

                            --- LINE 3 ---
                            v_temp := v_temp || 'Interviewer: SA ' || l.int_interviewer_name || v_newline;

                            --- LINE 4 ---
                            if (l.int_asst_interviewer_name is not null) then

                              v_temp := v_temp || 'Asst Interviewer: SA ' || l.int_asst_interviewer_name || v_newline;

                            end if;

                            --- LINE 5 ---
                            v_temp := v_temp || 'Associated Exhibit: XXX [insert exhibit number if necessary, else remove line]' || v_newline;
                        ...
                        when 'ACT.AAPP.EDUCATION' then
                            ...
                            v_temp := v_temp || 'SUBJECT attended ' || l.deg_school || ', ' || l.address_1 || ', from ' || to_char(l.date_from, v_date_format) || ' to ';
                            v_temp := v_temp || to_char(l.date_to, v_date_format);

                            if (l.deg_grad_date is not null) then

                              v_temp := v_temp || ' and graduated with a ' || l.deg_degree || ' on ' || to_char(l.deg_grad_date, v_date_format);
        ...
        if (v_temp2 is null or length(v_temp2) <= 0) then
          ...
          case p_objective_type_code
              ...
              when 50 then
                  ...
                  v_temp2 := '>>>SUBJECT was not unemployed during the time frame of this investigation.<<<';

              when 100 then

                  v_temp2 := '>>>SUBJECT has never filed for bankruptcy, nor were any records found indicating SUBJECT had done so.<<<';
              ...
              when 140 then
                  ...
                  v_temp2 := '>>>SUBJECT stated he/she has never been taken to Criminal Court, nor were any records found indicating he/she had been a participant in a criminal court proceeding.<<<';

              when 150 then
                  v_temp2 := '>>>SUBJECT stated he/she has never been taken to Civil Court, nor were any records found indicating he/she had been a participant in a criminal court proceeding.<<<';
        ...
        if p_replace_tag is null then
          ...
          v_ok1 := core_template.replace_tag(v_report, p_replace_tag, v_temp2, 'WEBTOK@');
    ...
    exception
        when others then
            ...
            log_error('<<<osi_aapp_file.rpt_generate_generic_act_sect(' || p_obj || ',' || p_objective_type_code || ',' || p_replace_tag || ')');
            v_ok1 := core_template.replace_tag(v_report, p_replace_tag, '--- osi_aapp_file.rpt_generate_generic_act_sect ERROR---' || sqlerrm);
    ...
    function generate_roi(p_obj in varchar2)
        ...
        v_tempstring2   clob;
    begin
        log_error('>>>osi_aapp_file.generate_roi');

        --- Get latest template ---
        v_ok1 := core_template.get_latest('AGENT_APPLICANT_ROI',v_report,v_return_date,v_mime_type,v_mime_disp);

        --- Get Full ID ---
        v_ok1 := core_template.replace_tag(v_report,'FULL_ID',osi_file.get_full_id(p_obj),'WEBTOK@',p_multiple => true);

        --- Get Classification ---
        v_ok1 := core_template.replace_tag(v_report,'CLASSIFICATION',osi_classification.get_report_class(p_obj),'WEBTOK@',p_multiple => true);

        --- Report By ---
        for la in (select 'SA ' || first_name || ' ' || decode(middle_name, null, '(UNK) ', '', '(UNK) ', middle_name || ' ') || last_name as lead_agent
                     from v_osi_personnel_gen_info where sid in(select personnel
                                                                      from t_osi_assignment
        ...
        log_error('Lead Agent=' || v_temp);
        
        v_ok1 := core_template.replace_tag(v_report, 'LEAD_AGENT', v_temp,'WEBTOK@');

        --- v_osi_f_aapp_file ---
        for k in (select * from v_osi_f_aapp_file where sid=p_obj)
        loop
            --- Start Date ---
            v_ok1 := core_template.replace_tag(v_report, 'START_DATE', to_char(k.start_date, v_date_format),'WEBTOK@');

            --- Date of Report ---
            v_ok1 := core_template.replace_tag(v_report, 'PRINTDATE', to_char(sysdate, v_date_format),'WEBTOK@');

            --- Matters Investigated ---
            if k.category_code in ('AGT','RAGT','CAGENT','EAGENT','JDET','OAGENT','RAGENT') then
 
              v_temp5 := 'Investigative Duty';
 
            elsif k.category_code in ('SPT','RSPT','CPROSTAFF','MPROSTAFF','RPROSTAFF') then

                 v_temp5 := 'Professional Staff Duty';
            ...
            v_ok1 := core_template.replace_tag(v_report, 'AGENT_OR_SUPP', v_temp5,'WEBTOK@');
            ...
            v_temp3 := 'This investigation was initiated to determine SUBJECT''s ' || 'eligibility and suitability for ' || lower(v_temp5) || ' with AFOSI';
            
            if k.category_code in ('SPT','RSPT','CPROSTAFF','MPROSTAFF','RPROSTAFF') then
              
              v_temp3 := v_temp3 || '.';
              
            elsif k.category_code in ('CAGENT') then
   
                 v_temp3 := v_temp3 || ' as a civilian Special Agent.';
                 
            elsif k.category_code in ('EAGENT') then
                 
                 v_temp3 := v_temp3 || ' as an enlisted Special Agent.';
                 
            elsif k.category_code in ('OAGENT') then

                 v_temp3 := v_temp3 || ' as an officer Special Agent.';

            elsif k.category_code in ('RAGT','RAGENT') then

                 v_temp3 := v_temp3 || ' as a reserve Special Agent.';

            elsif k.category_code in ('JDET') then

                 v_temp3 := v_temp3 || ' as a JDET Agent.';
                 
            end if;

            v_ok1 := core_template.replace_tag(v_report, 'BACKGROUND', v_temp3,'WEBTOK@');

            --- Subject ---
            v_ok1 := core_template.replace_tag(v_report,'SUBJECT',rpt_get_aapp_person_roi_block(rpt_get_aapp_file_subject(p_obj)),'WEBTOK@');

            --- Status ---
            v_ok1 := core_template.replace_tag(v_report, 'STATUS', 'Closed','WEBTOK@');

            --- Synopsis ---
            v_ok1 := core_template.replace_tag(v_report, 'SYNOPSIS', k.synopsis,'WEBTOK@');
            
        end loop;
        
        --- Reference Interviews ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '31', 'REFERENCE');

        --- Developed References ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '32', 'DEV_REF');
        
        --- Credit Bureau Check ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '33', 'CREDIT');

        --- Background Questionnaire Review ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '34', 'BACKGROUND');

        --- Qualifications to Possess a Firearm and Ammunition ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '35', 'QPFA');

        --- Realities of the Profession ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '36', 'PROFESSION');

        --- Psychological Testing Review ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '37', 'PSYCH');

        --- Writing Sample ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '38', 'WS');

        --- Medical Records Review ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '39', 'MEDICAL');

        ---Personnel Records Reviews ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '310', 'PERSONNEL');

        --- Law Enforcement Records Reviews ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '311', 'LAW');

        --- Applicant Interview ---
        v_ok1 := rpt_generate_generic_act_sect(p_obj, '312', 'SUBJECT_INT');
        ...
        v_ok1 := core_template.replace_tag(v_report, 'NOTES', v_notes,'WEBTOK@');
        ...
        v_ok1 := core_template.replace_tag(v_report, 'IDPHEADER', v_temp4,'WEBTOK@');
