...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110518071005',
...
'    if (v_current_status = ''IC'' and ((:P5100_TYPE = v_type and :request=''DELETE'') or (:';

p:=p||'P5100_TYPE != v_type and :request=''SAVE'')) and v_attach_count = 0) then    '||chr(10)||
''||chr(10)||
...
'         and sc.obj_type = core_obj.lookup_objtype';
