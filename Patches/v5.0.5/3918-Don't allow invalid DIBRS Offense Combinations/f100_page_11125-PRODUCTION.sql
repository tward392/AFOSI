...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:57 Tuesday November 8, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101007160431',
...
p:=p||'    from t_osi_f_inv_incident_map im, t_osi_f_inv_spec s'||chr(10)||
'    where im.investigation = :P0_OBJ'||chr(10)||
...
'       from t_osi_f_inv_offen';

p:=p||'se o, t_osi_f_inv_spec s'||chr(10)||
'      where o.investigation = ''22203OFW'''||chr(10)||
...
p:=p||'e o.investigation = :P0_OBJ'||chr(10)||
'   order by o.sid desc)'||chr(10)||
'WHERE ROWNUM = 1;'||chr(10)||
''||chr(10)||
...
p:=p||'om t_osi_partic_involvement i, t_osi_partic_role_type rt'||chr(10)||
' where i.obj = :P0_OBJ'||chr(10)||
'   and i.involvement_role = rt.sid'||chr(10)||
'   and rt.role = ''Victim'''||chr(10)||
'   order by i.sid desc)'||chr(10)||
