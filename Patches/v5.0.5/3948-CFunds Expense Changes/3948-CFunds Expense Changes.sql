...
select cfe.sid, cfe.voucher_no, cfe.claimant, cfe.incurred_date, cfe.parent, cfe.parent_info,
           ...
           cfe.source_amount, cfe.agent_amount, cfe.conversion_rate, decode(cfe.take_from_advances, -1, 1, 1, 1, 0),
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   09:50 Friday September 30, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'',
  ...
  p_last_upd_yyyymmddhh24miss => '20110930095003',
...
' '||chr(10)||
'                              Default TAKE_FROM_ADVANCE to 0 (NO) on Create.');
