...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   10:38 Monday November 28, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 1100
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>1100);
...
prompt  ...PAGE 1100: Desktop All Files
--
...
wwv_flow_api.create_page(
  ...
  p_tab_set=> '',
  p_name   => 'Desktop All Files',
  p_step_title=> '&DESKTOP_TITLE.',
  p_step_sub_title => 'Desktop Files',
  ...
  p_last_upd_yyyymmddhh24miss => '20101222093105',
...
wwv_flow_api.create_page_plug (
  p_id=> 6185016962278392 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1100,
  ...
  p_plug_display_when_condition => 'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.INV.CASE''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.INV.DEV''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.INV.INFO''))=''N'''||chr(10)||
'and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'', '||chr(10)||
'    core_obj.lookup_objtype(''FILE.AAPP''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'', '||chr(10)||
'    core_obj.lookup_objtype(''FILE.GEN.ANP''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'', '||chr(10)||
'    core_obj.lookup_objtype(''FILE.PSO''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'', '||chr(10)||
'    core_obj.lookup_objtype(''FILE.POLY_FILE.SEC'')) = ''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'','||chr(10)||
'    core_obj.lookup_objtype(''FILE.GEN.SRCDEV''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'','||chr(10)||
'    core_obj.lookup_objtype(''FILE.GEN.UNDRCVROPSUPP''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'','||chr(10)||
'    core_obj.lookup_objtype(''FILE.GEN.TECHSURV''))=''N'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'','||chr(10)||
...
'             and (   (    :p1100_filter = ''RECENT'''||chr(10)||
'                      and r1.personnel = :user_sid)'||chr(10)||
'                  or (    ';

s:=s||':p1100_filter = ''RECENT_UNIT'''||chr(10)||
'                      and r1.unit = osi_personnel.get_current_unit(:user_sid))'||chr(10)||
'                  or (    :p1100_filter = ''NONE'' '||chr(10)||
'                          and 1 = 2)'||chr(10)||
'                  or (:p1100_filter in (''ALL'', ''OSI''))'||chr(10)||
'                  or (    :p1100_filter = ''ME'' '||chr(10)||
...
wwv_flow_api.create_page_plug (
  p_id=> 92117408484206228 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1100,
  p_plug_name=> 'Files > All Files',
  p_region_name=>'',
...
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.INV.INFO''))=''Y'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'', '||chr(10)||
...
a1:=a1||':p1100_filter = ''RECENT_UNIT'''||chr(10)||
'                      and r1.unit = osi_personnel.get_current_unit(:user_sid))'||chr(10)||
'                  or (    :p1100_filter = ''NONE'' '||chr(10)||
'                          and 1 = 2)'||chr(10)||
'                  or (:p1100_filter in (''ALL'', ''OSI''))'||chr(10)||
...
a1:=a1||'    or (    :p1100_filter = ''SUP_UNIT'''||chr(10)||
'                      and osi_object.get_assigned_unit(o1.sid) in'||chr(10)||
'                         (select unit'||chr(10)||
'                            from t_osi_unit_sup_units'||chr(10)||
'                           where sup_unit = '||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id => 92117619708206231+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 1100,
  p_region_id => 92117408484206228+wwv_flow_api.g_id_offset,
  p_name => 'Activities',
  p_folder_id => null, 
  p_alias => '',
  p_report_id_item => '',
  ...
  p_page_items_to_submit => 'P1100_FILTER',
  p_sort_asc_image       => '',
  ...
  p_download_filename         =>'&P1100_EXPORT_NAME.',
  p_detail_link              =>'#URL#',
...
wwv_flow_api.create_worksheet_column(
  p_id => 92118220188206262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1100,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92117707601206248+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1100,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92181319157322546+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92181416541322549+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92181515288322549+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92181632288322549+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 6871514008805245+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 6871620688805246+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 6871722262805248+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 6871813617805248+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1641715467898717+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1900401582859343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1900500038859343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1900604227859343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 92118315646206262+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1100,
  p_worksheet_id => 92117619708206231+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 15449524179842142 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1100,
  p_button_sequence=> 10,
  p_button_plug_id => 92117408484206228+wwv_flow_api.g_id_offset,
  ...
  p_button_cattributes=>'onClick="javascript:getIRCSV(null, this, 1100);"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>6872211022813792 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1100,
  p_branch_action=> 'f?p=&APP_ID.:1100:&SESSION.::&DEBUG.:::',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_sequence=> 10,
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> 'Created 08-MAR-2010 09:21 by TIM');
...
wwv_flow_api.create_page_item(
  p_id=>6872025436808537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1100,
  p_name=>'P1100_FILTER',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 92117408484206228+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15449805610846195 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1100,
  p_name=>'P1100_EXPORT_NAME',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  p_item_plug_id => 92117408484206228+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 6961419261605746 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1100,
  p_computation_sequence => 10,
  p_computation_item=> 'P1100_FILTER',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'STATIC_ASSIGNMENT',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'RECENT',
  p_compute_when => 'P1100_FILTER',
...
---------------------------------------
-- ...updatable report columns for page 1100
--
