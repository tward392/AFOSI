...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:53 Friday January 6, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 1360
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>1360);
 
end;
/

 
--application/pages/page_01360
prompt  ...PAGE 1360: Desktop Target Files
--
...
wwv_flow_api.create_page(
  ...
  p_tab_set=> '',
  p_name   => 'Desktop Target Files',
  p_step_title=> '&DESKTOP_TITLE.',
  p_step_sub_title => 'Desktop Target Files',
  ...
  p_last_upd_yyyymmddhh24miss => '20101213160120',
...
'   and ot.code = ''FILE.GEN.TARGETMGMT''';

wwv_flow_api.create_page_plug (
  p_id=> 2477217853540148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_plug_name=> 'Management Files > Target Files',
  p_region_name=>'',
  ...
  p_plug_display_when_condition => 'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.TARGETMGMT''))=''Y''',
...
a1:=a1||'    :p1360_filter = ''SUP_UNIT'''||chr(10)||
'                      and osi_object.get_assigned_unit(o1.sid) in'||chr(10)||
'                         (select unit'||chr(10)||
'                            from t_osi_unit_sup_units'||chr(10)||
'                           where sup_unit = '||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id => 2477422133540153+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 1360,
  p_region_id => 2477217853540148+wwv_flow_api.g_id_offset,
  p_name => 'Activities',
  p_folder_id => null, 
  p_alias => '',
  p_report_id_item => '',
  ...
  p_page_items_to_submit => 'P1360_FILTER',
  p_sort_asc_image       => '',
  ...
  p_download_filename         =>'&P1360_EXPORT_NAME.',
  p_detail_link              =>'#URL#',
...
wwv_flow_api.create_worksheet_column(
  p_id => 2477532659540157+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2477625479540157+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2477728989540159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2477802111540159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2477921808540159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2478000255540159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2478104760540160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2478223263540160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2478331753540160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2478432033540160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2478514772540160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2478600621540162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 2478723063540162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  p_worksheet_id => 2477422133540153+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_plug (
  p_id=> 6187328521291201 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1360,
  ...
  p_plug_query_show_nulls_as => ' - ',
  p_plug_display_condition_type => 'PLSQL_EXPRESSION',
  p_plug_display_when_condition => 'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.TARGETMGMT''))=''N''',
  p_pagination_display_position=>'BOTTOM_RIGHT',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
  p_plug_comment=> '');
...
wwv_flow_api.create_page_button(
  p_id             => 15470506947518442 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1360,
  p_button_sequence=> 10,
  p_button_plug_id => 2477217853540148+wwv_flow_api.g_id_offset,
  ...
  p_button_cattributes=>'onClick="javascript:getIRCSV(null, this, 1360);"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>2479320162540168 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1360,
  p_branch_action=> 'f?p=&APP_ID.:1360:&SESSION.::&DEBUG.:::',
...
wwv_flow_api.create_page_item(
  p_id=>2478826377540165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1360,
  p_name=>'P1360_FILTER',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 2477217853540148+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15470713873520445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1360,
  p_name=>'P1360_EXPORT_NAME',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  p_item_plug_id => 2477217853540148+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 2479129785540167 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1360,
  p_computation_sequence => 10,
  p_computation_item=> 'P1360_FILTER',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'STATIC_ASSIGNMENT',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'RECENT',
  p_compute_when => 'P1360_FILTER',
...
---------------------------------------
-- ...updatable report columns for page 1360
--
