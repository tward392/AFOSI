...
PROMPT ...Remove page 1500
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>1500);
...
prompt  ...PAGE 1500: Desktop All Support Files
--
...
wwv_flow_api.create_page(
  ...
  p_tab_set=> '',
  p_name   => 'Desktop All Support Files',
  p_step_title=> '&DESKTOP_TITLE.',
  p_step_sub_title => 'Desktop All Support Files',
  ...
  p_last_upd_yyyymmddhh24miss => '20101213160603',
...
'                                 osi_personnel.get_current_unit(:user_sid)'||chr(10)||
'                          )))'||chr(10)||
'        group by o1.sid, o1.obj_type, o1.create_by, o1.create';

s:=s||'_on) o,       '||chr(10)||
'    t_core_obj_type ot'||chr(10)||
' where f.sid = o.sid'||chr(10)||
'   and ot.sid = o.obj_type'||chr(10)||
'   and ot.code in (''FILE.GEN.SRCDEV'', ''FILE.GEN.UNDRCVROPSUPP'', ''FILE.GEN.TECHSURV'',''FILE.POLY_FILE.CRIM'')';

wwv_flow_api.create_page_plug (
  p_id=> 2134704278331081 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_plug_name=> 'Support Files > All Support Files',
  p_region_name=>'',
...
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.SRCDEV''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.UNDRCVROPSUPP''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.TECHSURV''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.POLY_FILE.CRIM''))=''N'''||chr(10)||
')',
...
a1:=a1||'ilter = ''RECENT_UNIT'''||chr(10)||
'                      and r1.unit = osi_personnel.get_current_unit(:user_sid))'||chr(10)||
'                  or (    :p1500_filter = ''NONE'' '||chr(10)||
'                          and 1 = 2)'||chr(10)||
'                  or (:p1500_filter in (''ALL'', ''OSI''))'||chr(10)||
...
a1:=a1||'    :p1500_filter = ''SUP_UNIT'''||chr(10)||
'                      and osi_object.get_assigned_unit(o1.sid) in'||chr(10)||
'                         (select unit'||chr(10)||
'                            from t_osi_unit_sup_units'||chr(10)||
'                           where sup_unit = '||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id => 2134928941331082+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 1500,
  p_region_id => 2134704278331081+wwv_flow_api.g_id_offset,
  p_name => 'Activities',
  p_folder_id => null, 
  p_alias => '',
  p_report_id_item => '',
  ...
  p_no_data_found_message => 'No Support files found.',
  p_max_rows_per_page    => '',
  p_search_button_label  => '',
  p_page_items_to_submit => 'P1500_FILTER',
  p_sort_asc_image       => '',
  ...
  p_download_filename         =>'&P1500_EXPORT_NAME.',
  p_detail_link              =>'#URL#',
...
wwv_flow_api.create_worksheet_column(
  p_id => 2135030990331084+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135110449331084+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135200519331084+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135316878331085+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135424092331087+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135504419331087+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135607516331087+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135705716331087+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135814596331089+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2135921144331089+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2136025700331089+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2136114056331089+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 2136218374331089+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  p_worksheet_id => 2134928941331082+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_plug (
  p_id=> 6189124497299470 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1500,
  ...
  p_plug_query_show_nulls_as => ' - ',
  p_plug_display_condition_type => 'PLSQL_EXPRESSION',
  p_plug_display_when_condition => 'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.SRCDEV''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.UNDRCVROPSUPP''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.TECHSURV''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.POLY_FILE.CRIM''))=''N''',
  p_pagination_display_position=>'BOTTOM_RIGHT',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
  p_plug_comment=> '');
...
wwv_flow_api.create_page_button(
  p_id             => 15513100198972278 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1500,
  p_button_sequence=> 10,
  p_button_plug_id => 2134704278331081+wwv_flow_api.g_id_offset,
  ...
  p_button_cattributes=>'onClick="javascript:getIRCSV(null, this, 1500);"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>2136815181331092 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1500,
  p_branch_action=> 'f?p=&APP_ID.:1500:&SESSION.::&DEBUG.:::',
...
wwv_flow_api.create_page_item(
  p_id=>2136320767331090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1500,
  p_name=>'P1500_FILTER',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 2134704278331081+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15513306431974156 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1500,
  p_name=>'P1500_EXPORT_NAME',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  p_item_plug_id => 2134704278331081+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 2136611335331090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1500,
  p_computation_sequence => 10,
  p_computation_item=> 'P1500_FILTER',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'STATIC_ASSIGNMENT',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'RECENT',
  p_compute_when => 'P1500_FILTER',
