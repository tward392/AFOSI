...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   10:40 Monday November 28, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 1400
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>1400);
...
prompt  ...PAGE 1400: Desktop All Service Files
--
...
wwv_flow_api.create_page(
  ...
  p_tab_set=> '',
  p_name   => 'Desktop All Service Files',
  p_step_title=> '&DESKTOP_TITLE.',
  p_step_sub_title => 'Desktop All Service Files',
  ...
  p_last_upd_yyyymmddhh24miss => '20101222093327',
...
'       o.last_accessed as "Last Accesse';
...
wwv_flow_api.create_page_plug (
  p_id=> 2099709264120510 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_plug_name=> 'Service Files > All Service Files',
  p_region_name=>'',
  ...
  p_plug_display_when_condition => 'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.AAPP''))=''Y'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.ANP''))=''Y'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.PSO''))=''Y'' and'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.POLY_FILE.SEC''))=''Y''',
...
a1:=a1||'_filter in (''ALL'', ''OSI''))'||chr(10)||
'                  or (    :p1400_filter = ''ME'' '||chr(10)||
'                      and osi_object.is_assigned(o1.sid)=''Y'')'||chr(10)||
'                  or (    :p1400_filter = ''UNIT'''||chr(10)||
'                      and osi_object.get_assigned_unit(o1.sid) ='||chr(10)||
...
a1:=a1||'si_unit.is_subordinate('||chr(10)||
'                          osi_personnel.get_current_unit(:user_sid),'||chr(10)||
'                          osi_object.get_assigned_unit(o1.sid))=''Y'')'||chr(10)||
'                  or (    :p1400_filter = ''SUP_UNIT'''||chr(10)||
'                      and osi_object.get_assigned_unit(o1.sid) in'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id => 2099901620120514+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 1400,
  p_region_id => 2099709264120510+wwv_flow_api.g_id_offset,
  p_name => 'Activities',
  p_folder_id => null, 
  p_alias => '',
  p_report_id_item => '',
  ...
  p_no_data_found_message => 'No Service files found.',
  p_max_rows_per_page    => '',
  p_search_button_label  => '',
  p_page_items_to_submit => 'P1400_FILTER',
  p_sort_asc_image       => '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 2100025421120517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100103691120517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100210014120517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100321710120517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100401240120518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100507089120518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100611704120518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100711193120518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100811977120518+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2100927407120520+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2101017953120520+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2101103007120520+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2101225828120520+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2101330327120520+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2101408881120521+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 2101530013120521+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  p_worksheet_id => 2099901620120514+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_plug (
  p_id=> 6187806489294309 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1400,
  ...
  p_plug_query_show_nulls_as => ' - ',
  p_plug_display_condition_type => 'PLSQL_EXPRESSION',
  p_plug_display_when_condition => 'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.AAPP''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.GEN.ANP''))=''N'' or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.PSO''))=''N'' '||chr(10)||
'or'||chr(10)||
'osi_auth.check_for_priv(''DESKTOP'',core_obj.lookup_objtype(''FILE.POLY_FILE.SEC''))=''N''',
  p_pagination_display_position=>'BOTTOM_RIGHT',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
  p_plug_comment=> '');
...
wwv_flow_api.create_page_button(
  p_id             => 15472424524542457 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 1400,
  p_button_sequence=> 10,
  p_button_plug_id => 2099709264120510+wwv_flow_api.g_id_offset,
  ...
  p_button_cattributes=>'onClick="javascript:getIRCSV(null, this, 1400);"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>2102120651120523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1400,
  p_branch_action=> 'f?p=&APP_ID.:1400:&SESSION.::&DEBUG.:::',
...
wwv_flow_api.create_page_item(
  p_id=>2101627216120521 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1400,
  p_name=>'P1400_FILTER',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 2099709264120510+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15472630758544259 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1400,
  p_name=>'P1400_EXPORT_NAME',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  p_item_plug_id => 2099709264120510+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 2101919899120523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1400,
  p_computation_sequence => 10,
  p_computation_item=> 'P1400_FILTER',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'STATIC_ASSIGNMENT',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'RECENT',
  p_compute_when => 'P1400_FILTER',
...
---------------------------------------
-- ...updatable report columns for page 1400
--
