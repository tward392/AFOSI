...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101213160146',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select ''javascript:getObjURL('''''' || u.sid || '''''');'' url,'||chr(10)||
...
begin
a1:=a1||'select ''javascript:getObjURL('''''' || u.sid || '''''');'' url,'||chr(10)||
'       u.unit_code as "Unit Code",'||chr(10)||
'       osi_unit.get_name(u.sid) as "Name",'||chr(10)||
'       osi_unit.get_name(u.unit_parent) as "Parent Unit",'||chr(10)||
'       o.create_on as "Created On",'||chr(10)||
...
a1:=a1||'filter = ''RECENT_UNIT'''||chr(10)||
'                      and r1.unit = osi_personnel.get_current_unit(:user_sid))'||chr(10)||
'                  or (    :p1390_filter = ''NONE'' '||chr(10)||
'                          and 1 = 2)'||chr(10)||
'                  or (:p1390_filter in (''ALL'', ''OSI''))'||chr(10)||
...
wwv_flow_api.create_worksheet_column(
  p_id => 92950927325559901+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1390,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92951032500559907+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1390,
  p_worksheet_id => 92950722444559889+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92951131749559907+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1390,
  p_worksheet_id => 92950722444559889+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92951238878559907+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1390,
  p_worksheet_id => 92950722444559889+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92951328418559907+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1390,
  p_worksheet_id => 92950722444559889+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92951429721559909+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1390,
  p_worksheet_id => 92950722444559889+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  ...
  p_is_default              =>'Y',
  p_display_rows            =>15,
  p_report_columns          =>'URL:Unit Code:Name:Parent Unit:Created On:Created By',
