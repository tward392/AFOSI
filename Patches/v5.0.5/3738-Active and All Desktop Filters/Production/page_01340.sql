...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101213155931',
...
s:=s||'i_personnel.get_current_unit(o1.sid))=''Y'')'||chr(10)||
...
a1:=a1||'i_personnel.get_current_unit(o1.sid))=''Y'')'||chr(10)||
'                  or (    :p1340_filter = ''SUP_UNIT'''||chr(10)||
'                      and osi_personnel.get_current_unit(o1.sid) in'||chr(10)||
'                         (select unit'||chr(10)||
'                            from t_osi_unit_sup_units'||chr(10)||
...
wwv_flow_api.create_worksheet_column(
  p_id => 92965808851707515+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1340,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92965930059707515+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1340,
  p_worksheet_id => 92965616256707514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92966016785707517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1340,
  p_worksheet_id => 92965616256707514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92966137816707517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1340,
  p_worksheet_id => 92965616256707514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 92966208703707517+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1340,
  p_worksheet_id => 92965616256707514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2151110384574373+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92965616256707514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2151209405574373+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92965616256707514+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10991121908717803+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 92965616256707514+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Badge Number',
  p_display_order          =>8,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  ...
  p_is_default              =>'Y',
  p_display_rows            =>15,
  p_report_columns          =>'URL:Employee #:Name:Unit Name:Start Date',
