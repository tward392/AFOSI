...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101213155851',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select ''javascript:newWindow({page:30700,clear_cache:''''30700'''',name:''''EMM'' || u.sid || '''''',item_names:''''P0_OBJ'''',item_values:'''''' || u.sid || '''''',request:''''OPEN''''});'' url,'||chr(10)||
...
s:=s||'0_filter = ''RECENT_UNIT'''||chr(10)||
...
s:=s||'current_unit(:user_sid))'||chr(10)||
...
begin
a1:=a1||'select ''javascript:newWindow({page:30700,clear_cache:''''30700'''',name:''''EMM'' || u.sid || '''''',item_names:''''P0_OBJ'''',item_values:'''''' || u.sid || '''''',request:''''OPEN''''});'' url,'||chr(10)||
'       ''Evidence Management Module for: '' ||'||chr(10)||
'        osi_unit.get_name(u.sid) as "Module Name"'||chr(10)||
'  from t_osi_unit u,'||chr(10)||
'       (select   o1.sid, '||chr(10)||
...
a1:=a1||'0_filter = ''RECENT_UNIT'''||chr(10)||
'                      and r1.unit = osi_personnel.get_current_unit(:user_sid))'||chr(10)||
'                  or (    :p1320_filter = ''NONE'' '||chr(10)||
'                          and 1 = 2)'||chr(10)||
'                  or (:p1320_filter in (''ALL'', ''OSI''))'||chr(10)||
...
a1:=a1||'current_unit(:user_sid))'||chr(10)||
'                  or (    :p1320_filter = ''SUB_UNIT'''||chr(10)||
'                      and osi_unit.is_subordinate('||chr(10)||
'                          osi_personnel.get_current_unit(:user_sid),'||chr(10)||
'                          o1.sid)=''Y'')'||chr(10)||
...
a1:=a1||'si_unit_sup_units'||chr(10)||
'                           where sup_unit = '||chr(10)||
'                                 osi_personnel.get_current_unit(:user_sid)'||chr(10)||
'                          )))'||chr(10)||
'        group by o1.sid, o1.obj_type, o1.create_by, o1.create_on) o'||chr(10)||
...
wwv_flow_api.create_worksheet_column(
  p_id => 8427115203452642+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1320,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 8431629894476842+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 8427014703452626+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Module Name',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
