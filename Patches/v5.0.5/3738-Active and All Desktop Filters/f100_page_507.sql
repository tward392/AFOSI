...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:35 Wednesday January 18, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120118073323',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '23-Jun-2011 - Tim Ward - CR#3868 - Created for SAPRO Incident Locations.'||chr(10)||
'18-Jan-2012 - Tim Ward - CR#3728 - Save Filter and rows values.'||chr(10)||
...
begin
wwv_flow_api.create_page_item(
  p_id=>10375300500210716 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 507,
  p_name=>'P507_OBJECT_TYPE',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 70,
  p_item_plug_id => 6168622060331318+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>10376027512218470 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 507,
  p_name=>'P507_NUM_ROWS',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 80,
  p_item_plug_id => 6168622060331318+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 10375717469215608 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 507,
  p_computation_sequence => 40,
  p_computation_item=> 'P507_NUM_ROWS',
  p_computation_point=> 'BEFORE_BOX_BODY',
  p_computation_type=> 'PLSQL_EXPRESSION',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'osi_personnel.get_user_setting(:user_sid,'||chr(10)||
'                               ''P'' || :APP_PAGE_ID || ''_NUM_ROWS.'' || ''CITY_STATE_COUNTRY'','||chr(10)||
'                               ''25'');'||chr(10)||
'',
  p_compute_when => '',
  p_compute_when_type=>'');
...
p:=p||'begin'||chr(10)||
''||chr(10)||
'   :P507_FILTER := osi_personnel.get_user_setting(:user_sid,'||chr(10)||
'                                                  ''P'' || :APP_PAGE_ID || ''_FILTER.'' || ''CITY_STATE_COUNTRY'','||chr(10)||
'                                                  ''RECENT'');'||chr(10)||
''||chr(10)||
'End;';

wwv_flow_api.create_page_process(
  p_id     => 10375510543213547 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 507,
