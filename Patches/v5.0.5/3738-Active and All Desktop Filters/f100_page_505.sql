...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120118073457',
...
begin
wwv_flow_api.create_page_item(
  p_id=>10371520146159616 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 505,
  p_name=>'P505_OBJECT_TYPE',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 70,
  p_item_plug_id => 6102107086355419+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>10372604955183618 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 505,
  p_name=>'P505_NUM_ROWS',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 80,
  p_item_plug_id => 6102107086355419+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 10372325949180211 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 505,
  p_computation_sequence => 30,
  p_computation_item=> 'P505_NUM_ROWS',
  p_computation_point=> 'BEFORE_BOX_BODY',
  p_computation_type=> 'PLSQL_EXPRESSION',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'osi_personnel.get_user_setting(:user_sid,'||chr(10)||
'                               ''P'' || :APP_PAGE_ID || ''_NUM_ROWS.'' || ''MILITARY_LOCS'','||chr(10)||
'                               ''25'');'||chr(10)||
'',
  p_compute_when => '',
  p_compute_when_type=>'');
...
p:=p||'begin'||chr(10)||
''||chr(10)||
'   :P505_FILTER := osi_personnel.get_user_setting(:user_sid,'||chr(10)||
'                                                  ''P'' || :APP_PAGE_ID || ''_FILTER.'' || ''MILITARY_LOCS'','||chr(10)||
'                                                  ''RECENT'');'||chr(10)||
''||chr(10)||
'End;';

wwv_flow_api.create_page_process(
  p_id     => 10371824779170375 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 505,
