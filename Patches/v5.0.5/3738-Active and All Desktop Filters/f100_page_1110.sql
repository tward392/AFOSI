...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:43 Tuesday January 17, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120117121535',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT C001,C002,C003,C004,to_date(C005),C006,C007,to_date(C008),C009,C010,C011,C012,to_date(C013),to_date(C014),to_number(C015),C016,C017,to_date(C018)'||chr(10)||
...
begin
a1:=a1||'SELECT C001,C002,C003,C004,to_date(C005),C006,C007,to_date(C008),C009,C010,C011,C012,to_date(C013),to_date(C014),to_number(C015),C016,C017,to_date(C018)'||chr(10)||
'FROM APEX_COLLECTIONS '||chr(10)||
'WHERE COLLECTION_NAME=''P'' || :APP_PAGE_ID || ''_CURRENT_FILTER'';'||chr(10)||
'';
