CREATE OR REPLACE PACKAGE BODY WEBI2MS."OSI_DESKTOP" AS
/******************************************************************************
   Name:     osi_desktop
...
*/         
    ...
    BEGIN
         ...
         column_names('TO_DATE(C008)'):='e.modify_on';
    ...
    BEGIN
         ...
         IF p_ObjType in ('FILE.SUPPORT','FILE.GEN.SRCDEV', 'FILE.GEN.UNDRCVROPSUPP', 'FILE.GEN.TECHSURV', 'FILE.POLY_FILE.CRIM') THEN
    ...
    /*  Personnel Section */   
    /**********************/ 
    FUNCTION DesktopPersonnelSQL(FILTER IN VARCHAR2, user_sid IN VARCHAR2, ACTIVE_FILTER IN VARCHAR2, p_WorksheetID IN VARCHAR2 := NULL, p_APP_USER IN VARCHAR2 := NULL, p_Instance IN VARCHAR2 := NULL) RETURN VARCHAR2 IS
...
--                      '       v.role_desc as "Role",' || vCRLF ||
         ...
         --- Add VLT Link ---
         --SQLString := SQLString || vCRLF ||
         --             '       ''javascript:newWindow({page:5550,clear_cache:''''5550'''',name:''''VLT''||o.sid||'''''',item_names:''''P0_OBJ'''',item_values:''||''''||''''''''||o.sid||''''''''||''''||'',request:''''OPEN''''})'' AS VLT,';
    ...
    BEGIN
         ...
         CASE 
             ...
             WHEN p_ObjType IN ('FILE', 'FILE.INV', 'FILE.INV.CASE', 'FILE.INV.DEV', 'FILE.INV.INFO',
                                ...
                                'FILE.SUPPORT','FILE.GEN.SRCDEV', 'FILE.GEN.UNDRCVROPSUPP', 'FILE.GEN.TECHSURV', 'FILE.POLY_FILE.CRIM') THEN
             ...
             WHEN p_ObjType='PERSONNEL' THEN
                 ...
                 SQLString := DesktopPersonnelSQL(NewFilter, user_sid, NewActiveFilter);
