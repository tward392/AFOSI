...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:34 Tuesday January 10, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120110133413',
...
wwv_flow_api.create_page_branch(
  ...
  p_branch_comment=> 'Created 01-JUN-2009 14:44 by THOMAS');
 
wwv_flow_api.create_page_branch(
  p_id=>91484626916384367 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30110,
  p_branch_action=> 'f?p=&APP_ID.:30110:&SESSION.:&REQUEST.:&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
