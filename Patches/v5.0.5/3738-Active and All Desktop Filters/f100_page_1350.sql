...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   14:02 Tuesday January 17, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120117122108',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT C001, C002, C003, C004, C005, TO_DATE(C006) AS C006, C007, C008, C009, TO_DATE(C010) AS C010, C011, C012'||chr(10)||
...
begin
a1:=a1||'SELECT C001, C002, C003, C004, C005, TO_DATE(C006) AS C006, C007, C008, C009, TO_DATE(C010) AS C010, C011, C012'||chr(10)||
'FROM APEX_COLLECTIONS '||chr(10)||
'WHERE COLLECTION_NAME=''P'' || :APP_PAGE_ID || ''_CURRENT_FILTER'';';
...
wwv_flow_api.create_worksheet_column(
  ...
  p_display_condition      =>'SELECT 1 FROM APEX_COLLECTIONS WHERE C010 IS NOT NULL AND COLLECTION_NAME=''P1350_CURRENT_FILTER''',
  p_help_text              =>'');
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10084304667625992+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 1627602467148425+wwv_flow_api.g_id_offset,
  ...
  p_rpt_filter_date_ranges =>'ALL',
  p_display_condition_type =>'EXISTS',
  p_display_condition      =>'SELECT 1 FROM APEX_COLLECTIONS WHERE C011 IS NOT NULL AND COLLECTION_NAME=''P1350_CURRENT_FILTER''',
  p_help_text              =>'');
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10084430195625994+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> null,
  p_worksheet_id => 1627602467148425+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  ...
  p_is_default              =>'Y',
  p_display_rows            =>25,
  p_report_columns          =>'C002:C003:C004:C005:C006:C007:C008:C010:C011:C012',
