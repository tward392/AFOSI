...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:00 Tuesday January 3, 2012
--   Exported By:     TWARD
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     APP PROCESS: GET_REPORT_ROWS_NUMBER
--   Manifest End
--   Version: 3.2.0.00.27
...
prompt Component Export: APP PROCESS 9883609096019187
...
'begin'||chr(10)||
''||chr(10)||
'     v_return := Get_Report_Rows_Number(apex_application.g_x01,:user_sid);'||chr(10)||
'     htp.p(v_return);'||chr(10)||
''||chr(10)||
'End;';

wwv_flow_api.create_flow_process(
  p_id => 9883609096019187 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_process_sequence=> 1,
  p_process_point => 'ON_DEMAND',
  p_process_type=> 'PLSQL',
  p_process_name=> 'GET_REPORT_ROWS_NUMBER',
...
--   Export Type:     Component Export
--   Manifest
--     APP PROCESS: SAVE_REPORT_ROWS_NUMBER
--   Manifest End
--   Version: 3.2.0.00.27
...
prompt Component Export: APP PROCESS 9881630231750915
...
''||chr(10)||
'begin'||chr(10)||
'     v_return := Save_Report_Rows_Number(apex_application.g_x01,'||chr(10)||
'                                         apex_application.g_x02, '||chr(10)||
'                                         :user_sid);'||chr(10)||
''||chr(10)||
'End;';

wwv_flow_api.create_flow_process(
  p_id => 9881630231750915 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_process_sequence=> 1,
  p_process_point => 'ON_DEMAND',
  p_process_type=> 'PLSQL',
  p_process_name=> 'SAVE_REPORT_ROWS_NUMBER',
  p_process_sql_clob=> p,
  p_process_error_message=> '',
  p_process_when=> '',
  p_process_when_type=> '',
...
'<BR>',
  ...
  p_before_column_heading=>'<thead id="reportHeader" name="reportHeader">'||chr(10)||
'',
...
'                          Added id/name="reportHeader" to '||chr(10)||
'                           "Before Column Heading".'||chr(10)||
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:02 Tuesday January 3, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'<script language="JavaScript">'||chr(10)||
'function End(){'||chr(10)||
'var answer = confirm ("Are you sure you woul';

ph:=ph||'d like to end this Role?")'||chr(10)||
'if (answer)'||chr(10)||
'{'||chr(10)||
'doSubmit(''END'');'||chr(10)||
'}'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120103080209',
...
'                         process.'||chr(10)||
''||chr(10)||
'03-Jan-2012 - Tim Ward - CR#3974 - Show more rows in Datagrid.  Removed Next/Previous'||chr(10)||
'                          pagination.'||chr(10)||
'');
...
wwv_flow_api.create_page_branch(
  ...
  p_branch_condition=> ''||chr(10)||
':REQUEST LIKE ''TAB%''',
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> 'Created 08-MAY-2009 16:05 by THOMAS');
 
wwv_flow_api.create_page_branch(
  p_id=>18233912276577914 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30455,
  p_branch_action=> 'f?p=&APP_ID.:30455:&SESSION.:&P30455_REGION_ID.:&DEBUG.:::pg_min_row=1',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_sequence=> 20,
  p_branch_condition_type=> 'PLSQL_EXPRESSION',
  p_branch_condition=> ':REQUEST like ''EDIT_%''',
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> 'Created 02-NOV-2010 11:51 by JASON');
 
wwv_flow_api.create_page_branch(
  p_id=>90275537309771987 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30455,
  p_branch_action=> 'f?p=&APP_ID.:30455:&SESSION.:&REQUEST.:&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:popupLocator(500,''P30455_UNIT_SID'',''N'',''&P30455_UNIT_SID.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
...
begin
wwv_flow_api.create_page_item(
  p_id=>18233529676564007 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30455,
  p_name=>'P30455_REGION_ID',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 290,
  p_item_plug_id => 16044630961072406+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'SELECT ''pg_R_''||TO_CHAR(REGION_ID)'||chr(10)||
'  FROM APEX_APPLICATION_PAGE_REGIONS'||chr(10)||
' WHERE APPLICATION_ID = :APP_ID'||chr(10)||
'   AND PAGE_ID        = :APP_PAGE_ID'||chr(10)||
'   AND STATIC_ID      = ''CHILD_RPT''',
  p_source_type=> 'QUERY',
  p_display_as=> 'HIDDEN',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
...
'end;',
  ...
  p_validation_condition=> ':REQUEST = ''CREATE'''||chr(10)||
'and'||chr(10)||
