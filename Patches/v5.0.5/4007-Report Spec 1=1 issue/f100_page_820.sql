...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:14 Wednesday March 7, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120307111138',
...
'                                Added Rearrange Narrative button.'||chr(10)||
''||chr(10)||
'07-Mar-2012 Tim Ward CR#4007 - Add spec=:P820_SPEC to the query in both report'||chr(10)||
'                               regions and remove the 1=1. The 1=1 appears '||chr(10)||
'                               to happen and it locks other sessions and'||chr(10)||
'                               spikes the Oracle server CPU.');
