...
******************************************************************************/
    ...
    FUNCTION get_name(p_pvop IN VARCHAR2) RETURN VARCHAR2 IS
...
*/
    ...
    begin
        ...
        if pnameonly = false then
          ...
          select sex_desc, dob, nvl(pa.state_desc, pa.country_desc), sa_pay_plan_desc, sa_pay_grade_desc, sa_affiliation_code, pv.participant, pv.obj_type_desc
