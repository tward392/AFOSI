...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:30 Thursday October 27, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20100813064819',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '09-JUL-2010  J.Faris  Bug 0484 - made Cancel button submit the page rather than redirect to prevent the loss of tabs when the button is pressed on initial load.');
...
''||chr(10)||
'if (:P0_OBJ_TYPE_CODE in (''FILE.AAPP'',''FILE.SOURCE'')) then'||chr(10)||
