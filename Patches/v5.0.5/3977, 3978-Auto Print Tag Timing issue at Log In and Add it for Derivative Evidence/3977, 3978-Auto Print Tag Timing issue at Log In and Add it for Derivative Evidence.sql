...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:33 Friday December 23, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20111223123350',
...
p:=p||'login_evidence(core_list.get_list_element(:p30710_trans_sids, 1),'||chr(10)||
'                                        :p0_obj,'||chr(10)||
...
p:=p||'           :P30710_DO_AUTO_PRINT_TAG:=''YES'';'||chr(10)||
''||chr(10)||
...
'            osi_evidence.reject_evidence(core_list.get_list_element(:p30710_tran';
...
p:=p||'obj = v_evidence.transferred_from_unit_sid then'||chr(10)||
...
'            when ''T'' then'||chr(10)||
'               :P30710_TITLE := ''Log In'';'||chr(10)||
'               :P30710_PURPOSE := ''Logging in Evidence'';';
...
'      when ''SPLIT'' then'||chr(10)||
'         :P30710_TITLE := ''Derivat';

p:=p||'ive Evidence'';'||chr(10)||
...
p:=p||' :P30710_PURPOSE := ''Recalling Evidence'';'||chr(10)||
'      when ''DISPOSE'' then'||chr(10)||
...
p:=p||'      :P30710_PURPOSE := ''Reject Evidence'';'||chr(10)||
'      else'||chr(10)||
'         null;'||chr(10)||
'    end case;'||chr(10)||
'end;';
