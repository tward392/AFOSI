...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:48 Friday April 1, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
begin
c1:=c1||'<td#ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="currentrow">#COLUMN_VALUE#</td>';
...
wwv_flow_api.create_row_template (
  ...
  p_row_template_before_rows=>'<table cellpadding="0" border="0" cellspacing="0" summary="" width=100%>'||chr(10)||
'#TOP_PAGINATION#'||chr(10)||
'<tr>'||chr(10)||
'<td colspan="2">'||chr(10)||
'<div class="reportContainer">'||chr(10)||
'<table class="reportData" cellpadding="0" cellspacing="0" border="0" width=100%>',
...
'',
  ...
  p_theme_id  => 101,
  p_theme_class_id => 5,
  p_row_template_comment=> '<tr>'||chr(10)||
''||chr(10)||
'<td class="csv">#EXTERNAL_LINK##CSV_LINK#</td><td><table width="100%" border="0">#PAGINATION#</table></td></tr>'||chr(10)||
''||chr(10)||
'<table class="t9pagination"><tr><td class="pagination"><a href="#LINK#" class="fielddata">#PAGINATION_NEXT#</a></td><td class="pagination"><a href="#LINK#"><img src="#IMAGE_PREFIX#themes/theme_9/pagination_next.png" border="0" width="12" height="19" alt="next"></a></td></tr></table>'||chr(10)||
''||chr(10)||
'<table class="t9pagination"><tr><td class="pagination"><a href="#LINK#"><img src="#IMAGE_PREFIX#themes/theme_9/pagination_prev.png" border="0" width="12" height="19" alt="next"></a></td><td class="pagination"><a href="#LINK#" class="fielddata">#PAGINATION_PREVIOUS#</a></td></tr></table>'||chr(10)||
''||chr(10)||
'<table class="t9pagination"><tr><td class="pagination"><a href="#LINK#" class="fielddata">#PAGINATION_NEXT_SET#</a></td><td class="pagination"><a href="#LINK#"><img src="#IMAGE_PREFIX#themes/theme_9/pagination_next.png" border="0" width="12" height="19" alt="next"></a></td></tr></table>'||chr(10)||
''||chr(10)||
'<table class="t9pagination"><tr><td class="pagination"><a href="#LINK#"><img src="#IMAGE_PREFIX#themes/theme_9/pagination_prev.png" border="0" width="12" height="19" alt="next"></a></td><td class="pagination"><a href="#LINK#" class="fielddata">#PAGINATION_PREVIOUS_SET#</a></td></tr></table>');
end;
null;
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:50 Friday April 1, 2011
--   Exported By:     TWARD
--   Flashback:       0
