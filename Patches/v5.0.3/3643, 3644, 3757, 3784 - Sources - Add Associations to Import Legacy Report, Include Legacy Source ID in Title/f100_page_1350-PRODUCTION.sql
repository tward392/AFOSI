...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   10:34 Wednesday April 20, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101213160014',
...
s:=s||'from t_core_obj o1, t_osi_personnel_recent_objects r1, t_osi_f_source f2'||chr(10)||
...
'                          osi_personnel.get_current_un';

s:=s||'it(:user_sid))'||chr(10)||
...
a1:=a1||'from t_core_obj o1, t_osi_personnel_recent_objects r1, t_osi_f_source f2'||chr(10)||
'           where r1.obj(+) = o1.sid'||chr(10)||
'             and o1.sid = f2.sid'||chr(10)||
'             and (   (    :p1350_filter = ''RECENT'''||chr(10)||
'                      and r1.personnel = :user_sid)'||chr(10)||
...
a1:=a1||' (    :p1350_filter = ''NONE'' '||chr(10)||
'                          and 1 = 2)'||chr(10)||
'                  or (:p1350_filter in (''ALL'', ''OSI''))'||chr(10)||
'                  or (    :p1350_filter = ''ME'' '||chr(10)||
'                      and osi_object.is_assigned(o1.sid)=''Y'')'||chr(10)||
