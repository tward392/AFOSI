...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   10:06 Wednesday June 8, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
''||chr(10)||
'If the current page is not within our object specific pages, or common object pages (i.e. associations), then the values of these items are all cleared out.  Otherwise, if P0_OBJ is set (meaning we are in edit mode for an object), then P0_OBJ_TYPE_CODE and P0_OBJ_TYPE_SID are derived from P0_OBJ.  If P0_OBJ is NOT set (meaning we''re in create mode for an object), then P0_OBJ_TYPE_SID is derived from P0_OBJ_TYPE_CODE.');
end;
