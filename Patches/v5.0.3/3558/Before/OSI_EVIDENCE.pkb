...
*/
    ...
    function obtained_method(p_obj in varchar2)
        ...
        v_rec_frm    t_osi_evidence.seized_from_participant_sid%type;
        v_sez_frm    t_osi_evidence.received_from_participant_sid%type;
    begin
...
------------------------
    ...
    begin
        ...
        loop
            ...
            v_temp_string :=
                v_temp_string
                || 'TOKEN (Indicate if item was returned to owner/authorized person)';
            v_temp_string :=
                v_temp_string
