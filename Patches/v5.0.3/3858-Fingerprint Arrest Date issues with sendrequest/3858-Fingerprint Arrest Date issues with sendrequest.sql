...
******************************************************************************/
    ...
    begin
         ...
         return  'SELECT                         OFFENSE_CHARGE as "Charge/Citation",                         TO_CHAR(OFFENSE_DATE,''DD-MON-YYYY'') as "Charge Date",                         COURT_DISP as "Disposition",                         TO_CHAR(COURT_DISP_DATE,''DD-MON-YYYY'') as "Disposition Date",                         ''' || ArrestDate || ''' as "Arrest Date"                     FROM                          V_OSI_IAFIS_OFFENSE_INFO                    WHERE INVESTIGATION=''' || FileSID || '''';
