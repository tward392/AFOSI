...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:06 Wednesday May 18, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110518110558',
...
begin
p:=p||'begin'||chr(10)||
'    if (instr(:P30455_ROLE_FILTER, ''SPR'') <= 0 or'||chr(10)||
'       :P30455_ROLE_FILTER is null) then'||chr(10)||
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:14 Wednesday May 18, 2011
--   Exported By:     TWARD
--   Flashback:       0
--   Export Type:     Page Export
--   Version: 3.2.0.00.27
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'TWARD',
  p_last_upd_yyyymmddhh24miss => '20110518110840',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '24-JUN-2010  Jason Faris Bug 0454 Fixed (ADD mode set/reset update).'||chr(10)||
