...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:45 Wednesday June 15, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'      }'||chr(10)||
'      if (imSure){'||chr(10)||
'         window.location = ''f?p=&APP_ID.:30720:&SE';
...
'            item_names:''P0_OBJ,P30';

ph:=ph||'715_EVIDENCE'', '||chr(10)||
...
ph:=ph||'    item_values:''&P0_OBJ.,&P30700_TRANS_SIDS.,&REQUEST.'','||chr(10)||
'            height:450});'||chr(10)||
'     default:'||chr(10)||
'         break;'||chr(10)||
'  }'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20100929164259',
...
wwv_flow_api.create_page_validation(
  ...
  p_validation_condition=> 'REJECT,LOGIN,SPLIT,UNDISPOSE,COMMENT',
  p_validation_condition_type=> 'REQUEST_IN_CONDITION',
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
