...
/*                                                                                                        */
    ...
    procedure assocact_closed(p_parent in varchar2, p_complete out number, p_msg out varchar2);
...
/*=============================================================================================*/
    ...
    begin
        ...
        p_msg := osi_auth.check_for_priv('APP_134_Z2', core_obj.get_objtype(p_parent), v_unit);
...
/*=============================================================================================*/
    ...
    procedure aapp_act_closed(p_parent in varchar2, p_complete out number, p_msg out varchar2) is
        v_cnt   number;
        v_msg   clob;--varchar2(32000);
        v_ids   clob;--varchar2(20000);
    begin
        v_msg := 'DEFAULT';                                                     ---initial value---
        v_cnt := 0;
