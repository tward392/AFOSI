...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:07 Friday August 24, 2012
--   Exported By:     TWARD
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     SHORTCUTS: JS_SEND_REQUEST
--   Manifest End
--   Version: 3.2.0.00.27
...
prompt Component Export: SHORTCUTS 6817618530976250
...
'function sendRequest(obj, request)'||chr(10)||
'{'||chr(10)||
' runJQueryPopWin(''EMAIL IAFIS Packet'',''P751_OBJ,P751_REQUEST'',obj + '','' + request,''751'', ''500'', ''500'');'||chr(10)||
'}'||chr(10)||
'</script>';

wwv_flow_api.create_shortcut (
 p_id=> 6817618530976250 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
 p_shortcut_name=> 'JS_SEND_REQUEST',
 p_shortcut_type=> 'HTML_TEXT',
 p_comments=> '24-Aug-2012 - Tim Ward - Changed this to use jQuery Dialog.',
 p_shortcut=> c1);
end;
null;
