...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:14 Thursday August 2, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 21710
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>21710);
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120802080409',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '16-SEP-2010 J.Faris - WCHG0000260, Cleared :P0_DIRTY on Add Topic process.'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_button(
  ...
  p_button_redirect_url=> 'javascript:openLocator(''301'',''P21710_SELECTED_TOPIC'',''Y'',''&P21710_EXCLUDE_SIDS.'',''OPEN'','''','''',''Choose Topics...'',''BRIEFING'',''&P0_OBJ.'');',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_button_comment=>'javascript:popupLocator(600,''P21710_SELECTED_TOPIC'',''Y'',''&P21710_EXCLUDE_SIDS.'');'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 21710,
  p_branch_action=> 'f?p=&APP_ID.:21710:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P21710_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  p_id=>15581204270236365 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 21710,
  p_name=>'P21710_OBJ',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 15581410503238148 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 21710,
  p_computation_sequence => 10,
  p_computation_item=> 'P21710_OBJ',
