...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   09:15 Tuesday October 23, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
''||chr(10)||
' $(label).toggleClass(''opt';

ph:=ph||'ionallabel'', true);'||chr(10)||
...
' var objTypeCode = $v(''P210';

ph:=ph||'01_OBJ_TYPE_CODE'');'||chr(10)||
...
ph:=ph||'001_DATE_2'',true,false);'||chr(10)||
...
ph:=ph||'''P21001_TEXT_8'',false,false);'||chr(10)||
...
ph:=ph||'''P21001_LIST_3'',false,false);'||chr(10)||
...
'    showField(''P21001_FIND_FILE_WIDGET'',f';

ph:=ph||'alse,false);'||chr(10)||
'   }'||chr(10)||
''||chr(10)||
...
''||chr(10)||
' makeLabelOptional(''P21001_PRECISION_DATE_1_DISPL';
...
' makeLabelOptional(''P210';

ph:=ph||'01_TEXT_8'');'||chr(10)||
...
ph:=ph||'akeLabelOptional(''P21001_ADDRESS_DISPLAY'');'||chr(10)||
''||chr(10)||
...
ph:=ph||'                          showField(''P21001_LIST_2'',false,false);'||chr(10)||
...
'                                        showField(''P21001_PRECISION_DATE_1'',false,';
...
'                                          }'||chr(10)||
''||chr(10)||
'                                        buildRC_DRNarrativeandTitle(''P21001_LIST_1'',''P21001_LIST_2'',''';

ph:=ph||'P21001_NARRATIVE'',''P21001_TITLE'',''P21001_OBJ_TYPE_CODE'');'||chr(10)||
'                                        break;'||chr(10)||
''||chr(10)||
...
ph:=ph||'ld(''P21001_LIST_2'',false,false);'||chr(10)||
'                                        makeLabelRequired(''P21001_LIST_1'');'||chr(10)||
...
ph:=ph||'                                   showField(''P21001_DATE_2'',true,false);'||chr(10)||
'                                        showField(''P21001_DATE_3'',true,false);'||chr(10)||
...
ph:=ph||'                               showField(''P21001_TEXT_3'',false,false);'||chr(10)||
...
ph:=ph||'                                   showField(''P21001_HOUR_2'',false,false);'||chr(10)||
...
'                                        showParticWidget();'||chr(10)||
'                                        makeLabelRequired(''P21001_LIST_1'');'||chr(10)||
'                                        buildRC_DRNarrativeandTitle(''P21001_LIST_1'',''P21001_LIST_2'',''P21001_NARRATIV';

ph:=ph||'E'',''P21001_TITLE'',''P21001_OBJ_TYPE_CODE'');'||chr(10)||
'                                        break;'||chr(10)||
''||chr(10)||
...
'                                              showField(''P21001_TEXT';

ph:=ph||'_6'',false,false);'||chr(10)||
...
ph:=ph||'001_LIST_1'',false,false);'||chr(10)||
'                                        makeLabelRequired(''P21001_PARTIC_DISPLAY'');'||chr(10)||
...
ph:=ph||'RADIOGROUP_3'',false,false);'||chr(10)||
...
ph:=ph||'eld(''P21001_TEXT_9_SUFFIX'',false,false);'||chr(10)||
''||chr(10)||
...
ph:=ph||'         $(''#P21001_LIST_2'').children().end().append(''<option value="''+values[1]+''">''+values[0]+''</option>'');'||chr(10)||
'                                                    }'||chr(10)||
'                                                 }'||chr(10)||
'                                             }'||chr(10)||
'                                          }'||chr(10)||
''||chr(10)||
'                                        hideField(''P21001_NARRATIVE'',false,true);'||chr(10)||
'           ';

ph:=ph||'                             hideField(''P21001_PAY_CAT'',false,false);'||chr(10)||
'                                        hideField(''P21001_DUTY_CAT'',false,false);'||chr(10)||
'                                        hideField(''P21001_MISSION'',false,false);'||chr(10)||
'                                        hideField(''P21001_WORK_DATE'',true,false);'||chr(10)||
'                                        hideField(''P21001_HOURS'',false,false);'||chr(10)||
'      ';

ph:=ph||'                                  hideField(''P21001_COMPLETE'',false,false);'||chr(10)||
'                                        hideField(''P21001_SUBSTANTIVE'',false,false);'||chr(10)||
''||chr(10)||
...
ph:=ph||'ld($(this).attr(''id''),false,false);'||chr(10)||
'                                         });'||chr(10)||
'                                        break;'||chr(10)||
'  '||chr(10)||
...
'                                        makeLabelRequired(''P21001_LIST_1'');'||chr(10)||
'                                        makeLabelRequired(''P21001_RADIOGROUP_1'');'||chr(10)||
'                                        showField(''P21001_LIST_1'',fals';

ph:=ph||'e,false);'||chr(10)||
'                                        showField(''P21001_RADIOGROUP_1'',false,false);'||chr(10)||
'                                        break;'||chr(10)||
''||chr(10)||
'                                default:'||chr(10)||
'                                        if ($(''#P21001_OBJ_TYPE_CODE'').val().substring(0,16)==''ACT.CONSULTATION'' || $(''#P21001_OBJ_TYPE_CODE'').val().substring(0,16)==''ACT.COORDINATION'')'||chr(10)||
'                             ';
...
ph:=ph||'least one Coordination/Consultation Type in the Select List //'||chr(10)||
...
ph:=ph||'                            if(list[0].text=''- Select -'')'||chr(10)||
'                                                   {'||chr(10)||
...
' '||chr(10)||
' if(typeof src !== "undefined")'||chr(10)||
'   {'||chr(10)||
...
ph:=ph||'(src.indexOf("plus.gif")>-1 || pHideParticDetails=="N")'||chr(10)||
'      {'||chr(10)||
...
'       $(''#showHideParticipantIcon'').attr("src",src.replace("minu';

ph:=ph||'s","plus"));'||chr(10)||
'       $(''#P21001_HIDEPARTICDETAILS'').val("Y");'||chr(10)||
'      }'||chr(10)||
'   }'||chr(10)||
'}'||chr(10)||
''||chr(10)||
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20121023091546',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '***************************************************'||chr(10)||
'*** BE CAREFUL WHEN ADDING ITEMS TO THIS PAGE   ***'||chr(10)||
'*** ANY MORE ITEMS IN MEDIA ANALYSIS/DDD TRIAGE ***'||chr(10)||
'*** COULD PUT IT OVER APEX''S 100 ITEM COUNT     ***'||chr(10)||
'***************************************************'||chr(10)||
'30-Apr-2012 - Tim Ward - CR#4043 - Created to replace ALL Activity Create Pages.'||chr(10)||
...
'14-Aug-2012 - Tim Ward - Previous change sent us over the limit of controls.'||chr(10)||
'                         Made all Hidden Participant Items conditional.'||chr(10)||
'                         Removed P21001_IMAGE - never used.'||chr(10)||
'21-Aug-2012 - Tim Ward - Removed "JS_POPUP_OBJ_DATA" from HTML Header, it is'||chr(10)||
'                          not used and it seems with the changes to '||chr(10)||
'                          "JS_ADDRESS_WIDGET" it puts this page somewhere over'||chr(10)||
'                          its HTML Header limit.'||chr(10)||
'29-Aug-2012 - Tim Ward - Let Records Check and Document Review pick any type'||chr(10)||
'                          of participants, not just individuals.'||chr(10)||
'05-Oct-2012 - Tim Ward - Records Check and Document Reviews not associating to'||chr(10)||
'                          File if create is picked from the file.'||chr(10)||
'15-Oct-2012 - Tim Ward - CR#4127 - Make sure you can up/down arrow in '||chr(10)||
'                          comboboxes. (added $(pthis).focus() to'||chr(10)||
'                          hideShowFields()).'||chr(10)||
'16-Oct-2012 - Tim Ward - CR#4117 - Change Label ITEM Case to IG Report. '||chr(10)||
'16-Oct-2012 - Tim Ward - CR#4114 - Removed Address, Narrative, Work Hours,'||chr(10)||
'                          Complete, Substantive and all ?''s in the radio '||chr(10)||
'                          options for Surveillance Activities. '||chr(10)||
'22-Oct-2012 - Tim Ward - CR#4132 - Allow Coordination/Consultation types to be'||chr(10)||
'                          hidden from the select list.'||chr(10)||
'23-Oct-2012 - Tim Ward - CR#4135 - Add 2701 field for Interviews (Victim and'||chr(10)||
'                          Witness). Also added Advisement for Subject Interview.'||chr(10)||
'');
...
wwv_flow_api.create_page_validation(
  ...
  p_validation_condition=> ':REQUEST IN (''ADD'',''CREATE'',''CREATE_ONE'')'||chr(10)||
'AND'||chr(10)||
':P21001_OBJ_TYPE_CODE IN (''ACT.SURVEILLANCE'')'||chr(10)||
'AND'||chr(10)||
':P21001_ADDRESS_LABEL IS NOT NULL;',
  p_validation_condition_type=> 'PLSQL_EXPRESSION',
...
'        v_ActivityDate := :p21001_activity_date;'||chr(10)||
''||chr(10)||
'    WHEN :P21001_OBJ_TYPE_CODE IN (''ACT.INTERVIEW.SUBJECT'') THEN'||chr(10)||
''||chr(10)||
'        v_ParticipantUsage := ''SUBJECT'';'||chr(10)||
'        v_ParticipantCode := ''PERSON'';'||chr(10)||
'        v_FieldNames := ''sid,advisement'';'||chr(10)||
'        v_FieldValues := '''''''' || ''~^~P0_OBJ~^~'' || '''''''' || '','' || '''''''' || replace(:p21001_list_1,''%null%'',''null'') || '''''''';'||chr(10)||
'        v_TableName := ''t_osi_a_i';

p:=p||'nterview'';'||chr(10)||
'        v_ActivityDate := to_date(:p21001_activity_date || '' '' || nvl(:p21001_hour, ''00'') || '':'' || nvl(:p21001_minute, ''00''), :fmt_date || '' '' || :fmt_time);'||chr(10)||
''||chr(10)||
'    WHEN :P21001_OBJ_TYPE_CODE IN (''ACT.INTERVIEW.VICTIM'',''ACT.INTERVIEW.WITNESS'') THEN'||chr(10)||
''||chr(10)||
'        v_ParticipantUsage := ''SUBJECT'';'||chr(10)||
'        v_ParticipantCode := ''PERSON'';'||chr(10)||
'        v_FieldNames := ''sid,dd2701'';'||chr(10)||
'        v_FieldValues ';

p:=p||':= '''''''' || ''~^~P0_OBJ~^~'' || '''''''' || '','' || '''''''' || replace(:p21001_list_1,''%null%'',''null'') || '''''''';'||chr(10)||
'        v_TableName := ''t_osi_a_interview'';'||chr(10)||
'        v_ActivityDate := to_date(:p21001_activity_date || '' '' || nvl(:p21001_hour, ''00'') || '':'' || nvl(:p21001_minute, ''00''), :fmt_date || '' '' || :fmt_time);'||chr(10)||
''||chr(10)||
'    WHEN :P21001_OBJ_TYPE_CODE=''ACT.LIAISON'' THEN'||chr(10)||
''||chr(10)||
'        v_FieldNames := ''sid,liaison_type,li';

p:=p||'aison_level'';'||chr(10)||
'        v_FieldValues := '''''''' || ''~^~P0_OBJ~^~'' || '''''''' || '','' || '''''''' || replace(:p21001_list_1,''%null%'',''null'') || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 replace(:p21001_list_2,''%null%'',''null'') || '''''''';'||chr(10)||
''||chr(10)||
...
''||chr(10)||
'    WHEN :P21001_OBJ_TYPE_CODE IN (''AC';

p:=p||'T.MEDIA_ANALYSIS'',''ACT.DDD_TRIAGE'') THEN'||chr(10)||
''||chr(10)||
...
'        v_FieldValues := ''core_sidgen.next_sid'' || '','' || '''''''' || replace(:p21001_list_1,''%null%'',''null'') || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 replace(:p21001_';

p:=p||'text_2,'''''''','''''''''''') || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 replace(:p21001_list_2,''%null%'',''null'') || '''''''' || '','' || '''''''' ||'||chr(10)||
'                                 :p21001_radiogroup_1 || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 replace(:p21001_text_3,'''''''','''''''''''') || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 :p21001_date_2 || '''''''' || '','' || '''''''' || '||chr(10)||
'  ';

p:=p||'                               :p21001_date_3 || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 :p21001_date_4 || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 :p21001_date_5 || '''''''' || '','' || '''''''' || '||chr(10)||
'                                 replace(:p21001_text_4,'''''''','''''''''''') || '''''''' || '','' || '''''''' ||'||chr(10)||
'                                 ''~^~P0_OBJ~^~'' || '''''''';'||chr(10)||
''||chr(10)||
''||chr(10)||
'        v_TableName := ';

p:=p||'''t_osi_a_media_analysis'';'||chr(10)||
'        v_ActivityDate := :p21001_activity_date;'||chr(10)||
''||chr(10)||
...
'        v_FieldValues := '''''''' || ''~^~P0_OBJ~^~'' || '''''''' || '','' || '''''''' || replace(:p21001_text_5,'''''''','''''''''''') || '''''''' || '','' || '||chr(10)||
'''to_date(to_char(to_date('' || '''''''' || :p21001_activity_date ';

p:=p||'|| '''''''' || ''),''''yyyymmdd'''')'' || '' ||nvl('' || '''''''' || :p21001_hour || '''''''' || '',''''01'''')'' || '' || nvl('' || '''''''' || :p21001_minute || '''''''' || '',''''00'''') || '' || ''''''00'''''' || '', ''''yyyymmddhh24miss'''')''  || '','' || '||chr(10)||
'''to_date(to_char(to_date('' || '''''''' || :p21001_activity_date || '''''''' || ''),''''yyyymmdd'''')'' || '' ||nvl('' || '''''''' || :p21001_hour_2 || '''''''' || '',''''01'''')'' || '' || nvl('' || '''''''' || :p21001_minute_2 |';

p:=p||'| '''''''' || '',''''00'''') || '' || ''''''00'''''' || '', ''''yyyymmddhh24miss'''')''  || '','' || '''''''' ||'||chr(10)||
...
'        v_ActivityDate := to_date(:p21001_activity_date, ''DD-Mon-YYYY HH24:MI'');'||chr(10)||
''||chr(10)||
'    WHEN :P21001_OBJ_TYPE';

p:=p||'_CODE=''ACT.RECORDS_CHECK'' THEN'||chr(10)||
''||chr(10)||
...
''||chr(10)||
'        v_FieldNames := ''sid,commodity,cont';
...
'        v_ActivityDate := to_date(to_char(to_date(:p21001_activity_date),''yyyymmdd'') || nvl(:p21001_hour,''01'') || nvl(:p21';

p:=p||'001_minute,''00'') || ''00'', ''yyyymmddhh24miss'');'||chr(10)||
''||chr(10)||
...
'        v_FieldValues := '''''''' || ''~^~P0_OBJ~^~'' || '''''''' || '','' || '''''''' || :p21001_radiogroup_2 || '''''''' || '','' || '''''''' ||'||chr(10)||
'                                 :p21001_radiogroup_3 || '''''''' ';
...
p:=p||'         replace(:p21001_text_9,'''''''','''''''''''') || '''''''';'||chr(10)||
''||chr(10)||
...
'      '||chr(10)||
''||chr(10)||
'    WHEN :P21001_OBJ_TYPE_CODE=''ACT.SU';

p:=p||'SPACT_REPORT'' THEN'||chr(10)||
''||chr(10)||
...
p:=p||'o_date(:p21001_activity_date, ''DD-Mon-YYYY'');'||chr(10)||
''||chr(10)||
'   ELSE'||chr(10)||
'       v_ActivityDate := to_date(:p21001_activity_date,''DD-MON-YYYY HH24:MI'');'||chr(10)||
''||chr(10)||
...
'     IF :P21001_FROM_OBJ IS NOT NULL THEN'||chr(10)||
''||chr(10)||
'       :P21001_FILE_ASSOC:=:P21001_FROM_OBJ;'||chr(10)||
' '||chr(10)||
'     END IF;'||chr(10)||
''||chr(10)||
...
p:=p||'        where personnel=:USER_SID '||chr(10)||
'             and obj_type_code=:P21001_obj_type_code;'||chr(10)||
''||chr(10)||
'     end if;'||chr(10)||
''||chr(10)||
'     if :P21001_PARTICIPANT is null then'||chr(10)||
''||chr(10)||
...
p:=p||'select complete into :P21001_COMPLETE'||chr(10)||
'          from t_osi_a_rc_dr_multi_temp '||chr(10)||
'           where personnel=:USER_SID '||chr(10)||
'             and obj_type_code=:P21001_obj_type_code;'||chr(10)||
''||chr(10)||
...
'          from t_osi_a_rc_dr_multi_temp '||chr(10)||
'           where personnel=:USER_SID '||chr(10)||
'             and obj_type_code=:P21001_obj';

p:=p||'_type_code;'||chr(10)||
''||chr(10)||
'     end if;'||chr(10)||
''||chr(10)||
'     if :P21001_RESTRICTION is null then'||chr(10)||
''||chr(10)||
'       select restriction into :P21001_RESTRICTION '||chr(10)||
'          from t_osi_a_rc_dr_multi_temp '||chr(10)||
'           where personnel=:USER_SID '||chr(10)||
'             and obj_type_code=:P21001_obj_type_code;'||chr(10)||
''||chr(10)||
...
''||chr(10)||
'     end if;'||chr(10)||
'     if :P21001_DUTY_CAT is null then'||chr(10)||
''||chr(10)||
...
''||chr(10)||
'       select wh_mission int';

p:=p||'o :P21001_MISSION'||chr(10)||
'          from t_osi_a_rc_dr_multi_temp '||chr(10)||
'           where personnel=:USER_SID '||chr(10)||
'             and obj_type_code=:P21001_obj_type_code;'||chr(10)||
''||chr(10)||
...
p:=p||'  if :P21001_HOURS is null then'||chr(10)||
''||chr(10)||
...
'(activity_date,subject_of_activity,reference_num,restriction,title,narrative,doc_type,resu';

p:=p||'lts,file_sid,personnel,WH_PAY_CAT,WH_DUTY_CAT,WH_MISSION,WH_DATE,WH_HOURS,COMPLETE,SUBSTANTIVE,OBJ_TYPE_CODE,EXPLANATION)'||chr(10)||
'values'||chr(10)||
...
'       wh_pay_cat=:p21001_pay_cat,'||chr(10)||
...
'                                       loop'||chr(10)||
'                                           :P21001_LIST_2_LOV := :P21001_LIST_2_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || ''';
...
'                                       :P21001_PARTIC_TYPE_EXCLUDES:='''';'||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a id="FindPartic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
'                                                                ''''''P301_ACTIVE_FILTER_EXCLUDES'''',$v(''''P';

p:=p||'21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participant...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
''||chr(10)||
...
'                                       :P21001_PARTIC_WIDGET_VISIBLE:=''Y'';'||chr(10)||
'                                       :P21001_PARTIC_TYPE_EXCLUDES:='''';'||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a id="FindPartic" href="java';

p:=p||'script:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
'                                                                ''''''P301_ACTIVE_FILTER_EXCLUDES'''',$v(''''P21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participant...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
''||chr(10)||
'      WHEN ''ACT.INTERVIEW.SUBJECT'' THEN'||chr(10)||
'                                       :P21001_ACTIVITY_DATE_LABEL:=''Interview ';

p:=p||'Date'';'||chr(10)||
'                                       :P21001_HOUR_LABEL:=''Interview Time'';'||chr(10)||
'                                       :P21001_LIST_1_LABEL := ''Type of Advisement'';'||chr(10)||
'                                       :P21001_LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''ADVISEMENT'',:P21001_LIST_1);'||chr(10)||
'                                       :P21001_PARTIC_LABEL:=''Subject'';'||chr(10)||
'                      ';
...
'                                       :P21001_HOUR_LABEL:=''Interview Time'';'||chr(10)||
'                                       :P21001_LIST_1_LABEL := ''Form 2701'';'||chr(10)||
'                                       :P21001_LIST_1_LOV := ''- Select -;%null%,'' || osi_refe';

p:=p||'rence.get_lov(''DD2701_RESULT'',:P21001_LIST_1);'||chr(10)||
...
p:=p||'         :P21001_LIST_1_LABEL := ''Form 2701'';'||chr(10)||
'                                       :P21001_LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''DD2701_RESULT'',:P21001_LIST_1);'||chr(10)||
'                                       :P21001_PARTIC_LABEL:=''Witness'';'||chr(10)||
'                                       :P21001_PARTIC_WIDGET_VISIBLE:=''Y'';'||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a';

p:=p||' id="FindPartic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
'                                                                ''''''P301_ACTIVE_FILTER_EXCLUDES'''',$v(''''P21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participant...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
'                WHEN ''ACT.LIAISON'' THEN'||chr(10)||
'                                       :P21001_ACTIVI';

p:=p||'TY_DATE_LABEL:=''Liaison Date'';'||chr(10)||
...
'                                       :P21001_LIST_2_LOV:=''- Select -;%null%,'' || osi_refer';

p:=p||'ence.get_lov(''LIAISON_LEVEL'');'||chr(10)||
''||chr(10)||
...
p:=p||'01_TEXT_2_LABEL:=''Media Size'';'||chr(10)||
...
p:=p||'                       :P21001_DATE_2_LABEL:=''Seizure Date'';'||chr(10)||
...
p:=p||'                :P21001_TEXT_3_LABEL:=''Quantity'';'||chr(10)||
'                                       :P21001_LIST_2_LABEL := ''Size Units'';'||chr(10)||
'                                       :P21001_LIST_2_LOV:=''- Select -;%null%,'' || osi_reference.get_lov(''MEDANLY_UNIT'');'||chr(10)||
'                                       :P21001_RADIOGROUP_1_LABEL:=''Removable?'';'||chr(10)||
'                                       :P21001_DATE_2_LABEL:=''Seizure ';
...
p:=p||'   :P21001_ACTIVITY_DATE_LABEL:=''Exam Date'';'||chr(10)||
...
'                                       :P21001_TEXT_5_LABEL:=''Place of Exam';
...
'                                       :P21001_LIST_1_LOV := ''- Select';

p:=p||' -;%null%,'' || osi_reference.get_lov(''LERC_DOCTYPE'');'||chr(10)||
'                                       :P21001_PARTIC_LABEL:=''Subject of Activity'';'||chr(10)||
'                                       :P21001_PARTIC_WIDGET_VISIBLE:=''Y'';'||chr(10)||
...
p:=p||'                                       :P21001_TEXT_6_LABEL:=''Explanation'';'||chr(10)||
'                                       :P21001_PARTIC_WIDGET_VISIBLE:=''Y'';'||chr(10)||
...
p:=p||'   WHEN ''ACT.SOURCE_MEET'' THEN'||chr(10)||
...
p:=p||'                                  :P21001_PARTIC_LABEL:=''Source'';'||chr(10)||
'                                       :P21001_PARTIC_WIDGET_VISIBLE:=''Y'';'||chr(10)||
'                                       :P21001_PARTIC_TYPE_EXCLUDES:='''';'||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','''''' ||'||chr(10)||
'                               ';

p:=p||'                                 '''''','''''''',''''Choose Source Number...'''',''''SOURCE'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
...
p:=p||'          :P21001_LIST_1_LABEL := ''Surveillance Information Type'';'||chr(10)||
...
p:=p||'                                      :P21001_RADIOGROUP_4_LABEL:=''IG Report'';'||chr(10)||
...
'                                                         from V_OSI_CONSULT_CREATE_TYPES WHERE ACTIVE=''Y''  order by 1)'||chr(10)||
'                                         loop'||chr(10)||
'                                             :P21001_LIST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '','';'||chr(10)||
'                                          ';

p:=p||'   if (:P21001_LIST_1 is null) then'||chr(10)||
'                                               :P21001_LIST_1:=a.r;'||chr(10)||
'                                             end if; '||chr(10)||
'                                         end loop;'||chr(10)||
''||chr(10)||
'                                         :P21001_LIST_2_LABEL:=''Method'';'||chr(10)||
'                                         :P21001_LIST_2_LOV:=''- Select -;%null%,'' || osi_reference.get_lov(''CONTACT_M';
...
p:=p||'             for a in (select d,r '||chr(10)||
'                                                         from V_OSI_COORDIN_CREATE_TYPES WHERE ACTIVE=''Y'' order by 1)'||chr(10)||
'                                         loop'||chr(10)||
'                                             :P21001_LIST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '',''; '||chr(10)||
'                                             if (:P21001_LIST_1';
...
p:=p||'                                   :P21001_ACTIVITY_DATE_LABEL:=''Activity Date'';'||chr(10)||
'                                           :P21001_PARTIC_LABEL:=''Subject'';'||chr(10)||
''||chr(10)||
'                                         end if;'||chr(10)||
''||chr(10)||
...
p:=p||'ST_2_LOV:=''- Select -;%null%'';'||chr(10)||
''||chr(10)||
'end if;'||chr(10)||
''||chr(10)||
...
'end if;'||chr(10)||
''||chr(10)||
'if :P21001_activity_date is null th';
