...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   09:36 Tuesday October 16, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:02 Tuesday October 16, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20121016115506',
...
p:=p||'1_LIST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '',''; '||chr(10)||
'                                         end loop;'||chr(10)||
''||chr(10)||
'                                         begin'||chr(10)||
...
''||chr(10)||
'                                       elsif (substr(:P21001_OBJ_TYPE_CODE,1,16)=''ACT.COO';

p:=p||'RDINATION'') then'||chr(10)||
''||chr(10)||
...
p:=p||'OSI_COORDIN_CREATE_TYPES order by 1)'||chr(10)||
'                                         loop'||chr(10)||
'                                             :P21001_LIST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '',''; '||chr(10)||
'                                         end loop;'||chr(10)||
''||chr(10)||
'                                         begin'||chr(10)||
'                                              select sid into :P21001_LIST_1 fro';

p:=p||'m t_core_obj_type where code =''ACT.COORDINATION.FORENSICS'';'||chr(10)||
''||chr(10)||
'                                         exception when others then'||chr(10)||
''||chr(10)||
'                                                  null;'||chr(10)||
...
''||chr(10)||
'                                         :P21001_LIST_2_LABEL:=''Method'';'||chr(10)||
'                                         :P21001_LIST_2_LOV:=''- Select -;%null%,'' || osi_refe';

p:=p||'rence.get_lov(''CONTACT_METHOD'');'||chr(10)||
''||chr(10)||
'                                       else'||chr(10)||
'                                         '||chr(10)||
...
p:=p||'if :P21001_LIST_2_LOV = '''' then'||chr(10)||
''||chr(10)||
'  :P21001_LIST_2_LOV:=''- Select -;%null%'';'||chr(10)||
''||chr(10)||
'end if;'||chr(10)||
