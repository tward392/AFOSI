...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:33 Friday August 3, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120803073105',
...
'                          instead of createObject.'||chr(10)||
''||chr(10)||
'03-Aug-2012 - Tim Ward - P0_OBJ Passing in the Page Branches.'||chr(10)||
'                          Added Cancel Process and made Cancel Button use it '||chr(10)||
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11215,
  p_branch_action=> 'f?p=&APP_ID.:11215:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P11215_OBJ.',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P11215_SID,'||chr(10)||
'P11215_USER_CAN_MARK_OM,'||chr(10)||
'P11215_PREV_ITEM,'||chr(10)||
'P11215_EXPORT_NAME,'||chr(10)||
'P11215_POSSIBLE_ACT_TYPES,'||chr(10)||
'P11215_OBJECTIVE_SID,'||chr(10)||
'P11215_COMMENTS,'||chr(10)||
'P11215_OBJECTIVE_MET_LOCKOUT,'||chr(10)||
'P11215_OBJECTIVE_MET';

wwv_flow_api.create_page_process(
  p_id     => 15718414300682134 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11215,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>1679117195480634 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
