...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   14:00 Thursday August 2, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120802140033',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '02-Aug-2012 - Tim Ward - P0_OBJ Passing in the Page Branches.');
 
wwv_flow_api.set_html_page_header(p_flow_id=>wwv_flow.g_flow_id,p_flow_step_id=>11140,p_text=>ph);
end;
...
'                         item_values:''&P11140_SEL_SPECIFICATION.''});',
