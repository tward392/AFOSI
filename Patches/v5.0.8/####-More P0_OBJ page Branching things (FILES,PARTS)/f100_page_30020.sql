...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:54 Monday August 6, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120806065421',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '22-NOV-2010 J.Faris - Fixed the Known DOB JQuery date field to have conditional read-only attributes.'||chr(10)||
...
wwv_flow_api.create_page_item(
  ...
  p_cHeight=> 5,
  p_cAttributes=> 'nowrap="nowrap"',
  p_tag_attributes  => 'class="datepickernew&P30020_KDOB_RO."',
  p_begin_on_new_line => 'NO',
  p_begin_on_new_field=> 'YES',
  p_colspan => 1,
  p_rowspan => 1,
...
wwv_flow_api.create_page_item(
  ...
  p_cHeight=> 5,
  p_cAttributes=> 'nowrap="nowrap"',
  p_tag_attributes  => '&P30020_AEB_RO.',
  p_begin_on_new_line => 'YES',
  p_begin_on_new_field=> 'YES',
  p_colspan => 2,
  p_rowspan => 1,
...
begin
wwv_flow_api.create_page_item(
  p_id=>97897630451080548 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30020,
  p_name=>'P30020_KDOB_RO',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 26,
  p_item_plug_id => 93270931184523610+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>97897806340083029 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30020,
  p_name=>'P30020_AEB_RO',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 32,
  p_item_plug_id => 93270931184523610+wwv_flow_api.g_id_offset,
...
'    function is_numeric(p_value in varchar2)'||chr(10)||
...
'        end if;'||chr(10)||
'    elsif(upper(:p30020_aeb1) in(''NN'', ''NB'', ''BB'')) then'||chr(10)||
'        return null;'||chr(10)||
'    else'||chr(10)||
...
'        if (upper(:p30020_aeb1) in(''NN'', ''NB'', ''BB'')) then'||chr(10)||
'            if (:p30020_aeb2 is null or :p30020_aeb2 >= 2 and :p30020_aeb2 <= 99) then'||chr(10)||
'                return null;'||chr(10)||
'            else'||chr(10)||
'                return ''When Age Low in (NN, NB, BB) then Age High must be empty or 2-99.'';'||chr(10)||
'            end if;'||chr(10)||
'        elsif(:p30020_aeb2 >= 2 and :p30020_aeb2 <= 99) then'||chr(10)||
'            return null;'||chr(10)||
'        else'||chr(10)||
'            return ''Age High must be between 2 and 99.'';'||chr(10)||
'        end if;'||chr(10)||
'    elsif(upper(:p30020_aeb2) in(''NN'', ''NB'', ''BB'')) then'||chr(10)||
'        return ''Only Age Low can be NN for under 24 hours old, NB for 1-6 days old and BB for 7-364 days old.'';'||chr(10)||
'    else'||chr(10)||
'        return ''Invalid value for Age High.'';'||chr(10)||
'    end if;'||chr(10)||
'end;',
  p_validation_type => 'FUNC_BODY_RETURNING_ERR_TEXT',
  p_error_message => 'Age estimated values must be numeric.',
...
'    end if;'||chr(10)||
''||chr(10)||
'    if (:p30020_aeb1 is null and :p30020_kdob is null) then'||chr(10)||
'        :p30020_age';

p:=p||'_options := ''AU'';'||chr(10)||
...
begin
p:=p||'begin'||chr(10)||
'    if (:p30020_age_options = ''KDOB'') then'||chr(10)||
'        :p30020_kdob_ro := null;'||chr(10)||
'        :p30020_aeb1 := null;'||chr(10)||
'        :p30020_aeb2 := null;'||chr(10)||
'        :p30020_aeb_ro := :disable_text;'||chr(10)||
'    elsif(:p30020_age_options = ''AEB'') then'||chr(10)||
'        :p30020_kdob_ro := ''({ disabled: true })''; -- was :disable_text'||chr(10)||
'        :p30020_kdob := null;'||chr(10)||
'        :p30020_aeb_ro := null;'||chr(10)||
'    else'||chr(10)||
'        :p30020_aeb_ro := :dis';

p:=p||'able_text;'||chr(10)||
'        :p30020_kdob_ro := ''({ disabled: true })''; -- was :disable_text'||chr(10)||
'        :p30020_kdob := null;'||chr(10)||
'        :p30020_aeb1 := null;'||chr(10)||
'        :p30020_aeb2 := null;'||chr(10)||
...
wwv_flow_api.create_page_process(
  p_id     => 97901513985662442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30020,
...
begin
p:=p||'begin'||chr(10)||
'    case :p30020_age_options'||chr(10)||
'        when ''KDOB'' then'||chr(10)||
'            :p30020_age_display := ''Save to update.'';'||chr(10)||
'            :p30020_aeb1 := null;'||chr(10)||
'            :p30020_aeb2 := null;'||chr(10)||
'        when ''AEB'' then'||chr(10)||
'            :p30020_age_display := ''Estimated'';'||chr(10)||
'            :p30020_kdob := null;'||chr(10)||
'        when ''AU'' then'||chr(10)||
'            :p30020_age_display := ''Unknown'';'||chr(10)||
...
p:=p||'   :p30020_aeb2 := null;'||chr(10)||
'            :p30020_kdob := null;'||chr(10)||
'    end case;'||chr(10)||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 93441229431053520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30020,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'PLSQL',
  p_process_name=> 'Change age selection',
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when=>'P30020_AGE_OPTIONS,SAVE',
