...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:00 Monday August 6, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 30310
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>30310);
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120806125831',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30310,
  p_branch_action=> 'f?p=&APP_ID.:30310:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P30310_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
begin
wwv_flow_api.create_page_item(
  p_id=>15810728166569562 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30310,
  p_name=>'P30310_OBJ1',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  ...
  p_post_element_text=>'<a href="javascript:openLocator(''301'',''P30310_UNIT_SID'',''N'','''',''OPEN'','''','''',''Choose Supporting Unit...'',''UNITS'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(500,''P30310_UNIT_SID'',''N'',''&P30310_UNIT_SID.'');">&ICON_LOCATOR.</a>'||chr(10)||
''||chr(10)||
'<a href="javascript:popup({page:150,name:''UNITLOC&P0_OBJ.'',clear_cache:''150'',item_names:''P150_VIEW,P150_RETURN_ITEM,P150_EXCLUDE_ITEMS'',item_values:''OSI.LOC.UNIT,P5450_UNIT_SID,&P5450_UNIT_EXCLUDE.''});">&ICON_LOCATOR.</a>');
...
wwv_flow_api.create_page_computation(
  p_id=> 15810900247570990 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30310,
  p_computation_sequence => 10,
  p_computation_item=> 'P30310_OBJ1',
