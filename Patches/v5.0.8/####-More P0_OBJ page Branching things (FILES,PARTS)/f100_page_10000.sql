...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120802121444',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10000,
  p_branch_action=> 'f?p=&APP_ID.:10000:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P10000_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  p_id=>15625823024746331 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10000,
  p_name=>'P10000_OBJ',
  p_data_type=> 'VARCHAR',
