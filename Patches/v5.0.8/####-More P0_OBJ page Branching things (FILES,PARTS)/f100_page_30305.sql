...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:55 Monday August 6, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
ph:=ph||'oSubmit(''ACTIVATE_UNIT'');'||chr(10)||
'  }    '||chr(10)||
'</script>';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120806125520',
...
''||chr(10)||
'03-Jan-2012 Tim Ward - CR#3655 - View/Find/Create Widget Button Alignment issue.'||chr(10)||
''||chr(10)||
'27-Feb-2012 - Tim Ward - CR#4002 - Changed to JQuery Locators Page #301.'||chr(10)||
''||chr(10)||
'14-Mar-2012 - Tim Ward - CR#3995 - Unit Name Validation Check Fails when saving.'||chr(10)||
'                          Needs to check T_OSI_UNIT_NAME.END_DATE IS NULL.');
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30305,
  p_branch_action=> 'f?p=&APP_ID.:30305:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P30305_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P30305_PARENT_UNIT_SID'',''N'',''&P30305_PARENT_UNIT_SID.~&P0_OBJ.'',''OPEN'','''','''',''Choose Parent Unit...'',''UNITS'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(500,''P30305_PARENT_UNIT_SID'',''N'',''&P30305_PARENT_UNIT_SID.~&P0_OBJ.'');">&ICON_LOCATOR.</a>');
...
begin
wwv_flow_api.create_page_item(
  p_id=>15809619939548299 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30305,
  p_name=>'P30305_OBJ',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 15809825480549863 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30305,
  p_computation_sequence => 10,
  p_computation_item=> 'P30305_OBJ',
...
'               where oun.unit_name = :P30305_UNIT_NAME and ou.sid = oun.unit and ou.sid <> :p0_obj and oun.end_date is null)'||chr(10)||
'    loop'||chr(10)||
'        return false;'||chr(10)||
'    end loop;'||chr(10)||
''||chr(10)||
