...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:54 Thursday August 2, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120802122203',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11105,
  p_branch_action=> 'f?p=&APP_ID.:11105:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P11105_INVESTIGATION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P11105_SUMMARY_ALLEGATION,'||chr(10)||
'P11105_SUMMARY_INVESTIGATION,'||chr(10)||
'P11105_INVESTIGATIVE_TYPE,'||chr(10)||
'P11105_MANAGE_BY,'||chr(10)||
'P11105_AFRC,'||chr(10)||
'P11105_SPECIAL_INTEREST,'||chr(10)||
'P11105_NOTIFY_UNITS,'||chr(10)||
'P11105_NOTIFY_UNITS_DISPLAY';

wwv_flow_api.create_page_process(
  p_id     => 15626422856784126 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11105,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>94010425924215014 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
