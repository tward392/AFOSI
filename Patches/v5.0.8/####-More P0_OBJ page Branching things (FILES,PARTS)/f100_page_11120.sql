...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:59 Thursday August 2, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
PROMPT ...Remove page 11120
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>11120);
...
'     openLocator(''301'',''P11120_OFFENSE'',''Y'',''&P11120_EXCLUDE_SIDS.'',''OPEN'','''','''',''Choose Matters Investigated...'',''OFFENSE'',''&P0_OBJ.'');'||chr(10)||
''||chr(10)||
'    }'||chr(10)||
' }'||chr(10)||
'</script>',
...
'  }'||chr(10)||
''||chr(10)||
'  $(''.OffenseAddButton'').after(''<a class="htmlButton" href="&P11120_URL_EOF18." target="_blank">View USC Title 18 Elements of Offense</a>'');'||chr(10)||
'  $(''.OffenseAddButton'').after(''<a class="htmlButton" href="&P11120_URL_EOF." target="_blank">View Elements of Offense</a>'');'||chr(10)||
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120802125941',
...
''||chr(10)||
'03-Apr-2012 - Tim Ward - CR#3476 - Added the two View Elements of '||chr(10)||
'                          Offense buttons.'||chr(10)||
'                          Added Items P11120_URL_EOF and P11120_URL_EOF18.'||chr(10)||
'                          Added class="htmlButton OffenseAddButton" to the '||chr(10)||
'                           add offense(s) button.'||chr(10)||
'                          Changed page page footer text to append the '||chr(10)||
'                           two buttons after the Offense Add button.'||chr(10)||
'                          Added "Get EOF URLs" page process.'||chr(10)||
'                          Added links to T_CORE_CONFIG (OSI.URL_EOF &'||chr(10)||
'                           OSI.URL_EOF18).'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'class="htmlButton OffenseAddButton"',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11120,
  p_branch_action=> 'f?p=&APP_ID.:11120:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P11120_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_post_element_text=>'<a href="javascript:openLocator(''301'',''P11120_OFFENSE'',''Y'',''&P11120_EXCLUDE_SIDS.'',''OPEN'','''','''',''Choose Matters Investigated...'',''OFFENSE'',''&P0_OBJ.'');" style="vertical-align:bottom; padding-left:2px;">&ICON_LOCATOR.</a>'||chr(10)||
'',
  ...
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(550,''P11120_OFFENSE'',''Y'', ''&P11120_EXCLUDE_SIDS.'');">&ICON_LOCATOR.</a>');
...
begin
wwv_flow_api.create_page_item(
  p_id=>12768812198689911 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11120,
  p_name=>'P11120_URL_EOF',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
...
begin
wwv_flow_api.create_page_item(
  p_id=>12769304111753775 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11120,
  p_name=>'P11120_URL_EOF18',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 4,
  p_item_plug_id => 96244715386767984+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15652913749999103 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11120,
  p_name=>'P11120_OBJ',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||':P11120_OBJ:=:P0_OBJ;';

wwv_flow_api.create_page_process(
  p_id     => 15653023445001923 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11120,
  p_process_sequence=> 1,
...
p:=p||'begin'||chr(10)||
''||chr(10)||
'     :p11120_url_eof:=core_util.get_config(''OSI.URL_EOF'');'||chr(10)||
'     :p11120_url_eof18:=core_util.get_config(''OSI.URL_EOF18'');'||chr(10)||
''||chr(10)||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 12771224159806928 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11120,
  p_process_sequence=> 70,
  p_process_point=> 'BEFORE_HEADER',
  p_process_type=> 'PLSQL',
  p_process_name=> 'Get EOF URLs',
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
