...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120802121208',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10250,
  p_branch_action=> 'f?p=&APP_ID.:10250:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P10250_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
begin
wwv_flow_api.create_page_item(
  p_id=>15625027133719090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10250,
  p_name=>'P10250_OBJ',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P10250_SID,'||chr(10)||
'P10250_TITLE,'||chr(10)||
'P10250_RESTRICTION_VAL,'||chr(10)||
'P10250_RESTRICTION';

wwv_flow_api.create_page_process(
  p_id     => 15625310773733332 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10250,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>93566726872812198 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
