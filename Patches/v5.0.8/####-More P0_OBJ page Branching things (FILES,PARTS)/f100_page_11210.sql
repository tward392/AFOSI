...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:27 Friday August 3, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11210,
  p_branch_action=> 'f?p=&APP_ID.:11210:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P11210_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
begin
wwv_flow_api.create_page_item(
  p_id=>15717109620642979 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11210,
  p_name=>'P11210_OBJ',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 15717314468644379 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11210,
  p_computation_sequence => 10,
  p_computation_item=> 'P11210_OBJ',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P11210_SID,'||chr(10)||
'P11210_SYNOPSIS,'||chr(10)||
'P11210_BACKGROUND';

wwv_flow_api.create_page_process(
  p_id     => 15717702479650321 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11210,
  ...
  p_process_when_button_id=>1674108931156517 + wwv_flow_api.g_id_offset,
