...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:43 Monday October 22, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'                                        showField(''P21001_DATE_2'',true,fa';
...
'                                        showField(''P21001_TEXT_3'',false,false';
...
'                                        showField(''P21001_LIST_1'',false,false);'||chr(10)||
'                                        showField(''P21001_LIST_2'',false,false);'||chr(10)||
'                                        makeLabelRequired(''P21001_LIST_1';
...
'                                        showField(''P21001_HOUR'',false,false);'||chr(10)||
'                                        showField(''P21001_MINUTE'',false,false);'||chr(10)||
'                                        showField(''P21001_HOUR_2'',false,f';
...
ph:=ph||'                               showField(''P21001_DOCUMENT_NUMBER'',false,false);'||chr(10)||
'                                        showParticWidget();'||chr(10)||
'                                        makeLabelRequired(''P21001_LIST_1'');'||chr(10)||
...
ph:=ph||'LabelRequired(''P21001_TEXT_6'');'||chr(10)||
'                                              hideParticWidget();'||chr(10)||
'                                             }'||chr(10)||
'                                          }'||chr(10)||
'                                        break;'||chr(10)||
...
ph:=ph||'keLabelRequired(''P21001_PARTIC_DISPLAY'');'||chr(10)||
...
ph:=ph||'            makeLabelRequired(''P21001_TEXT_9'');'||chr(10)||
''||chr(10)||
...
ph:=ph||'i < items.length; i++) '||chr(10)||
'                                                 {'||chr(10)||
'                                                  if(items[i].length>0)'||chr(10)||
'                                                    {'||chr(10)||
'                                                     var values = items[i].split('';'');'||chr(10)||
'                                                     $(''#P21001_LIST_2'').children().end().append(''<option value=';

ph:=ph||'"''+values[1]+''">''+values[0]+''</option>'');'||chr(10)||
'                                                    }'||chr(10)||
'                                                 }'||chr(10)||
'                                             }'||chr(10)||
'                                          }'||chr(10)||
...
'                                        hideField(''P21001_PAY_CAT'',false,false)';
...
'                                        hideField(''P21001_COMPLETE'',false,';
...
ph:=ph||'RADIOGROUP_1'',false,false);'||chr(10)||
'                                        break;'||chr(10)||
''||chr(10)||
'                                default:'||chr(10)||
...
ph:=ph||'001_LIST_2'',false,false);'||chr(10)||
'                                           makeLabelRequired(''P21001_HOUR'');'||chr(10)||
'                                           makeLabelRequired(''P21001_LIST_1'');'||chr(10)||
'                                           makeLabelRequired(''P21001_LIST_2'');'||chr(10)||
'  '||chr(10)||
...
ph:=ph||'                                      var list = document.getElementById(''P21001_LIST_1'');'||chr(10)||
'                                           if(list!=null)'||chr(10)||
'                                             {'||chr(10)||
...
'                                                          ''Please talk to your Unit Commander about assigning yo';

ph:=ph||'u permissions for ''+$("#P21001_ACTIVITY_DATE_LABEL").val().replace('' Date'','''')+'' Activity Types that you need to create.'');'||chr(10)||
''||chr(10)||
'                                                    window.close();'||chr(10)||
'                                                   }'||chr(10)||
'                                                }'||chr(10)||
...
''||chr(10)||
'    if (src.indexOf("plus.gif")>-1 || pHideParticDetails=="N")'||chr(10)||
'      {'||chr(10)||
'    ';

ph:=ph||'   showField(''P21001_PARTICIPANT_DETAILS'',false,false);'||chr(10)||
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20121022124323',
...
p:=p||'VE_FILTER_EXCLUDES'''',$v(''''P21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participant...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
'      WHEN ''ACT.INTERVIEW.WITNESS'' THEN'||chr(10)||
'                                       :P21001_ACTIVITY_DATE_LABEL:=''Interview Date'';'||chr(10)||
'                                       :P21001_HOUR_LABEL:=''Interview Time'';'||chr(10)||
'                                       :P21001_PARTIC_LABEL:=''Witnes';

p:=p||'s'';'||chr(10)||
'                                       :P21001_PARTIC_WIDGET_VISIBLE:=''Y'';'||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a id="FindPartic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
'                                                                ''''''P301_ACTIVE_FILTER_EXCLUDES'''',$v(''''P21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participan';

p:=p||'t...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
...
p:=p||'               :P21001_LIST_2_LABEL:=''Liaison Level'';'||chr(10)||
...
p:=p||'                   :P21001_LIST_1_LOV:=''- Select -;%null%,'' || osi_reference.get_lov(''MEDANLY_TYPE'');'||chr(10)||
'                                       :P21001_TEXT_2_LABEL:=''Media Size'';'||chr(10)||
'                                       :P21001_TEXT_3_LABEL:=''Quantity'';'||chr(10)||
'                                       :P21001_LIST_2_LABEL := ''Size Units'';'||chr(10)||
'                                       :P21001_LIST_2_LOV:=''- Select -;%n';

p:=p||'ull%,'' || osi_reference.get_lov(''MEDANLY_UNIT'');'||chr(10)||
...
p:=p||'       :P21001_DATE_5_LABEL:=''Analysis End Date'';'||chr(10)||
'                                       :P21001_TEXT_4_LABEL:=''Comments'';'||chr(10)||
''||chr(10)||
'         WHEN ''ACT.MEDIA_ANALYSIS'' THEN'||chr(10)||
'                                       :P21001_ACTIVITY_DATE_LABEL:=''Activity Date'';'||chr(10)||
'                                       :P21001_LIST_1_LABEL := ''Media Type'';'||chr(10)||
'                                       :P21001_LIST_1_LOV:=''- Select -;%nu';

p:=p||'ll%,'' || osi_reference.get_lov(''MEDANLY_TYPE'');'||chr(10)||
'                                       :P21001_TEXT_2_LABEL:=''Media Size'';'||chr(10)||
'                                       :P21001_TEXT_3_LABEL:=''Quantity'';'||chr(10)||
'                                       :P21001_LIST_2_LABEL := ''Size Units'';'||chr(10)||
...
p:=p||'_1_LOV:=''- Select -;%null%,'' || osi_reference.get_lov(''POLY_MONITOR'');'||chr(10)||
...
p:=p||'21001_LIST_1_LABEL := ''Record Type'';'||chr(10)||
...
p:=p||'1_FIND_WIDGET_SRC:=''<a id="FindPartic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
'                                                                ''''''P301_ACTIVE_FILTER_EXCLUDES'''',$v(''''P21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participant...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
...
p:=p||'arch'' order by description)'||chr(10)||
'                                       loop'||chr(10)||
...
p:=p||'IST_2_LABEL := ''Search Based Upon'';'||chr(10)||
'                                       :P21001_LIST_2_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''SEARCH_BASIS'');'||chr(10)||
'  '||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a id="FindPartic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
'                                                                ''''''P';

p:=p||'301_ACTIVE_FILTER_EXCLUDES'''',$v(''''P21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participant...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
...
p:=p||'                       :P21001_LIST_1_LABEL := ''Interview Type'';'||chr(10)||
...
p:=p||'                            :P21001_LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''SUSPACT_CATEGORY'');'||chr(10)||
...
p:=p||'                       :P21001_RADIOGROUP_2_LABEL:=''Emergency'';'||chr(10)||
'                                       :P21001_RADIOGROUP_3_LABEL:=''Consensual'';'||chr(10)||
'                                       :P21001_RADIOGROUP_4_LABEL:=''IG Report'';'||chr(10)||
'                                       :P21001_LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''SURV_INFO_TYPE'');'||chr(10)||
'                                       :P21001_TE';

p:=p||'XT_9_LABEL := ''Requested Duration'';'||chr(10)||
...
p:=p||'          :P21001_LIST_1_LABEL := ''Category of Suspicious Activity'';'||chr(10)||
...
'                                             if (:P21001_LIST_1 is null) then'||chr(10)||
...
p:=p||'1001_LIST_2_LABEL:=''Method'';'||chr(10)||
...
p:=p||'ST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '',''; '||chr(10)||
'                                             if (:P21001_LIST_1 is null) then'||chr(10)||
'                                               :P21001_LIST_1:=a.r;'||chr(10)||
'                                             end if; '||chr(10)||
'                                         end loop;'||chr(10)||
''||chr(10)||
'                                         :P21001_LIST_2_LABEL:=''M';
...
p:=p||':P21001_duty_cat_lov is null then'||chr(10)||
''||chr(10)||
