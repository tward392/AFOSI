...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   09:05 Thursday November 8, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
' if (imSure)'||chr(10)||
'   {'||chr(10)||
'    window.location = ''f?p=&APP_ID.:30720:&SESSION.'' + '':OPEN:NO:30720:P0_OBJ:&P0_OBJ.'';'||chr(10)||
'   }'||chr(10)||
'}'||chr(10)||
''||chr(10)||
...
ph:=ph||'ryPopWin(''Evidence Transaction Log'',''P0_OBJ,P30715_EVIDENCE'',''&P0_OBJ.,''+pEvidence,''30715'');'||chr(10)||
'}'||chr(10)||
''||chr(10)||
'function proccessTransaction(pRequest, pWinTitle)'||chr(10)||
'{'||chr(10)||
' var pSids=''~'';'||chr(10)||
' var pTotalChecked = 0;'||chr(10)||
' '||chr(10)||
' if(typeof pWinTitle===''undefined'')'||chr(10)||
'   pWinTitle=pRequest.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();});'||chr(10)||
''||chr(10)||
' switch(pRequest)'||chr(10)||
' {'||chr(10)||
'      case ''LOGIN'':'||chr(10)||
'     case';
...
'                      {'||chr(10)||
'                       pSids=pSids+this.value+''~'';'||chr(10)||
'                       pTotalChecked+=1;'||chr(10)||
'                      }'||chr(10)||
'  ';

ph:=ph||'                 });'||chr(10)||
''||chr(10)||
'                   if(pTotalChecked==0)'||chr(10)||
'                     alert(''No Evidence Selected.'');'||chr(10)||
'                   else'||chr(10)||
'                     {'||chr(10)||
'                      if(pTotalChecked>1 && (pRequest==''REJECT'' || pRequest==''UNDISPOSE'' || pRequest==''SPLIT''))'||chr(10)||
'                        alert(''This transaction does not support multiple evidence selections.  Please select a single evidenc';

ph:=ph||'e item.'');'||chr(10)||
'                      else'||chr(10)||
'                        runJQueryPopWin(pWinTitle.replace('' Evidence'','''')+'' Evidence'',''P0_OBJ,P30710_TRANS_SIDS,P30710_TRANS_TYPE'',''&P0_OBJ.,''+pSids+'',''+pRequest,''30710'',0,0,''OPEN'');'||chr(10)||
'                     }'||chr(10)||
''||chr(10)||
'           default:'||chr(10)||
'                   break;'||chr(10)||
...
'});'||chr(10)||
''||chr(10)||
'function getFileList()'||chr(10)||
'{'||chr(10)||
' var get = new htmldb_Get(null,'||chr(10)||
'                          $v(''pFlowId''),'||chr(10)||
'                          ''APPLICATION_PROCESS=EVIDENCE_FILE_LIST'','||chr(10)||
'                          $v(''pFlowStepId''));'||chr(10)||
''||chr(10)||
' get.addParam(''x01'',$("#P0_OBJ").val());'||chr(10)||
' get.addParam(''x02'',($("#P30700_HIDE_DISPOSED_0").prop("checked")==true) ? "Y" : "N");'||chr(10)||
''||chr(10)||
' gReturn = $.trim(get.get());'||chr(10)||
''||chr(10)||
' $("#P30700_FILE_LIST").val(gReturn);'||chr(10)||
''||chr(10)||
' $(''#FILE_TO_FILTER_ON'').children().remove().end().append(''<option selected value="ALL">- Select File -</option>'');'||chr(10)||
''||chr(10)||
...
'        $(''#FILE_TO_FILTER_ON'').children().end().append(''<option value="''+values[1]+''">''+values[0]+''</option>'');'||chr(10)||
'       }'||chr(10)||
'    }'||chr(10)||
'}'||chr(10)||
''||chr(10)||
'function filterChanged()'||chr(10)||
'{'||chr(10)||
' $("#ApplyFilterButton").css(''color'',''red'');'||chr(10)||
'}'||chr(10)||
''||chr(10)||
'$(document).ready(function() '||chr(10)||
'{'||chr(10)||
' if (''&REQUEST.''==''OPEN'')'||chr(10)||
'   {'||chr(10)||
'    $("#P30700_HIDE_DISPOSED_0").prop("checked",true);'||chr(10)||
'    getFileList();'||chr(10)||
'   }'||chr(10)||
''||chr(10)||
' //$(''.title'').remove();'||chr(10)||
'  $("label.tooltip").tipsy({live: true, fade: true, gravity: "n", title: "tip"});'||chr(10)||
'});'||chr(10)||
'</script>'||chr(10)||
''||chr(10)||
'',
  ...
  p_last_upd_yyyymmddhh24miss => '20121108090544',
...
''||chr(10)||
'16-Jul-2012 - Tim Ward - CR#3986 - Filter changes now require button press.'||chr(10)||
'16-Jul-2012 - Tim Ward - CR#3999 - Made text fields 100% width.'||chr(10)||
'14-Sep-2012 - Tim Ward - CR#4034 - Undo until the Description problem is fixed.'||chr(10)||
'                                    multi logged in evidence ends up with the'||chr(10)||
'                                    same description.'||chr(10)||
''||chr(10)||
'03-Aug-2012 - Tim Ward - P0_OBJ Passing in the Page Branches.'||chr(10)||
''||chr(10)||
'27-Aug-2012 - Tim Ward - Made Transaction use jQuery Dialog instead of '||chr(10)||
'                          browser pop-up.'||chr(10)||
''||chr(10)||
'08-Nov-2012 - Tim Ward - CR#4149 - EMM Incorrectly displaying received from'||chr(10)||
'                          information.');
...
wwv_flow_api.create_page_plug (
  ...
  p_pagination_display_position=>'BOTTOM_RIGHT',
  p_plug_header=> '<div id="filterDIV" style="border:1px solid; border-radius:25px; -moz-border-radius:25px;">'||chr(10)||
'<a id="ApplyFilterButton" class="htmlButton" onclick="mySubmit(''APPLY_FILTERS'',this);" style="float:none; margin:0px 0px 0px 15px;" href="javascript:doSubmit(''APPLY_FILTERS'')">Apply Filters Changes</a>'||chr(10)||
'<br>',
  p_plug_footer=> '</div>',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onclick="javascript:window.open(''f?p=100:800:&SESSION.::&DEBUG.::P800_REPORT_TYPE,P0_OBJ,P800_PARAM_2:&P30700_I2MS_RPT.,&P0_OBJ.,&P30700_SEL_EVIDENCE.'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '#',
  p_button_cattributes=>'onclick="javascript:window.open(''f?p=100:800:&SESSION.::&DEBUG.::P800_REPORT_TYPE,P0_OBJ,P800_PARAM_2:&P30700_ORIG_RPT.,&P0_OBJ.,&P30700_SEL_EVIDENCE.'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''REJECT'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'instr(:P30700_FILTER, ''XFER'')>0',
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''LOGIN'',''Log In'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''LOGOUT'', ''Log Out'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_condition=> 'instr(:P30700_FILTER, ''LOGIN'')>0',
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''TRANSFER'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_condition=> 'instr(:P30700_FILTER,''LOGIN'')>0',
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''SPLIT'',''Derivative Evidence'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'instr(:P30700_FILTER,''LOGIN'')>0',
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''DISPOSE'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''UNDISPOSE'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_condition=> 'instr(:P30700_FILTER,''LOGIN'')>0',
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'onClick="javascript:proccessTransaction(''COMMENT'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '#',
  p_button_cattributes=>'onclick="javascript:window.open(''f?p=100:800:&SESSION.::&DEBUG.::P0_OBJ,P800_REPORT_TYPE:&P0_OBJ.,&P30700_MANUAL_RPT.'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_condition=> 'P30700_DAFORM4137_RPT',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 14931001306407774 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30700,
  p_button_sequence=> 140,
  p_button_plug_id => 8453232589922307+wwv_flow_api.g_id_offset,
  p_button_name    => 'DDForm2922',
  p_button_image   => 'template:'||to_char(179221063608554498+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'DD Form 2922',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=&APP_ID.:800:&SESSION.::&DEBUG.:800:P800_REPORT_TYPE,P0_OBJ,P800_PARAM_2:&P30700_DDFORM2922_RPT.,&P0_OBJ.,&P30700_SEL_EVIDENCE.',
  p_button_condition=> 'P30700_DDFORM2922_RPT',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_branch_action=> 'f?p=&APP_ID.:30700:&SESSION.::&DEBUG.::P0_OBJ:&P30700_OBJ1.#&P30700_SEL_EVIDENCE.',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_branch_action=> 'f?p=&APP_ID.:30700:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P30700_OBJ1.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_tag_attributes  => 'onclick="javascript:filterChanged();"',
...
wwv_flow_api.create_page_item(
  ...
  p_tag_attributes  => 'readOnly style="background-color:#f5f4ea; width:99%;"',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'&P30700_OBTAINED_FROM_LABEL.',
  p_source_type=> 'STATIC',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Filter by File:',
  p_source_type=> 'STATIC',
  p_display_as=> 'COMBOBOX',
  p_lov => 'STATIC2(~,^):&P30700_FILE_LIST.',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  ...
  p_cAttributes=> 'nowrap',
  p_cattributes_element=>'style="width:100%"',
  p_tag_attributes  => 'style="width:100%" onchange="javascript:filterChanged();"',
  p_begin_on_new_line => 'NO',
  p_begin_on_new_field=> 'YES',
  p_colspan => 1,
  p_rowspan => 1,
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => 'Changed from P30700_FILE to FILE_TO_FILTER_ON so the setDirty doesn''t run.'||chr(10)||
''||chr(10)||
'STATIC2:&P30700_FILE_LIST.');
...
wwv_flow_api.create_page_item(
  ...
  p_cHeight=> 5,
  p_cAttributes=> 'nowrap',
  p_tag_attributes  => 'style="margin: 0px 0px 0px 100px;" onclick="javascript:getFileList();"',
  p_begin_on_new_line => 'YES',
  p_begin_on_new_field=> 'YES',
  p_colspan => 1,
  p_rowspan => 1,
...
begin
wwv_flow_api.create_page_item(
  p_id=>14881022970164160 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_name=>'P30700_X',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>14881303362167974 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_name=>'P30700_X1',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 15.5,
  p_item_plug_id => 8303116823235265+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
...
begin
wwv_flow_api.create_page_item(
  p_id=>14884116764389422 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_name=>'P30700_FILE_LIST',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 321,
  p_item_plug_id => 8303116823235265+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>14931323124414108 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_name=>'P30700_DDFORM2922_RPT',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 331,
  p_item_plug_id => 8300810196204981+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15727307062383316 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_name=>'P30700_OBJ1',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17461810607898855 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_name=>'P30700_ACQUISITION_METHOD',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 7,
  p_item_plug_id => 8453232589922307+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>17464608408964421 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_name=>'P30700_OBTAINED_FROM_LABEL',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 8,
  p_item_plug_id => 8453232589922307+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_computation(
  p_id=> 15727513296385077 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30700,
  p_computation_sequence => 20,
  p_computation_item=> 'P30700_OBJ1',
...
declare
  ...
  l_length number := 1;
begin
p:=p||':P30700_FILE_LIST:=''- Select File -^ALL~'' || osi_evidence.get_file_list(:P0_OBJ,:P30700_HIDE_DISPOSED);'||chr(10)||
''||chr(10)||
''||chr(10)||
'if :P30700_FILTER is null then'||chr(10)||
...
'end if;'||chr(10)||
''||chr(10)||
'if :P30700_ORIG_RPT is null the';
...
''||chr(10)||
'/*'||chr(10)||
'if :P30700_DAFORM4137_RPT is null then';
...
'end if;'||chr(10)||
''||chr(10)||
'if :P30700_DDFORM2922_RPT is null then'||chr(10)||
'  select sid into :P30700_DDFORM2922_RPT'||chr(10)||
'    from t_osi_report_type'||chr(10)||
'   where obj_type = core_obj.lookup_objtype(''EMM'')'||chr(10)||
'     and description = ''DD Form 2922'';'||chr(10)||
'end if;'||chr(10)||
'*/'||chr(10)||
''||chr(10)||
'if :p30700_sel_evidence';
...
''||chr(10)||
'    :P30700_STORAGE_LOCATION_RO := ''readOnly style="background-color:#f5f4ea; width:100%;"'';'||chr(10)||
'    :P30700_FINAL_DISP_RO := ''readOnly style="background-color:#f5f';

p:=p||'4ea; width:100%;"'';'||chr(10)||
''||chr(10)||
'  else'||chr(10)||
''||chr(10)||
'    if :P30700_STATUS_CODE = ''X'' then'||chr(10)||
''||chr(10)||
'      :P30700_FINAL_DISP_RO := ''readOnly style="background-color:#f5f4ea; width:100%;"'';'||chr(10)||
''||chr(10)||
'    else'||chr(10)||
''||chr(10)||
'      :P30700_FINAL_DISP_RO := ''style="width:100%;"'';'||chr(10)||
''||chr(10)||
'    end if;'||chr(10)||
'    :P30700_STORAGE_LOCATION_RO := ''style="width:100%;"'';'||chr(10)||
''||chr(10)||
'  end if;'||chr(10)||
''||chr(10)||
...
p:=p||'00_ACQUISITION_METHOD = ''RFS'' then'||chr(10)||
''||chr(10)||
'    :P30700_OBTAINED_FROM_LABEL := ''Received From:'';'||chr(10)||
'    :P30700_OBTAINED_FROM := ''SOURCE'';'||chr(10)||
''||chr(10)||
'  elsif :P30700_ACQUISITION_METHOD = ''ODSO'' then'||chr(10)||
''||chr(10)||
'       :P30700_OBTAINED_FROM_LABEL := osi_evidence.obtained_method(:p30700_sel_evidence);'||chr(10)||
'       :P30700_OBTAINED_FROM := osi_evidence.obtained_detail(:p30700_sel_evidence);'||chr(10)||
''||chr(10)||
'       if length(:P30700_OBTAINED_FROM)>50 the';

p:=p||'n'||chr(10)||
''||chr(10)||
'        :P30700_OBTAINED_FROM := ''<label class="tooltip" tip="'' || :P30700_OBTAINED_FROM || ''" id="obtainedFrom">'' ||substr(osi_evidence.obtained_detail(:p30700_sel_evidence),1,47) || ''...</label>'';'||chr(10)||
''||chr(10)||
'       end if;'||chr(10)||
''||chr(10)||
'  elsif :P30700_ACQUISITION_METHOD IN (''RFP'',''SFP'',''ODSO'') then'||chr(10)||
''||chr(10)||
'       :P30700_OBTAINED_FROM_LABEL := osi_evidence.obtained_method(:p30700_sel_evidence);'||chr(10)||
'       :P30700_OBTAINED_FR';

p:=p||'OM := osi_evidence.obtained_detail(:p30700_sel_evidence);'||chr(10)||
''||chr(10)||
'  else'||chr(10)||
''||chr(10)||
'    :P30700_OBTAINED_FROM_LABEL := ''Received From:'';'||chr(10)||
'    :P30700_OBTAINED_FROM := ''INVESTIGATIVE ACTIVITY'';'||chr(10)||
''||chr(10)||
'  end if;'||chr(10)||
''||chr(10)||
'end if;';
