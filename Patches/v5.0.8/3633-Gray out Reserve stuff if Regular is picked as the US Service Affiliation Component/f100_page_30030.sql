...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:12 Friday October 19, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'function checkReserveAffiliation()'||chr(10)||
'{'||chr(10)||
' if ($(''#P30030_COMPONENT option:selected'').text()==''Reserve'')'||chr(10)||
'   {'||chr(10)||
'    $(''#P30030_RES_TYPE'').removeAttr(''disabled'');'||chr(10)||
'    $(''#P30030_RES_STATUS'').removeAttr(''disabled'');'||chr(10)||
'    $(''#P30030_RESERVE_AFFILIATION_0'').attr(''checked'',false);'||chr(10)||
'    $(''#P30030_RESERVE_AFFILIATION_1'').attr(''checked'',true);'||chr(10)||
'    $(''#P30030';

ph:=ph||'_RESERVE_AFFILIATION_2'').attr(''checked'',false);'||chr(10)||
'   }'||chr(10)||
' else'||chr(10)||
'   {'||chr(10)||
'    $(''#P30030_RES_TYPE'').val('''');'||chr(10)||
'    $(''#P30030_RES_TYPE'').attr(''disabled'', ''disabled'');'||chr(10)||
'    $(''#P30030_RES_STATUS'').val('''');'||chr(10)||
'    $(''#P30030_RES_STATUS'').attr(''disabled'', ''disabled'');'||chr(10)||
'    $(''#P30030_RESERVE_AFFILIATION_0'').attr(''checked'',false);'||chr(10)||
'    $(''#P30030_RESERVE_AFFILIATION_1'').attr(''checked'',false);'||chr(10)||
'    $(''#P30030_RESERVE_AFF';

ph:=ph||'ILIATION_2'').attr(''checked'',true);'||chr(10)||
'   }     '||chr(10)||
'}'||chr(10)||
''||chr(10)||
'$(document).ready(function() '||chr(10)||
'{'||chr(10)||
' checkReserveAffiliation();'||chr(10)||
'});'||chr(10)||
'</script>';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20121019111247',
...
'                                   Changed Setup and Set read only fields.'||chr(10)||
''||chr(10)||
...
''||chr(10)||
'19-Oct-2012 - Tim Ward - CR#3633 - Gray out Reserve Stuff when Component is not'||chr(10)||
'                          set to "Reserve".'||chr(10)||
'');
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30030,
  p_branch_action=> 'f?p=&APP_ID.:30030:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P30030_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P30030_SAPRO_LOCATION_CODE'',''N'','''',''OPEN'','''','''',''Choose Assigned Location...'',''MILITARY_LOCS'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(505,''P30030_SAPRO_LOCATION_CODE'',''N'');">&ICON_LOCATOR.</a>');
...
begin
wwv_flow_api.create_page_item(
  p_id=>15749400081508195 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30030,
  p_name=>'P30030_OBJ',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  ...
  p_cHeight=> 1,
  p_cAttributes=> 'nowrap',
  p_tag_attributes  => '&P30030_COMPONENT_RO. onChange="checkReserveAffiliation();"',
  p_begin_on_new_line => 'YES',
  p_begin_on_new_field=> 'YES',
  p_colspan => 1,
  p_rowspan => 1,
...
wwv_flow_api.create_page_computation(
  p_id=> 15749607353510281 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30030,
  p_computation_sequence => 10,
  p_computation_item=> 'P30030_OBJ',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P30030_SERVICE_LOV,'||chr(10)||
'P30030_AFFILIATION_LOV,'||chr(10)||
'P30030_COMPONENT_LOV,'||chr(10)||
'P30030_PAY_PLAN_LOV,'||chr(10)||
'P30030_RES_TYPE_LOV,'||chr(10)||
'P30030_RES_STATUS_LOV,'||chr(10)||
'P30030_HAS_PAY_BAND,'||chr(10)||
'P30030_CLEARANCE_LOV,'||chr(10)||
'P30030_AFFILIATION_RO,'||chr(10)||
'P30030_COMPONENT_RO,'||chr(10)||
'P30030_SPECIALTY_RO,'||chr(10)||
'P30030_PAY_BAND_RO,'||chr(10)||
'P30030_RA_RO,'||chr(10)||
'P30030_FSA_RO,'||chr(10)||
'P30030_SAPRO_ASS_LOCATION_RO,'||chr(10)||
'P30030_SID,'||chr(10)||
'P30030_SERVICE,'||chr(10)||
'P30030_AFFILIATION,'||chr(10)||
'P30030_AFFIL_MEMBER,'||chr(10)||
'P30030_COMPON';

p:=p||'ENT,'||chr(10)||
'P30030_PAY_PLAN,'||chr(10)||
'P30030_PAY_PLAN_CODE,'||chr(10)||
'P30030_PAY_GRADE,'||chr(10)||
'P30030_PAY_GRADE_CODE,'||chr(10)||
'P30030_PAY_BAND,'||chr(10)||
'P30030_RANK,'||chr(10)||
'P30030_RANK_DATE,'||chr(10)||
'P30030_SPECIALTY,'||chr(10)||
'P30030_SAPRO_LOCATION_CODE,'||chr(10)||
'P30030_INCIDENT_LOCATION,'||chr(10)||
'P30030_MILITARY_INCIDENT_FIND_WIDGET,'||chr(10)||
'P30030_SAPRO_LOCATION_DELETE,'||chr(10)||
'P30030_AFFIL_RETIRE,'||chr(10)||
'P30030_RESERVE_AFFILIATION,'||chr(10)||
'P30030_RES_TYPE,'||chr(10)||
'P30030_RES_STATUS,'||chr(10)||
'P30030_FSA_SERVICE,'||chr(10)||
'P30030_FSA_RANK,'||chr(10)||
'P3003';

p:=p||'0_FSA_EQUIV_RANK,'||chr(10)||
'P30030_FSA_RANK_DATE,'||chr(10)||
'P30030_SUSPECTED_IO,'||chr(10)||
'P30030_KNOWN_IO,'||chr(10)||
'P30030_CLEARANCE';

wwv_flow_api.create_page_process(
  p_id     => 15750301728527544 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30030,
