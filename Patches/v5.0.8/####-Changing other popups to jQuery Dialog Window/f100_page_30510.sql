...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:57 Wednesday August 29, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
''||chr(10)||
' window.parent.document.getElementById(''P30505_DISALLOW_COMMENT'').value = comment;'||chr(10)||
' window.parent.doSubmit(''DISALLOW_EXPENSE'');'||chr(10)||
' closeDialog();'||chr(10)||
'}'||chr(10)||
'</script>';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120829075756',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '15-Aug-2011 - TJW - CR#3789 Change CFunds to EFunds.'||chr(10)||
'29-Aug-2012 - TJW - Changed to use jQuery Dialog instead of browser pop-up.');
