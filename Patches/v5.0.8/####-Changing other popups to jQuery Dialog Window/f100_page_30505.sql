...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:37 Wednesday August 29, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'{'||chr(10)||
' runJQueryPopWin(''Disallow Comments'',''P30510_FROM_OBJ,P30510_FROM_ITEM'',''&P30505_SID., P30505_DISALLOW_COMMENT'',''30510'',655,425);'||chr(10)||
'}'||chr(10)||
'</script>';
...
'',
  ...
  p_last_upd_yyyymmddhh24miss => '20120829073727',
...
''||chr(10)||
'22-Aug-2011 - TJW - Added SEQ to T_CFUNDS_PARAGRAPHS so they display'||chr(10)||
'                    in Numerical Order and not ASCII order.'||chr(10)||
''||chr(10)||
'30-Sep-2011 - TJW - CR#3948 - Addded format mask to "DD-MON-YYYY HH24:MI:SS" '||chr(10)||
'                              for all hidden dates so if saved the instead of '||chr(10)||
'                              trigger on the view doesn''t trim the time from '||chr(10)||
'                              the date.'||chr(10)||
''||chr(10)||
'                              Changed Deduct from Advance to Yes/No only and '||chr(10)||
'                              disable it if status=Rejected.'||chr(10)||
' '||chr(10)||
'                              Changed v_cfunds_expense_v3 to not save '||chr(10)||
'                              the hidden dates on update instead of trigger'||chr(10)||
'                              (they are set via lifecycle changes in the '||chr(10)||
'                              CFUNDS_PKG procedures for each state change '||chr(10)||
'                              and should NOT be updated via the Application '||chr(10)||
'                              Express Page.'||chr(10)||
''||chr(10)||
'                              Changed v_cfunds_expense_v3 to to decode '||chr(10)||
'                              TAKE_FROM_ADVANCE -1=1, 1=1, anything else=0.'||chr(10)||
' '||chr(10)||
'                              Default TAKE_FROM_ADVANCE to 0 (NO) on Create.'||chr(10)||
''||chr(10)||
'27-Feb-2012 - Tim Ward - CR#4002 - Changed to JQuery Locators Page #301.'||chr(10)||
''||chr(10)||
'29-Aug-2012 - Tim Ward - Changed Disallow pop-up to use jQuery Dialog.'||chr(10)||
...
wwv_flow_api.create_page_item(
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => 'STATIC2:- Select Y/N -;2,Yes;-1,No;0'||chr(10)||
'STATIC2:?;2,Yes;-1,No;0  --- Changed to STATIC2:?;NULL,Yes;1,No;0');
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P30505_CHARGE_UNIT'',''N'',''&P30505_CHARGE_UNIT.'',''OPEN'','''','''',''Choose Unit Charged with Expense...'',''UNITS_EFUNDS'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(650,''P30505_CHARGE_UNIT'',''N'',''&P30505_CHARGE_UNIT.'');">&ICON_LOCATOR.</a>');
