...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:46 Tuesday August 28, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'{'||chr(10)||
' //$("#readOnlyBanner").hide();'||chr(10)||
'});'||chr(10)||
''||chr(10)||
'function closeMe()'||chr(10)||
'{'||chr(10)||
' var msg, comp_pos, completed, close_pos, closed;'||chr(10)||
''||chr(10)||
' try'||chr(10)||
'    {'||chr(10)||
'     msg = $(''#P5600_OUTPUT'').html();'||chr(10)||
'     comp_pos = msg.indexOf(''Completed ['');'||chr(10)||
'     completed = msg.substr(comp_pos+11,1);'||chr(10)||
'     close_pos = msg.indexOf(''Closed ['');'||chr(10)||
'     closed = msg.substr(cl';

ph:=ph||'ose_pos+8,1);'||chr(10)||
'    }'||chr(10)||
' catch (err)'||chr(10)||
'    {'||chr(10)||
'     completed = ''1'';'||chr(10)||
...
'    }'||chr(10)||
''||chr(10)||
' if(''&P5600_COMPLETE.'' == ''Y'' && (closed!=''0'' || completed!=''0''))'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120827115318',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '27-Aug-2012 - Tim Ward - Make this use jQuery Dialog instead of browser pop-up.'||chr(10)||
'                         Got rid of "Read Only" item when object is a source.');
