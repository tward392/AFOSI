...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:58 Monday September 10, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
' if (imSure)'||chr(10)||
'   {'||chr(10)||
'    window.location = ''f?p=&APP_I';

ph:=ph||'D.:30700:&SESSION.'' +'||chr(10)||
...
' javascript:openLocator(''301'',''NEW_AGENT_INVOLVED_SID'',''Y'',''&P30720_EXCLUDE_SIDS.'',''OPEN'','''','''',''Choose Other Agents Involved...'',''PERSONNEL'',''&P0_OBJ.'');'||chr(10)||
''||chr(10)||
...
ph:=ph||' = $v(''P30720_SAVE_BUTTON_NAME'');'||chr(10)||
'}'||chr(10)||
''||chr(10)||
...
'{'||chr(10)||
' var lst = document.getElementById("P30720_CC_EVIDENCE");'||chr(10)||
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120910065550',
...
''||chr(10)||
'14-Dec-2011 Tim Ward - CR#3945 - Count of selected evidence would go to 0 after'||chr(10)||
'                                 picking custodian.  Now does CC on CREATE and'||chr(10)||
'                                 SAVE.  Only show Count Pop-Up on CREATE and '||chr(10)||
'                                 SAVE.'||chr(10)||
''||chr(10)||
'27-Feb-2012 - Tim Ward - CR#4002 - Changed to JQuery Locators Page #301.'||chr(10)||
''||chr(10)||
'24-Apr-2012 - Tim Ward - CR#4041 - Cancel will still process Custodian Change on selected evidence.'||chr(10)||
''||chr(10)||
'12-Jul-2012 - Tim Ward - CR#4064 - Keep getting "Outgoing Evidence Custodian"'||chr(10)||
'                          must be selected for a custodian change." error '||chr(10)||
'                          message.'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:NewAgent();"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
':P30720_END_DATE IS NULL',
  ...
  p_button_cattributes=>'onclick="javascript:window.open(''f?p=100:800:&SESSION.::&DEBUG.::P800_REPORT_TYPE,P0_OBJ,P800_PARAM_2:&P30720_RPT_TYPE.,&P0_OBJ.,&P30720_SEL_INVENTORY.'');"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30720,
  p_branch_action=> 'f?p=&APP_ID.:30720:&SESSION.::&DEBUG.::P0_OBJ:&P30720_OBJ.#&P30720_SEL_INVENTORY.',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30720,
  p_branch_action=> 'f?p=&APP_ID.:30720:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P30720_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P30720_OUTGOING_CUST_SID'',''N'','''',''OPEN'','''','''',''Choose Outgoing Custodian...'',''PERSONNEL'',''&P0_OBJ.'');" style="vertical-align:bottom; padding-left:2px;">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
...
'   and code in (''ACC'',''PCC'')',
  ...
  p_protection_level => 'N',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_item_comment => '<a href="javascript:popupLocator(350,''P30720_OUTGOING_CUST_SID'',''N'');" style="vertical-align:bottom; padding-left:2px;">&ICON_LOCATOR.</a>');
...
begin
wwv_flow_api.create_page_item(
  p_id=>11070832167800772 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30720,
  p_name=>'P30720_EXCLUDE_SIDS',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 230,
  p_item_plug_id => 8957611619466307+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15727804077391900 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30720,
  p_name=>'P30720_OBJ',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 15728011349393952 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30720,
  p_computation_sequence => 1,
  p_computation_item=> 'P30720_OBJ',
...
wwv_flow_api.create_page_validation(
  ...
  p_validation_condition=> ':P30720_INVENTORY_REASON_SID in '||chr(10)||
'(select sid from t_osi_reference '||chr(10)||
'           where code in (''ACC'',''PCC'') and usage=''EVIDENCE_INVENTORY_REASON'')'||chr(10)||
...
'AND :REQUEST NOT LIKE ''EDIT_%'''||chr(10)||
''||chr(10)||
''||chr(10)||
':P30720_INVENTORY_REASON_SID in '||chr(10)||
'(select sid from t_osi_reference '||chr(10)||
'           where code in (''ACC'',''PCC'') and usage=''EVIDENCE_INVENTORY_REASON'')'||chr(10)||
'AND'||chr(10)||
'');
...
wwv_flow_api.create_page_process(
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when=>':P30720_CC_COUNT > 0'||chr(10)||
'AND :REQUEST IN (''SAVE'',''CREATE'')',
  p_process_when_type=>'PLSQL_EXPRESSION',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
...
''||chr(10)||
'begin'||chr(10)||
'     v_temp := replace(:NEW_AGENT_INVOLVED_SID, '':'', ''~'');'||chr(10)||
'     '||chr(10)||
...
'     end if;'||chr(10)||
''||chr(10)||
'     for i in 1 .. core_list.count_list_elements(v_temp)';

p:=p||''||chr(10)||
'     loop'||chr(10)||
'         v_per_sid := core_list.get_list_element(v_temp,i); '||chr(10)||
''||chr(10)||
'         insert into t_osi_evidence_inv_personnel (inventory_sid, personnel_sid) values (:p30720_sel_inventory, v_per_sid);'||chr(10)||
''||chr(10)||
'     end loop;'||chr(10)||
''||chr(10)||
'end;';
...
':REQUEST NOT IN (''ADD'',''DELETE'',''CANCEL'')',
...
'begin'||chr(10)||
'    for k in (SELECT PERSONNEL_SID'||chr(10)||
'                FROM t_osi_evidence_inv_personnel'||chr(10)||
'               WHERE INVENTORY_SID = :p30720_sel_inventory)'||chr(10)||
'    loop'||chr(10)||
'        v_sid_list := v_sid_list || ''~'' || k.PERSONNEL_SID;'||chr(10)||
''||chr(10)||
'    end loop;'||chr(10)||
''||chr(10)||
'    :p30720_exclude_sids := v_sid_list;'||chr(10)||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 11070305716783729 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30720,
  p_process_sequence=> 70,
  p_process_point=> 'BEFORE_HEADER',
