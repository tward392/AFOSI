...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:49 Tuesday August 28, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_icon_bar_item(
  ...
  p_icon_target    => '#" onClick="javascript:runJQueryPopWin(''Submit Help Desk Ticket'',''P0_OBJ,P0_OBJ_CONTEXT,P775_LOCATION,P775_OBJECT'',''&P0_OBJ.,,&APP_PAGE_ID.,&P0_OBJ.'',''775'');'||chr(10)||
'',
  p_icon_image_alt => '',
  p_icon_height    => null,
  p_icon_width     => null,
