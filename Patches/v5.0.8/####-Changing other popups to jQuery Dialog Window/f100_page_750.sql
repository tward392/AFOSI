...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:41 Thursday August 30, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'}'||chr(10)||
''||chr(10)||
'function onlyCloseDialog()'||chr(10)||
'{'||chr(10)||
' if($(''#P750_DIALOG'').val()==''Y'')'||chr(10)||
'   closeDialog();'||chr(10)||
' else'||chr(10)||
'   window.close();'||chr(10)||
'}'||chr(10)||
...
'}'||chr(10)||
''||chr(10)||
'function closeDialogAndParent()'||chr(10)||
'{'||chr(10)||
' if($(''#P750_DIALOG'').val()==''Y'')'||chr(10)||
'   {'||chr(10)||
'    closeParent();'||chr(10)||
...
ph:=ph||'ipt:window.opener.close(); '||chr(10)||
'    window.close();'||chr(10)||
'   }'||chr(10)||
'}'||chr(10)||
'</script>';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120830084115',
...
''||chr(10)||
'30-Aug-2012 - Tim Ward - Changed to jQuery Dialog instead of browser pop-up.');
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:closeDialogAndParent();"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:onlyCloseDialog();"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_item(
  p_id=>16305325852394162 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 750,
  p_name=>'P750_DIALOG',
  p_data_type=> 'VARCHAR',
