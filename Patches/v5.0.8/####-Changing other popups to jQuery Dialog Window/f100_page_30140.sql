...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   09:45 Thursday August 30, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
' var l_field_obj = docum';

ph:=ph||'ent.getElementById(''P30140_OBJ''); '||chr(10)||
'  '||chr(10)||
' for (var i = 0; i < node_list.length; i++) '||chr(10)||
'    {'||chr(10)||
'     var node = node_list[i];'||chr(10)||
...
ph:=ph||'ng = String(gReturn);'||chr(10)||
...
ph:=ph||'       // A new participant version was created.         //'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120830094516',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '30-Aug-2012 - Tim Ward - Made it use jQuery Dialog instead of browser pop-up.');
...
wwv_flow_api.create_page_button(
  ...
  p_button_image_alt=> 'Update Selected',
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:DeleteDeersImportRecord();"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '#',
  p_button_cattributes=>'onClick="javascript:checkAll();"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '#',
  p_button_cattributes=>'onClick="javascript:uncheckAll();"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'      htp.p(''<script language="JavaScript">alert("'' || ltrim(ltrim(osi_deers.get_import_message, ''ERROR ''), ''MSG '') || ''");closeDialog();</script>'');'||chr(10)||
''||chr(10)||
'    end if';
...
p:=p||'up to date.");closeDialog();</script>'');'||chr(10)||
''||chr(10)||
'  end if;'||chr(10)||
''||chr(10)||
''||chr(10)||
