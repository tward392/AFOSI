...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:00 Thursday August 30, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120830101150',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '22-FEB-2011 J.FARIS WCHG0000371 - Participants Relationships Import, new page to display relationship import status.'||chr(10)||
''||chr(10)||
'30-Aug-2012 - Tim Ward - Changed to be jQuery Dialog instead of browser pop-up.');
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:window.closeDialog();"',
  p_required_patch => null + wwv_flow_api.g_id_offset);
