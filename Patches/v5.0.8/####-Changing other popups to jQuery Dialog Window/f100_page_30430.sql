...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:53 Monday August 27, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'{'||chr(10)||
' runJQueryPopWin(''Transfer Unit'',''P0_OBJ,P950_ORIG_UNIT_SID'',''&P0_OBJ.,&P30430_UNIT_SID.'',''950'',600,350);'||chr(10)||
'};'||chr(10)||
'</script>';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120827064126',
...
''||chr(10)||
'27-Aug-2012 - Tim Ward - Changed Transfer Unit button use jQuery Dialog instead'||chr(10)||
'                          of browser pop-up window.'||chr(10)||
