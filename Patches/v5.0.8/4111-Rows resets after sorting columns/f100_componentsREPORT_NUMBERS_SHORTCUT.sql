...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   09:47 Wednesday September 5, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'  {'||chr(10)||
'   if($(this).attr("href").substring(0,21)==''javascript:$a_report('')'||chr(10)||
'     $(this).attr("href",$(this).attr("href")+'';ChangeMaxHeight#REGION_ID#();resetHeaderLinks();'')'||chr(10)||
'  })';
