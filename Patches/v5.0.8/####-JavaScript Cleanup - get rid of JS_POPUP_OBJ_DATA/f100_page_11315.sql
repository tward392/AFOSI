...
begin
h := null;
ph:=ph||'"JS_CREATE_PARTIC_WIDGET"'||chr(10)||
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120823090650',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11315,
  p_branch_action=> 'f?p=&APP_ID.:11315:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P11315_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P11315_SOURCE'',''N'','''',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''All Participant Types;ALL~Programs;PART.NONINDIV.PROG~Companies;PART.NONINDIV.COMP~Organizations;PART.NONINDIV.ORG'',''Choose Source...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P11315_SOURCE'',''N'','''',''PART.INDIV'');">&ICON_LOCATOR.</a>');
...
begin
wwv_flow_api.create_page_item(
  p_id=>15731225790965839 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11315,
  p_name=>'P11315_OBJ',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 15731430985967397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11315,
  p_computation_sequence => 10,
  p_computation_item=> 'P11315_OBJ',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'PLSQL_EXPRESSION',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> ':P0_OBJ',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P11315_SOURCE,'||chr(10)||
'P11315_SID,'||chr(10)||
'P11315_SOURCE_RO,'||chr(10)||
'P11315_SOURCE_INFO_RO,'||chr(10)||
'P11315_WITTING_INFO_RO,'||chr(10)||
'P11315_TYPE,'||chr(10)||
'P11315_NAME,'||chr(10)||
'P11315_FIND_WIDGET,'||chr(10)||
'P11315_VIEW_WIDGET,'||chr(10)||
'P11315_CREATE_WIDGET,'||chr(10)||
'P11315_WITTING,'||chr(10)||
'P11315_MISSION,'||chr(10)||
'P11315_SOURCE_DETAILS';

wwv_flow_api.create_page_process(
  p_id     => 15731717956973113 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11315,
  ...
  p_process_when_button_id=>1924519805044821 + wwv_flow_api.g_id_offset,
