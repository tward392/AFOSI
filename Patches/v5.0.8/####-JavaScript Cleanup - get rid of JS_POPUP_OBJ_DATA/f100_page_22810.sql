...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120823115742',
...
'                         Fixed call to createParticWidget to use'||chr(10)||
'                          P22810_SEL_PARTICIPANT instead of P22810_PARTICIPANT.'||chr(10)||
'');
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22810,
  p_branch_action=> 'f?p=&APP_ID.:22810:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P22810_SUSPACT.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a title="Create Participant" href="javascript:createParticWidget(''P22810_SEL_PARTICIPANT'');">&ICON_CREATE_PERSON.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
