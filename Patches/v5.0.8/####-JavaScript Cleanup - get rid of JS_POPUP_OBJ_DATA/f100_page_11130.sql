...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:15 Wednesday August 22, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120822071532',
...
wwv_flow_api.create_report_columns (
  ...
  p_column_link=>'#',
  p_column_linktext=>'&ICON_EDIT.',
  p_column_link_attr=>'onClick="javascript:runJQueryPopWin(''Weapon Force'',''P11160_SEL_ARM'',''#SID#'',''11160'',500,300);"',
  p_column_alignment=>'LEFT',
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:runJQueryPopWin(''Edit Specification'',''P11125_SEL_SPECIFICATION'',''&P11130_SEL_SPECIFICATION.'',''11125'',500,300);"',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_button_comment=>''||chr(10)||
'',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_button(
  ...
  p_button_cattributes=>'onClick="javascript:runJQueryPopWin(''Weapon Force'',''P11160_SPECIFICATION'',''&P11130_SEL_SPECIFICATION.'',''11160'',500,300);"',
  p_security_scheme => 4418131991249078+ wwv_flow_api.g_id_offset,
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11130,
  p_branch_action=> 'f?p=&APP_ID.:11130:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P11130_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
begin
wwv_flow_api.create_page_item(
  p_id=>15655406841148452 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11130,
  p_name=>'P11130_OBJ',
  p_data_type=> 'VARCHAR',
...
p:=p||'P11130_SEL_SPECIFICATION,'||chr(10)||
'P11130_MODE,'||chr(10)||
'P11130_ENTRY_METHOD_STATE,'||chr(10)||
'P11130_MULTI_ENTRIES_STATE,'||chr(10)||
'P11130_WEAPONS_USED_APPLIES,'||chr(10)||
'P11130_EXPORT_NAME,'||chr(10)||
'P11130_SPEC_COUNT,'||chr(10)||
'P11130_DATA_READY,'||chr(10)||
'P11130_INVESTIGATION,'||chr(10)||
'P11130_OFFENSE,'||chr(10)||
'P11130_OFF_LOC,'||chr(10)||
'P11130_OFF_US_STATE,'||chr(10)||
'P11130_OFF_COUNTRY,'||chr(10)||
'P11130_OFF_RESULT,'||chr(10)||
'P11130_OFF_COMMITTED_ON,'||chr(10)||
'P11130_HOUR,'||chr(10)||
'P11130_MINUTE,'||chr(10)||
'P11130_SEX_HARASSMENT_REL,'||chr(10)||
'P11130_NUM_PREM_ENTERED,'||chr(10)||
'';

p:=p||'P11130_ENTRY_METHOD,'||chr(10)||
'P11130_OFF_ON_USI,'||chr(10)||
'P11130_SAPRO_LOCATION_CODE,'||chr(10)||
'P11130_INCIDENT_LOCATION,'||chr(10)||
'P11130_SAPRO_LOCATION_CODE2,'||chr(10)||
'P11130_INCIDENT_LOCATION2';

wwv_flow_api.create_page_process(
  p_id     => 15695020356228095 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11130,
...
'    end if;'||chr(10)||
''||chr(10)||
'wwv_flow.debug(''1-:P11130_OBJ='' || :P11130_OBJ);'||chr(10)||
'wwv_flow.debug(''2-:P0_OBJ='' || :P0_OBJ);'||chr(10)||
''||chr(10)||
'end;';
