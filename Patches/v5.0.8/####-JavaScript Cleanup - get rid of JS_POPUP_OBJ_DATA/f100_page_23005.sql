...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:18 Thursday August 23, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120823091530',
...
''||chr(10)||
'17-May-2011 - Tim Ward - Removed Unused showHide javascript.'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 23005,
  p_branch_action=> 'f?p=&APP_ID.:23005:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P23005_SID.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P23005_PARTICIPANT'',''N'','''',''OPEN'','''','''',''Choose Requestor...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P23005_PARTICIPANT'',''N'','''',''OPEN'',''P400_PARTIC_TYPE_LIST'',''~PART.INDIV~PART.NONINDIV.COMP~PART.NONINDIV.ORG~PART.NONINDIV.PROG~'');">&ICON_LOCATOR.</a>');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P23005_PARTICIPANT,'||chr(10)||
'P23005_PARTICIPANT_VERSION,'||chr(10)||
'P23005_AV_TYPE,'||chr(10)||
'P23005_DATE_RECEIVED,'||chr(10)||
'P23005_DATE_REQUEST_BY,'||chr(10)||
'P23005_DATE_COMPLETED';

wwv_flow_api.create_page_process(
  p_id     => 15614606449069677 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 23005,
