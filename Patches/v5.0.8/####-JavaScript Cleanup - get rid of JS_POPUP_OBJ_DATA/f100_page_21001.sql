...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:51 Wednesday November 21, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'       $(''#showHideParticipantIcon'').attr("src';

ph:=ph||'",src.replace("minus","plus"));'||chr(10)||
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20121017062334',
