...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:24 Wednesday August 22, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'  case "DELETE":'||chr(10)||
'    case "SAVE":'||chr(10)||
'                window.parent.doSubmit(''SENTENCE_&P11175_SID.'');'||chr(10)||
'  case "CANCEL":'||chr(10)||
'                closeDialog();'||chr(10)||
'                break;'||chr(10)||
' }'||chr(10)||
...
'  if($(''#P11175_UOM option'').length==2)'||chr(10)||
'    {'||chr(10)||
'     $(''#P11175_UOM option:eq(1)'').prop(''selected'', true)'||chr(10)||
'    }'||chr(10)||
'});'||chr(10)||
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120822072427',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '27-Feb-2012 - Tim Ward - CR#4002 - Changed to JQuery Locators Page #301.'||chr(10)||
''||chr(10)||
'01-Aug-2012 - Tim Ward - CR#3453 - Unit of Measure should auto-select if there'||chr(10)||
'                                    is only one option in the list.'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_item(
  p_id=>4690309025570327 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11175,
  p_name=>'P11175_VIEW_WIDGET',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 135.5,
  p_item_plug_id => 99002929846009842+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'''<a title="View Participant" href="'' || '||chr(10)||
'osi_object.get_object_url(:P11175_PAYEE) ||'||chr(10)||
'''">&ICON_MAGNIFY.</a>''',
...
'where sid = :p11175_UOM_DEFAULT',
  ...
  p_label_alignment  => 'LEFT',
  p_field_alignment  => 'LEFT',
  p_display_when=>':P11175_UOM_LOCK=''Y'' AND :P11175_UOM_DEFAULT IS NOT NULL',
...
'  from t_osi_f_inv_sentence_type t, t_osi_f_inv_subj_disposition s, t_dibrs_reference d'||chr(10)||
' where (t.active = ''Y'' or :P11175_SENTENCE_TYPE = t.sid)'||chr(10)||
'   and s.jurisdiction=d.sid(+)'||chr(10)||
'   and s.sid=:P11175_DISPOSITION'||chr(10)||
'   and ((d.code=''A'' AND UCMJ=''Y'') or '||chr(10)||
'        ((d.code is null or d.code='''') and (UCMJ=''Y'' or NONUCMJ=''Y'')) or '||chr(10)||
'        (d.code in (''D'',''F'',''C'',''B'',''E'') and NONUCMJ=''Y'')'||chr(10)||
'       )'||chr(10)||
' order by t.seq, t.description',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => 'select description, sid'||chr(10)||
...
'order by st.seq, st.description',
  ...
  p_read_only_when=>'P11175_UOM_LOCK',
  p_read_only_when2=>'Y',
...
'      return osi_participant.get_name(:P11175_PAYEE);'||chr(10)||
'  else'||chr(10)||
'      return null;'||chr(10)||
'  end if;'||chr(10)||
'end;',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P11175_PAYEE'',''N'','''',''OPEN'','''','''',''Choose Payee...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P11175_PAYEE'',''N'');">&ICON_LOCATOR.</a>');
...
''||chr(10)||
'    select decode(duration_lock, ''Y'', :DISABLE_TEXT, null), duration_default, uom_lock, '||chr(10)||
'           uom_default, decode(payee_lock, ''Y'', :DISABLE_TEXT, null)'||chr(10)||
'      into :p11175_duration_lock, :p11175_duration_default, :p11175_uom_lock, '||chr(10)||
'           :p11175_uom';

p:=p||'_default, :p11175_payee_lock'||chr(10)||
'      from t_osi_f_inv_sentence_type where sid = :p11175_sentence_type;'||chr(10)||
''||chr(10)||
'  end if;'||chr(10)||
''||chr(10)||
...
'    :p11175_uom := :p11175_uom_default;'||chr(10)||
''||chr(10)||
