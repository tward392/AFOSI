...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:58 Monday August 27, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120827135839',
...
'21-JAN-2011 J.FARIS - Fixed bug in Invalid Date validation.  Item reference is case sensitive.'||chr(10)||
''||chr(10)||
...
'                         Fix Clear Items to NOT clear P21005_SID so page'||chr(10)||
'                          branching is correct.'||chr(10)||
'');
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 21005,
  p_branch_action=> 'f?p=&APP_ID.:21005:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P21005_SID.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P21005_PARTICIPANT'',''N'',''&P21005_TMP_PARTICIPANT.'',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''All Participant Types;ALL~Programs;PART.NONINDIV.PROG~Companies;PART.NONINDIV.COMP~Organizations;PART.NONINDIV.ORG'',''Choose Participant...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P21005_PARTICIPANT'',''N'',''&P21005_TMP_PARTICIPANT.'',''PART.INDIV'');">&ICON_LOCATOR.</a>');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P21005_PARTICIPANT,'||chr(10)||
'P21005_PARTICIPANT_VERSION,'||chr(10)||
'P21005_TMP_PARTICIPANT,'||chr(10)||
'P21005_PARTIC_NAME,'||chr(10)||
'P21005_ADVISEMENT,'||chr(10)||
'P21005_DD2701,'||chr(10)||
'P21005_ACTIVITY_DATE,'||chr(10)||
'P21005_HOUR,'||chr(10)||
'P21005_MINUTE,'||chr(10)||
'P21005_LOCATION_VALUE,'||chr(10)||
'P21005_LOCATION_DISPLAY';

wwv_flow_api.create_page_process(
  p_id     => 16230228378296326 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 21005,
