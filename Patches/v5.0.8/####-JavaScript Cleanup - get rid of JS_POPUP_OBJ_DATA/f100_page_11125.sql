...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:31 Wednesday August 22, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'  {'||chr(10)||
'   window.parent.doSubmit(''EDIT_&P11125_SEL_SPECIFICATION.'');'||chr(10)||
'   closeDialog();'||chr(10)||
'  }'||chr(10)||
'</script>';
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120822063011',
...
'                                    and "Check for Duplicate Specification"'||chr(10)||
''||chr(10)||
