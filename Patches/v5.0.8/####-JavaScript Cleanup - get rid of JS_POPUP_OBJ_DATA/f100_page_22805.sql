...
PROMPT ...Remove page 22805
 
begin
 
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>22805);
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120823091451',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22805,
  p_branch_action=> 'f?p=&APP_ID.:22805:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P22805_SID.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P22805_PARTICIPANT'',''N'',''&P22805_TMP_PARTICIPANT.'',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''All Participant Types;ALL~Programs;PART.NONINDIV.PROG~Companies;PART.NONINDIV.COMP~Individuals by Name;PART.INDIV'',''Choose Organization...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
  p_lov_columns=> 1,
  p_lov_display_null=> 'NO',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P22805_PARTICIPANT'',''N'',''&P22805_TMP_PARTICIPANT.'',''PART.NONINDIV.ORG'');">&ICON_LOCATOR.</a>');
