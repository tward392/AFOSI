...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   12:13 Thursday August 23, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120823090614',
...
'                         is now handled when the file is created.'||chr(10)||
''||chr(10)||
...
'                          Added Cancel Process make Cancel button use that'||chr(10)||
'                          instead of just redirecting to this page.'||chr(10)||
''||chr(10)||
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11205,
  p_branch_action=> 'f?p=&APP_ID.:11205:&SESSION.:&REQUEST.:&DEBUG.::P0_OBJ:&P11205_OBJ.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'<a href="javascript:openLocator(''301'',''P11205_PARTIC_VER'',''N'','''',''OPEN'',''P301_ACTIVE_FILTER_EXCLUDES'',''All Participant Types;ALL~Programs;PART.NONINDIV.PROG~Companies;PART.NONINDIV.COMP~Organizations;PART.NONINDIV.ORG'',''Choose Applicant...'',''PARTICIPANT'',''&P0_OBJ.'');">&ICON_LOCATOR.</a>',
  p_source_type=> 'STATIC',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '<a href="javascript:popupLocator(400,''P11205_PARTIC_VER'',''N'');">&ICON_LOCATOR.</a>');
...
begin
wwv_flow_api.create_page_item(
  p_id=>15715302254584010 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11205,
  p_name=>'P11205_OBJ',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_computation(
  p_id=> 15715508488585902 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11205,
  p_computation_sequence => 10,
  p_computation_item=> 'P11205_OBJ',
  p_computation_point=> 'BEFORE_HEADER',
  p_computation_type=> 'PLSQL_EXPRESSION',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> ':P0_OBJ',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'P11205_SID,'||chr(10)||
'P11205_PARTIC_VER_ORIGINAL,'||chr(10)||
'P11205_PARTIC_VER,'||chr(10)||
'P11205_CATEGORY_LOV,'||chr(10)||
'P11205_MARITAL_STATUS_LOV,'||chr(10)||
'P11205_TYPE_LOV,'||chr(10)||
'P11205_END_DATE_LOCKOUT,'||chr(10)||
'P11205_SUSPENSE_DATE_LOCKOUT,'||chr(10)||
'P11205_TYPE_LOCKOUT,'||chr(10)||
'P11205_APPROVED_FOR_LOCKOUT,'||chr(10)||
'P11205_IS_AGENT,'||chr(10)||
'P11205_USER_HAS_DPPI_PRIV,'||chr(10)||
'P11205_CURRENT_STATUS_CODE,'||chr(10)||
'P11205_CATEGORY,'||chr(10)||
'P11205_MARITAL_STATUS,'||chr(10)||
'P11205_TYPE,'||chr(10)||
'P11205_APPROVED_FOR,'||chr(10)||
'P11205_START_DATE,'||chr(10)||
'P11205';

p:=p||'_START_DATE_ORIGINAL,'||chr(10)||
'P11205_END_DATE,'||chr(10)||
'P11205_END_DATE_LOCKED,'||chr(10)||
'P11205_INITIAL_SUSPENSE_DATE,'||chr(10)||
'P11205_SUSPENSE_DATE,'||chr(10)||
'P11205_SUSPENSE_DATE_LOCKED,'||chr(10)||
'P11205_PERSON,'||chr(10)||
'P11205_HTML_DETAILS';

wwv_flow_api.create_page_process(
  p_id     => 15716322386618225 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 11205,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>1520114367848818 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
