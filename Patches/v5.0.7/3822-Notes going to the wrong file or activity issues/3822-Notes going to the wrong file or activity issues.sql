...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:53 Friday July 6, 2012
--   Exported By:     TWARD
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     BUTTON TEMPLATE: Button with Items and Values Passed
--   Manifest End
--   Version: 3.2.0.00.27
...
prompt Component Export: BUTTON TEMPLATE 13904225673632513
 
prompt  ...button templates
--
prompt  ......Button Template 13904225673632513
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
begin
t:=t||'<a #BUTTON_ATTRIBUTES# class="htmlButton" href="#" onClick="javascript:buttonSubmit(''#LABEL#'',this,&quot;#LINK#&quot;);return false;">#LABEL#</a>';

wwv_flow_api.create_button_templates (
  p_id=>13904225673632513 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
  p_template_name=> 'Button with Items and Values Passed',
  p_theme_id  => 101,
  p_theme_class_id => 1,
  p_template_comment       => '06-Jul-2012 - CR#3822 - To Objects Open, Notes go to wrong Object.'||chr(10)||
'');
end;
/
COMMIT;
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:52 Friday July 6, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120706065232',
...
':P5050_NOTE_STATUS is null',
  p_button_condition_type=> 'PLSQL_EXPRESSION',
  p_button_cattributes=>'id="DELETE_&P0_OBJ." items="P0_OBJ,P5050_OBJ,P5050_OBJ1,P5050_SEL_NOTE" values="&P0_OBJ.,&P0_OBJ.,&P0_OBJ.,&P5050_SEL_NOTE."',
  p_security_scheme => 5459808427748525+ wwv_flow_api.g_id_offset,
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  ...
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> 'Good One:'||chr(10)||
''||chr(10)||
'f?p=&APP_ID.:5050:&SESSION.::&DEBUG.::P0_OBJ:&P5050_OBJ.#&P5050_SEL_NOTE.'||chr(10)||
''||chr(10)||
'Test One:'||chr(10)||
'f?p=&APP_ID.:5050:&SESSION.:&REQUEST.:&DEBUG.:P5050_NOTE,P5050_NOTE_CATEGORY:P0_OBJ,P5050_OBJ,P5050_OBJ1,P5050_SEL_NOTE:&P5050_OBJ1.,&P5050_OBJ1.,&P5050_OBJ1.,&P5050_SEL_NOTE.#&P5050_SEL_NOTE.');
