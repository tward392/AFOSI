...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:15 Tuesday October 9, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
ph:=ph||'ESS=Get_Act_Surveillance_Techniques'','||chr(10)||
...
ph:=ph||'P21001_LIST_1'',false,false);'||chr(10)||
'                                        showField(''P21001_RADIOGROUP_1'',false,false);'||chr(10)||
'                                        break;'||chr(10)||
''||chr(10)||
'                                default:'||chr(10)||
...
ph:=ph||'e sure there is at least one Coordination/Consultation Type in the Select List //'||chr(10)||
...
'       $(''#showHideParticipantIcon'').attr("src",src.replace("minus';
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20121005132456',
...
'                                       :P21001_ADDRESS_LABEL := ''Address of Intercept/Surveillance'';'||chr(10)||
''||chr(10)||
'         WHEN ''ACT.SUSPACT_REPORT'' THEN'||chr(10)||
'                                       :P21001_ACTIVITY_DATE_LABEL:=''Requested Start Date'';'||chr(10)||
'                                       :P21001_LIST_1_LO';

p:=p||'V := ''- Select -;%null%,'' || osi_reference.get_lov(''SUSPACT_CATEGORY'');'||chr(10)||
...
p:=p||'                                   :P21001_ACTIVITY_DATE_LABEL:=''Consultation Date'';'||chr(10)||
'                                         :P21001_LIST_1_LABEL:=''Type'';'||chr(10)||
'                                         :P21001_LIST_1_LOV:=''- Select -;%null%,'';'||chr(10)||
''||chr(10)||
'                                         for a in (select d,r '||chr(10)||
'                                                         from V_OSI_CONSULT_CREATE_TYPES order by';
...
''||chr(10)||
'                                         begin'||chr(10)||
'                                              select sid into :P21001_LIST_1 from t_core_obj_type where code =''AC';

p:=p||'T.CONSULTATION.ACQUISITION'';'||chr(10)||
''||chr(10)||
'                                         exception when others then'||chr(10)||
'         '||chr(10)||
'                                                  null;'||chr(10)||
...
'                                         :P21001_LIST_2_LOV:=''- Select -;%null%,'' || osi_reference.get_lov(''CONTACT';
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:47 Thursday August 2, 2012
--   Exported By:     TWARD
--   Flashback:       0
--   Export Type:     Page Export
--   Version: 3.2.0.00.27
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'TWARD',
  p_last_upd_yyyymmddhh24miss => '20120802064408',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
...
''||chr(10)||
'02-Aug-2012 - Tim Ward - CR#4095 - Change Address of Intercept to '||chr(10)||
'                          Address of Intercept/Surveillance.');
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Address of<br>Intercept/Surveillance',
