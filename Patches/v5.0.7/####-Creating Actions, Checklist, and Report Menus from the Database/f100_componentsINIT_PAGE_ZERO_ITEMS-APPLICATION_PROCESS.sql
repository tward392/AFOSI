...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:14 Wednesday June 20, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
p:=p||'substr(core_obj.get_tagline(:P0_OBJ),1,70),'||chr(10)||
...
p:=p||'_OBJ_TYPE_CODE = ''UNIT'' '||chr(10)||
...
'      if :P0_OBJ_TYPE_CODE is not null th';
