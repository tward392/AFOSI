...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   07:30 Tuesday June 19, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20120618141256',
...
'                          from the database, removed regions and lists.');
...
'<a class="sf-with-ul-top sf-with-ul" href="javascript:void(0);" onclick="javascript:newWindow({page:5550,clear_cache:''5550'',name:''VLT&P0_OBJ.'',item_names:''P0_OBJ,P0_OBJ_CONTEXT'',item_values:''&P0_OBJ.,''})"><img class="sf-menu-img" src="/i/themes/OSI/blank16.gif">VLT</a>'||chr(10)||
'</li>'||chr(10)||
'</ul>',
  p_source_type=> 'STATIC',
  p_display_as=> 'DISPLAY_ONLY_HTML',
