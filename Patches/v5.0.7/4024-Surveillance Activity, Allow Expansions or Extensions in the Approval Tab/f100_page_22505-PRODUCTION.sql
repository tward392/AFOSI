...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   10:10 Wednesday August 1, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22505,
  p_branch_action=> 'f?p=&APP_ID.:22505:&SESSION.:&REQUEST.:&DEBUG.::P22505_EMERGENCY,P22505_US_LOCATION,P22505_CONSENSUAL,P22505_INFO_TYPE:&P22505_EMERGENCY_VAL.,&P22505_US_LOCATION_VAL.,&P22505_CONSENSUAL_VAL.,&P22505_INFO_TYPE_VAL.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22505,
  p_branch_action=> 'f?p=&APP_ID.:22505:&SESSION.:&REQUEST.:&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'&nbsp&nbsp&nbspAFOSI ITEM Case',
  p_source=>'ITEM_CASE',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_process(
  p_id     => 2760025000036175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22505,
