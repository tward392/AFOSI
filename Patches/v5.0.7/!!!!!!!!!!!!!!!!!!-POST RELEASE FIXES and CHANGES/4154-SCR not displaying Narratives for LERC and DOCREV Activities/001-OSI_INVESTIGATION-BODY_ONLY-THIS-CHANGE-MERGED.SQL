...
/******************************************************************************
   ...
   revisions:
    ...
    13-Sep-2012 Tim Ward        CR#4055 - Making sure case_roi still works.
                                 Changed case_roi.
    17-Oct-2012 Tim Ward        CR#4154 - SCR not displaying Narratives for LERC and DOCUMENT REVIEW Activities.
                                 Changed summary_complaint_report.
...
--        loop
        ...
        for a in (select   a.SID as activity, a.narrative as activity_narrative,
                      ...
                      from t_osi_assoc_fle_act afa, t_osi_activity a, t_core_obj o, t_core_obj_type ot
                     where afa.file_sid = psid and afa.activity_sid = a.SID
                       and a.sid=o.sid and o.obj_type=ot.sid
                  order by activity)
        loop
            v_recordcounter := v_recordcounter + 1;
            ...
            if a.object_type_code = 'ACT.DOCUMENT_REVIEW' then

              v_tempstring := v_tempstring || osi_report.replace_special_chars(rtrim(osi_document_review.get_narrative(a.activity),chr(10)||chr(13)), htmlorrtf) || '\b \cell \pard\plain \ql \li0\ri0\widctlpar\intbl\aspalpha\aspnum\faauto\adjustright\rin0\lin0 \fs20\lang1033\langfe1033\cgrid\langnp1033\langfenp1033 \b';

            elsif a.object_type_code = 'ACT.RECORDS_CHECK' then
            
                 v_tempstring := v_tempstring || osi_report.replace_special_chars(rtrim(osi_records_check.get_narrative(a.activity),chr(10)||chr(13)), htmlorrtf) || '\b \cell \pard\plain \ql \li0\ri0\widctlpar\intbl\aspalpha\aspnum\faauto\adjustright\rin0\lin0 \fs20\lang1033\langfe1033\cgrid\langnp1033\langfenp1033 \b';
