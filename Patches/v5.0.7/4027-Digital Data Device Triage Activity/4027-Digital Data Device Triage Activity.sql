INSERT INTO T_CORE_OBJ_TYPE ( SID, CODE, DESCRIPTION, METHOD_PKG, HAS_OWNING_UNIT, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, IMAGE, INHERIT_PRIVS_FROM_PARENT ) VALUES ( '33318SVJ', 'ACT.DDD_TRIAGE', 'Digital Data Device Triage', 'OSI_MEDIA_ANALYSIS', 'Y', 'timothy.ward',  TO_Date( '07/12/2012 07:56:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 07:56:31 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'MediaAnalysis.gif', 'Y'); 
COMMIT;


INSERT INTO T_OSI_MENU ( ID, DESCRIPTION, COMMAND, PARENT_ID, ICON, SEQ, ACTIVE, LAST_CHILD, DOUBLE_CLOSE ) VALUES ( 'ID_DDD_TRIAGE', 'Digital Data Device Triage', 'javascript:createActivityObject(21001,''ACT.DDD_TRIAGE'');', 'ID_ACTIVITY', '/i/themes/OSI/MediaAnalysis.gif', 11.5, 'N', 'N', 'N'); 
COMMIT;


INSERT INTO T_CORE_DT_OBJ_TYPE_PAGE ( SID, OBJ_TYPE, PAGE_FUNCTION, PAGE_NUM, REQUEST, DISPLAY_HTML, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, URL_SUFFIX, OTHER_ITEMS, OTHER_VALUES ) VALUES ( '33318SVK', '33318SVJ', 'OPEN', 20000, NULL, NULL, 'timothy.ward',  TO_Date( '07/12/2012 08:01:57 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:01:57 AM', 'MM/DD/YYYY HH:MI:SS AM'), NULL, NULL, NULL); 
COMMIT;


INSERT INTO T_CORE_ACL ( SID, OBJ_TYPE, ACL_NAME, RESTRICT_SEE, SEQ, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '33318SVL', '33318SVJ', 'Default', 'N', 1, 'timothy.ward',  TO_Date( '07/12/2012 08:02:46 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:02:46 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
COMMIT;


INSERT INTO T_OSI_OBJ_TYPE ( SID, STARTING_STATUS, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, PARENT, INCLUDE_STATUS_MENU, INCLUDE_CHECKLIST_MENU, DEFAULT_TITLE ) VALUES ( '33318SVJ', '222000005IY', 'timothy.ward',  TO_Date( '07/12/2012 08:05:59 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:06:04 AM', 'MM/DD/YYYY HH:MI:SS AM'), '2220000083O', 'Y', 'Y', 'Digital Data Device Triage:'); 
COMMIT;



INSERT INTO T_OSI_TAB ( SID, OBJ_TYPE, TAB_LEVEL, PARENT_TAB, SEQ, TAB_LABEL, PAGE_NUM, IS_DEFAULT, TAB_PARAMS, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACTIVE, AUTH_ACTION, OVERRIDE ) VALUES ( '33318SVS', '33318SVJ', 1, NULL, 15, 'Details', NULL, 'N', NULL, 'timothy.ward',  TO_Date( '07/12/2012 08:35:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:35:48 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'Y', NULL, 'N');
COMMIT;

INSERT INTO T_OSI_TAB ( SID, OBJ_TYPE, TAB_LEVEL, PARENT_TAB, SEQ, TAB_LABEL, PAGE_NUM, IS_DEFAULT, TAB_PARAMS, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACTIVE, AUTH_ACTION, OVERRIDE ) VALUES ( '33318SVU', '33318SVJ', 2, '33318SVS', 10, 'Media', 21805, 'N', NULL, 'timothy.ward',  TO_Date( '07/12/2012 08:36:10 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:36:56 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'Y', NULL, 'N'); 
INSERT INTO T_OSI_TAB ( SID, OBJ_TYPE, TAB_LEVEL, PARENT_TAB, SEQ, TAB_LABEL, PAGE_NUM, IS_DEFAULT, TAB_PARAMS, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACTIVE, AUTH_ACTION, OVERRIDE ) VALUES ( '33318SVY', '33318SVJ', 2, '33318SVS', 20, 'Other Participants', 5300, 'N', 'PARTICIPANTS', 'timothy.ward',  TO_Date( '07/12/2012 08:37:23 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:37:23 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'Y', NULL, 'N'); 
INSERT INTO T_OSI_TAB ( SID, OBJ_TYPE, TAB_LEVEL, PARENT_TAB, SEQ, TAB_LABEL, PAGE_NUM, IS_DEFAULT, TAB_PARAMS, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, ACTIVE, AUTH_ACTION, OVERRIDE ) VALUES ( '33318SW0', '33318SVJ', 2, '33318SVS', 5, 'General Info', 21810, 'N', NULL, 'timothy.ward',  TO_Date( '07/12/2012 08:37:58 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:37:58 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'Y', NULL, 'N'); 
COMMIT;



INSERT INTO T_OSI_PARTIC_ROLE_TYPE ( SID, OBJ_TYPE, ROLE, USAGE, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, CODE, OVERRIDE, MAX_NUM ) VALUES ( '33318SW4', '33318SVJ', 'Owned by SUBJECT', 'PARTICIPANTS', 1, 'Y', 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'SUBJOWN', 'N', 0); 
INSERT INTO T_OSI_PARTIC_ROLE_TYPE ( SID, OBJ_TYPE, ROLE, USAGE, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, CODE, OVERRIDE, MAX_NUM ) VALUES ( '33318SW5', '33318SVJ', 'Owned by VICTIM', 'PARTICIPANTS', 2, 'Y', 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'VICTOWN', 'N', 0); 
INSERT INTO T_OSI_PARTIC_ROLE_TYPE ( SID, OBJ_TYPE, ROLE, USAGE, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, CODE, OVERRIDE, MAX_NUM ) VALUES ( '33318SW6', '33318SVJ', 'Owned by Witness', 'PARTICIPANTS', 3, 'Y', 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'WITNOWN', 'N', 0); 
INSERT INTO T_OSI_PARTIC_ROLE_TYPE ( SID, OBJ_TYPE, ROLE, USAGE, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, CODE, OVERRIDE, MAX_NUM ) VALUES ( '33318SW7', '33318SVJ', 'Owned by Government', 'PARTICIPANTS', 4, 'Y', 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'GOVTOWN', 'N', 0); 
INSERT INTO T_OSI_PARTIC_ROLE_TYPE ( SID, OBJ_TYPE, ROLE, USAGE, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, CODE, OVERRIDE, MAX_NUM ) VALUES ( '33318SW8', '33318SVJ', 'Other', 'PARTICIPANTS', 5, 'Y', 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:51:52 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'OTHR', 'N', 0); 
COMMIT;



INSERT INTO T_OSI_NOTE_TYPE ( SID, OBJ_TYPE, USAGE, CODE, DESCRIPTION, MIN_NUM, MAX_NUM, LOCK_MODE, SEQ, ACTIVE, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON, OVERRIDE, AUTH_ACTION ) VALUES ( '33318SWB', '33318SVJ', 'NOTELIST', 'SPEC', 'Specialist Note', NULL, NULL, '72HR', 2, 'Y', 'timothy.ward',  TO_Date( '07/12/2012 08:55:28 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '07/12/2012 08:55:28 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'N', NULL); 
COMMIT;
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   09:02 Thursday July 12, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'                                        showField(''P21001_DATE_2'',true,false);'||chr(10)||
'                                        showField(''P21001_DATE_3'',true,false);'||chr(10)||
'                                        showField(''P21001_DATE_4'',true,false';
...
'                                        showField(''P21001_RADIOGROUP_1'',false,f';
...
ph:=ph||'            case ''ACT.SOURCE_MEET'':'||chr(10)||
'                                        showField(''P21001_LIST_1'',false,false);'||chr(10)||
'                                        makeLabelRequired(''P21001_PARTIC_DISPLAY'');'||chr(10)||
...
ph:=ph||'wField(''P21001_MINUTE'',false,false);'||chr(10)||
'                                        makeLabelRequired(''P21001_HOUR'');'||chr(10)||
'                                        showParticWidget();'||chr(10)||
'                                        break;'||chr(10)||
''||chr(10)||
...
ph:=ph||'001_RADIOGROUP_2'',false,false);'||chr(10)||
...
ph:=ph||'    showField(''P21001_TEXT_9'',false,false);'||chr(10)||
...
ph:=ph||'                               makeLabelRequired(''P21001_RADIOGROUP_2'');'||chr(10)||
...
ph:=ph||'                       makeLabelRequired(''P21001_ADDRESS_DISPLAY'');'||chr(10)||
''||chr(10)||
...
ph:=ph||'         gReturn = $.trim(get.get());'||chr(10)||
...
ph:=ph||'        for (i = 0; i < items.length; i++) '||chr(10)||
'                                                 {'||chr(10)||
'                                                  if(items[i].length>0)'||chr(10)||
'                                                    {'||chr(10)||
'                                                     var values = items[i].split('';'');'||chr(10)||
'                                                     $(''#P21001_LIST_2'').children().end().ap';

ph:=ph||'pend(''<option value="''+values[1]+''">''+values[0]+''</option>'');'||chr(10)||
'                                                    }'||chr(10)||
'                                                 }'||chr(10)||
'                                             }'||chr(10)||
'                                          }'||chr(10)||
...
ph:=ph||'quired(''P21001_LIST_1'');'||chr(10)||
'                                        makeLabelRequired(''P21001_RADIOGROUP_1'');'||chr(10)||
'                                        showField(''P21001_LIST_1'',false,false);'||chr(10)||
'                                        showField(''P21001_RADIOGROUP_1'',false,false);'||chr(10)||
'                                        break;'||chr(10)||
...
ph:=ph||'  if ($(''#P21001_OBJ_TYPE_CODE'').val().substring(0,16)==''ACT.CONSULTATION'' || $(''#P21001_OBJ_TYPE_CODE'').val().substring(0,16)==''ACT.COORDINATION'')'||chr(10)||
'                                          {'||chr(10)||
...
ph:=ph||'1_HOUR'',false,false);'||chr(10)||
'                                           showField(''P21001_MINUTE'',false,false);'||chr(10)||
'                                           showField(''P21001_LIST_1'',false,false);'||chr(10)||
'                                           showField(''P21001_LIST_2'',false,false);'||chr(10)||
'                                           makeLabelRequired(''P21001_HOUR'');'||chr(10)||
...
ph:=ph||'Required(''P21001_LIST_1'');'||chr(10)||
'                                           makeLabelRequired(''P21001_LIST_2'');'||chr(10)||
'  '||chr(10)||
...
' $(document).attr("title", $v(''P21001_OBJ_TYPE_DESCRIPTI';

ph:=ph||'ON'')+" (Create)");'||chr(10)||
'});'||chr(10)||
'</script>';
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120712082714',
...
'                          Triage Activity Creation (Same as Media Analysis).');
...
''||chr(10)||
'        v_FieldNames := ''sid,media_type,media_size,media_size_units,removable_flag,quantity,seizure_date,receive_date,analysis_start_date,analysis_end_date,comments,ac';
...
''||chr(10)||
''||chr(10)||
'        v_FieldNames := ''sid,location,start_datetime,end_datetime,exam_monitor''';
...
p:=p||'o_date(to_char(to_date('' || '''''''' || :p21001_activity_date || '''''''' || ''),''''yyyymmdd'''')'' || '' ||nvl('' || '''''''' || :p21001_hour_2 || '''''''' || '',''''01'''')'' || '' || nvl('' || '''''''' || :p21001_minute_2 || '''''''' || '',''''00'''') || '' || ''''''00'''''' || '', ''''yyyymmddhh24miss'''')''  || '','' || '''''''' ||'||chr(10)||
'                                 replace(:p21001_list_1,''%null%'',''null'') || '''''''';'||chr(10)||
''||chr(10)||
'        v_ParticipantUsage := ''SUBJECT'';'||chr(10)||
'';

p:=p||'        v_ParticipantCode := ''SUBJECT'';'||chr(10)||
...
p:=p||',search_basis, explanation'';'||chr(10)||
'        v_FieldValues := '''''''' || ''~^~P0_OBJ~^~'' || '''''''' || '','' || '''''''' || replace(:p21001_list_2,''%null%'',''null'') || '''''''' || '','' || '''''''' ||'||chr(10)||
...
p:=p||'ate(:p21001_activity_date, :fmt_date || '' '' || :fmt_time);'||chr(10)||
''||chr(10)||
'        :P21001_OBJ_TYPE_SID:=:p21001_list_1;'||chr(10)||
''||chr(10)||
...
p:=p||'01_list_1,''%null%'',''null'') || '''''''';'||chr(10)||
''||chr(10)||
...
''||chr(10)||
'        v_FieldNames := ''SID,EMERGENCY,CONSENSUAL,US_LOCATION,ITEM_CASE,INFO_TYPE,TECHNIQUE';

p:=p||',REQUESTED_DURATION'';'||chr(10)||
...
p:=p||'                replace(:p21001_list_1,''%null%'',''null'') || '''''''' || '','' || '''''''' ||'||chr(10)||
'                                 replace(:p21001_list_2,''%null%'',''null'') || '''''''' || '','' || '''''''' ||'||chr(10)||
'                                 replace(:p21001_text_9,'''''''','''''''''''') || '''''''';'||chr(10)||
''||chr(10)||
'        v_TableName := ''t_osi_a_surveillance'';'||chr(10)||
'        v_ActivityDate := to_date(to_char(to_date(:p21001_activity_date),''yyyymmdd'') || nvl(:';

p:=p||'p21001_hour,''01'') || nvl(:p21001_minute,''00'') || ''00'', ''yyyymmddhh24miss'');'||chr(10)||
...
p:=p||'   :P21001_FROM_OBJ:=:P21001_FILE_ASSOC;'||chr(10)||
' '||chr(10)||
'     END IF;'||chr(10)||
''||chr(10)||
...
p:=p||'          replace(:p21001_duty_cat,''%null%'',''null''),'||chr(10)||
...
'(activity_date,subject_of_activity,reference_number,restriction,title,narrative,doc_type,results,file_sid,personnel,WH_PAY_CAT,WH_DUTY_CAT,WH_MISSION,WH_DATE,WH_HOURS,COMPLETE,SUBSTANTIVE)'||chr(10)||
'values'||chr(10)||
...
p:=p||' recent_access(v_sid, :user_sid);'||chr(10)||
''||chr(10)||
...
p:=p||'21001_LIST_1_LOV:=''- Select -;%null%,'' || osi_reference.get_lov(''MEDANLY_TYPE'');'||chr(10)||
'                                       :P21001_TEXT_2_LABEL:=''Media Size'';'||chr(10)||
'                                       :P21001_TEXT_3_LABEL:=''Quantity'';'||chr(10)||
'                                       :P21001_LIST_2_LABEL := ''Size Units'';'||chr(10)||
'                                       :P21001_LIST_2_LOV:=''- Select -;%null%,'' || osi_referen';

p:=p||'ce.get_lov(''MEDANLY_UNIT'');'||chr(10)||
'                                       :P21001_RADIOGROUP_1_LABEL:=''Removable?'';'||chr(10)||
'                                       :P21001_DATE_2_LABEL:=''Seizure Date'';'||chr(10)||
'                                       :P21001_DATE_3_LABEL:=''Receive Date'';'||chr(10)||
...
p:=p||'_LABEL:=''Analysis End Date'';'||chr(10)||
'                                       :P21001_TEXT_4_LABEL:=''Comments'';'||chr(10)||
''||chr(10)||
...
p:=p||' ''ACT.RECORDS_CHECK'' THEN'||chr(10)||
...
p:=p||'                               :P21001_LIST_1_LABEL := ''Record Type'';'||chr(10)||
'                                       :P21001_LIST_2_LABEL := ''Records Check Result'';'||chr(10)||
'                                       '||chr(10)||
'                                       :P21001_LIST_2_LOV:=''- Select -;%null%,'';'||chr(10)||
'                                       for a in (select DESCRIPTION d, CODE r from T_OSI_A_RECORDS_CHECK_RESULTS order by ';
...
'                                       :P21001_FIND_WIDGET_SRC:=''<a id="FindP';

p:=p||'artic" href="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','' ||'||chr(10)||
'                                                                ''''''P301_ACTIVE_FILTER_EXCLUDES'''',$v(''''P21001_PARTIC_TYPE_EXCLUDES''''),''''Choose Participant...'''',''''PARTICIPANT'''','''''''');">&ICON_LOCATOR.</a>'';'||chr(10)||
''||chr(10)||
'                 WHEN ''ACT.SEARCH'' THEN'||chr(10)||
'                                       :P21001_ACTIVITY_DATE_LA';

p:=p||'BEL:=''Search Date'';'||chr(10)||
...
'  '||chr(10)||
'                                       :P21001_LIST_2_LABEL := ''Search Based Upo';
...
p:=p||'IST_1_LABEL := ''Interview Type'';'||chr(10)||
'                                       :P21001_TEXT_7_LABEL := ''Commodity'';'||chr(10)||
'                                       :P21001_PARTIC_LABEL:=''Source'';'||chr(10)||
'                                       :P21001_PARTIC_WIDGET_VISIBLE:=''Y'';'||chr(10)||
'                                       :P21001_PARTIC_TYPE_EXCLUDES:='''';'||chr(10)||
'                                       :P21001_FIND_WIDGET_SRC:=''<a href';

p:=p||'="javascript:openLocator(''''301'''',''''P21001_PARTICIPANT'''',''''N'''','''''''',''''OPEN'''','''''' ||'||chr(10)||
...
p:=p||'001_LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.get_lov(''SUSPACT_CATEGORY'');'||chr(10)||
...
p:=p||'ADIOGROUP_2_LABEL:=''Emergency'';'||chr(10)||
...
'                                       :P21001_TEXT_9_LABEL := ''Requested Duratio';
...
'                                       :P21001_ACTIVITY_DATE_LABEL:=''Requested Start Date'';'||chr(10)||
'                                       :P21001_LIST_1_LOV := ''- Select -;%null%,'' || osi_reference.ge';

p:=p||'t_lov(''SUSPACT_CATEGORY'');'||chr(10)||
...
p:=p||'TIVITY_DATE_LABEL:=''Consultation Date'';'||chr(10)||
...
p:=p||'                          exception when others then'||chr(10)||
'         '||chr(10)||
'                                                  null;'||chr(10)||
''||chr(10)||
'                                         end;'||chr(10)||
...
p:=p||'      elsif (substr(:P21001_OBJ_TYPE_CODE,1,16)=''ACT.COORDINATION'') then'||chr(10)||
''||chr(10)||
...
p:=p||'                                                 from V_OSI_COORDIN_CREATE_TYPES order by 1)'||chr(10)||
'                                         loop'||chr(10)||
'                                             :P21001_LIST_1_LOV := :P21001_LIST_1_LOV || replace(a.d, '', '', '' / '') || '';'' || a.r || '',''; '||chr(10)||
'                                         end loop;'||chr(10)||
''||chr(10)||
...
p:=p||'                      select sid into :P21001_LIST_1 from t_core_obj_type where code =''ACT.COORDINATION.FORENSICS'';'||chr(10)||
''||chr(10)||
'                                         exception when others then'||chr(10)||
''||chr(10)||
'                                                  null;'||chr(10)||
...
p:=p||'    :P21001_LIST_2_LOV:=''- Select -;%null%,'' || osi_reference.get_lov(''CONTACT_METHOD'');'||chr(10)||
''||chr(10)||
'                                       else'||chr(10)||
'                                         '||chr(10)||
...
p:=p||'duty_cat_lov := osi_reference.get_lov(''DUTY_CATEGORY'');'||chr(10)||
''||chr(10)||
'end if;'||chr(10)||
''||chr(10)||
