...
wwv_flow_api.create_field_template (
  ...
  p_template_body1=>'<label class="hoverHelp" style="cursor: help" tabindex="999" for="#CURRENT_ITEM_NAME#" rel="" reltitle="" style="font-weight: bold" style="color: #000">'||chr(10)||
'',
