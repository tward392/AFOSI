...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   10:28 Monday July 16, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120716100443',
...
'     v_effective_date := to_date(:p30710_effective_date || '' '' || :p30710_hour || '':'' || :p30710_minute || '':'' || :p30710_seconds, ''DD-MON-YYYY HH24:MI:SS'');'||chr(10)||
''||chr(10)||
'    case :p30710_trans_typ';
...
p:=p||'transfer_evidence(:p30710_trans_sids,'||chr(10)||
'                                           v_effective_date,'||chr(10)||
'                                           :p30710_purpose,'||chr(10)||
...
p:=p||'dispose_evidence(:p30710_trans_sids,'||chr(10)||
'                                          v_effective_date,'||chr(10)||
'                                          :p30710_purpose,'||chr(10)||
'                                          :p30710_condition_change);'||chr(10)||
