...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   06:03 Friday September 14, 2012
--   Exported By:     ADMIN
--   Flashback:       0
...
'',
  ...
  p_last_upd_yyyymmddhh24miss => '20120914055849',
...
wwv_flow_api.create_page_validation(
  ...
  p_validation_condition=> ':REQUEST IN (''REJECT'',''SPLIT'',''UNDISPOSE'',''LOGIN'')',
...
p:=p||'ODE not in (''X'',''T'',''C'') then'||chr(10)||
...
'      :P30700_FINAL_DISP_RO := ''readOnly style="background-color:#f5f4ea; width:100%;"'';'||chr(10)||
'   else'||chr(10)||
'      :P30700_FINAL_DISP_RO := ''style="width:100%;"'';';
