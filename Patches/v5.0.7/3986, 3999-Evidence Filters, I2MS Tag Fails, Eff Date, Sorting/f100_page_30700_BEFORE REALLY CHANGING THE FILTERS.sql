...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   13:59 Thursday July 12, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120712135842',
...
'<a class="htmlButton" onclick="mySubmit(''APPLY_FILTERS'',this);" style="float:none; margin:0px 0px 0px 15px;" href="javascript:doSubmit(''APPLY_FILTERS'')">Apply Filters Changes</a>'||chr(10)||
'<br>',
  p_plug_footer=> '</div>',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
...
'                   or s.code <> ''D''))',
  ...
  p_cHeight=> 5,
  p_cAttributes=> 'nowrap',
  p_cattributes_element=>'style="width:95%"',
