...
prompt  ...PAGE 21505: Records Check Details
--
...
wwv_flow_api.create_page_plug (
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21505,
  p_plug_name=> 'Records Check Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 92559128788674070 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21505,
  p_plug_name=> 'Hidden',
  p_region_name=>'',
...
wwv_flow_api.create_page_branch(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 21505,
  p_branch_action=> 'f?p=&APP_ID.:21505:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
...
wwv_flow_api.create_page_item(
  ...
  p_source=>'select to_char(activity_date, ''&FMT_DATE.'') from t_osi_activity where sid = :p21505_sid',
  p_source_type=> 'QUERY',
  p_display_as=> 'TEXT',
  p_lov_columns=> 1,
...
wwv_flow_api.create_page_item(
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 92559128788674070+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Sid',
  p_source=>'SID',
...
begin
wwv_flow_api.create_page_item(
  p_id=>92558715282670162 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 21505,
  p_name=>'P21505_DOCUMENT_TYPE_LOV',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  p_item_plug_id => 92559128788674070+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  ...
  p_lov => 'STATIC2:&P21505_DOCUMENT_TYPE_LOV.',
  p_lov_columns=> 1,
...
wwv_flow_api.create_page_validation(
  ...
  p_validation => 'P21505_DOCUMENT_TYPE',
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => 'A Document Type must be selected from the list.',
  p_when_button_pressed=> 92094015476224306 + wwv_flow_api.g_id_offset,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:T_OSI_A_RECORDS_CHECK:P21505_SID:SID';

wwv_flow_api.create_page_process(
  p_id     => 91889016344583976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 21505,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from T_OSI_A_RECORDS_CHECK',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:T_OSI_A_RECORDS_CHECK:P21505_SID:SID|U';

wwv_flow_api.create_page_process(
  p_id     => 91889217844583976 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 21505,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of T_OSI_A_RECORDS_CHECK',
  p_process_sql_clob => p, 
...
'      set activity_date = :p21505_activity_date'||chr(10)||
'    where SID = :p21505_sid;'||chr(10)||
''||chr(10)||
'   commit;'||chr(10)||
'end;';
...
begin
p:=p||'begin'||chr(10)||
'  :p21505_sid := :p0_obj;'||chr(10)||
'  :P21505_DOCUMENT_TYPE_LOV := osi_reference.get_lov(''LERC_DOCTYPE'');'||chr(10)||
'end;';
