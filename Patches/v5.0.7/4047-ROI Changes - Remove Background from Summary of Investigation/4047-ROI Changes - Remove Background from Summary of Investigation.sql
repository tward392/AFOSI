---- No Title Block (Background Field) Information Checklist Item ----
DELETE FROM T_OSI_CHECKLIST_ITEM_TYPE_MAP WHERE SID='22200000I4B';
COMMIT;

INSERT INTO T_CORE_TEMPLATE ( SID, TEMPLATE_NAME, TEMPLATE_INFO, MIME_TYPE, MIME_DISPOSITION, CREATE_BY, CREATE_ON, MODIFY_BY, MODIFY_ON ) VALUES ( '33318Q8R', 'SUMMARY_COMPLAINT_RPT', NULL, NULL, 'ATTACHMENT', 'timothy.ward',  TO_Date( '06/04/2012 11:37:28 AM', 'MM/DD/YYYY HH:MI:SS AM'), 'timothy.ward',  TO_Date( '06/04/2012 11:41:59 AM', 'MM/DD/YYYY HH:MI:SS AM')); 
COMMIT;

update t_osi_status_change_proc set active='N' where proc_to_use='OSI_STATUS_PROC.AUTOFILL_SUMMARY_INV';
COMMIT;
...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:45 Tuesday June 12, 2012
--   Exported By:     TWARD
--   Flashback:       0
...
'function clearUnits()'||chr(10)||
'{'||chr(10)||
' var before = $(''#P11105_NOTIFY_UNITS'').val();'||chr(10)||
''||chr(10)||
' $(''#P11105_NOTIFY_UNITS_DISPLAY'').find(''option'').remove();'||chr(10)||
' $(''#P11105_NOTIFY_UNITS'').val('''');'||chr(10)||
''||chr(10)||
' if(before!=$(''#P11105_NOTIFY_UNITS'').val())'||chr(10)||
'   setDirty();'||chr(10)||
'}'||chr(10)||
''||chr(10)||
'function removeUnits()'||chr(10)||
'{'||chr(10)||
' var before ';

ph:=ph||'= $(''#P11105_NOTIFY_UNITS'').val();'||chr(10)||
''||chr(10)||
' $(''#P11105_NOTIFY_UNITS_DISPLAY option:selected'').each(function()'||chr(10)||
'  {'||chr(10)||
'   $(''#P11105_NOTIFY_UNITS'').val($(''#P11105_NOTIFY_UNITS'').val().replace($(this).val(),''''));'||chr(10)||
'   $(''#P11105_NOTIFY_UNITS'').val($(''#P11105_NOTIFY_UNITS'').val().replace(''::'','':''));'||chr(10)||
'  });'||chr(10)||
''||chr(10)||
'  $(''#P11105_NOTIFY_UNITS_DISPLAY option:selected'').remove();'||chr(10)||
''||chr(10)||
' if(before!=$(''#P11105_NOTIFY_UNITS'').val())'||chr(10)||
'';

ph:=ph||'   setDirty();'||chr(10)||
'}'||chr(10)||
'</script>';
...
' $(''.title'').hide();'||chr(10)||
''||chr(10)||
' if($(''#P0_WRITABLE'').val()==''N'')'||chr(10)||
'    {'||chr(10)||
'     $(''#clearUnits'').hide();'||chr(10)||
'     $(''#removeUnits'').hide();'||chr(10)||
'     $(''#addUnits'').hide();'||chr(10)||
'    }'||chr(10)||
'});'||chr(10)||
'</script>',
  ...
  p_last_upd_yyyymmddhh24miss => '20120612084255',
...
''||chr(10)||
'04-Jun-2012 - Tim Ward - CR#4047 - Remove Background field.  (Just hide'||chr(10)||
'                                    it in-case they ever want it back).'||chr(10)||
'                                    Re-designed whole screen to look'||chr(10)||
'                                    more like legacy.  Changed the'||chr(10)||
'                                    clear/remove units buttons to not'||chr(10)||
'                                    do a submit.'||chr(10)||
''||chr(10)||
'');
...
wwv_flow_api.create_page_plug (
  p_id=> 14536625947139833 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 11105,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 14538407003266821 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 11105,
  p_plug_name=> 'Type/Mission',
  p_region_name=>'',
  ...
  p_plug_header=> '<table id="TypeMissionSpecInterestTable" width="100%">'||chr(10)||
'<tr>'||chr(10)||
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 14538621894271111 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 11105,
  p_plug_name=> 'Special Interest/Units',
  p_region_name=>'',
  p_plug_template=> 0,
  p_plug_display_sequence=> 12.1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
  p_plug_source_type=> 'STATIC_TEXT',
...
wwv_flow_api.create_page_plug (
  ...
  p_region_name=>'',
  p_region_attributes=>'style="width: 100%; colspan=2;"',
  p_plug_template=> 179216655889554481+ wwv_flow_api.g_id_offset,
  ...
  p_plug_query_row_count_max => 500,
  p_plug_column_width => 'style="width: 100%; colspan=2;"',
...
begin
wwv_flow_api.create_page_item(
  p_id=>14547317531055247 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11105,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 4,
  p_item_plug_id => 14538407003266821+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Timeliness Target',
...
wwv_flow_api.create_page_item(
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 4,
  p_item_plug_id => 14536625947139833+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Background',
...
wwv_flow_api.create_page_item(
  ...
  p_item_plug_id => 94010024002215012+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default => '*** NOTE: The summary should include the initial notification, all pertinent information, and key '||chr(10)||
'investigative results.  This means the summary should only include corroborative or exculpatory '||chr(10)||
'information such as, but not limited to, key witness statements and evidence / lab results that directly '||chr(10)||
'support the elements of proof.  There should be no extraneous information or fluff included into the '||chr(10)||
'summary.  Agents will not cut and paste interview narratives directly into the summary.  The summary '||chr(10)||
'should be a concise and independent synopsis of the investigation.  The summary will not exceed one '||chr(10)||
'page.  Delete – Do not place this informational paragraph into the official Summary.',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_pre_element_text=>'<b><div id="P11105_LABEL_TEST" style="float:left;">Summary of Investigation</div>'||chr(10)||
'<div id="P11105_FULL_ID_DISPLAY" style="float:right;">&P11105_FULL_ID.</div></b>',
...
' where code like ''FILE.INV.%''',
  ...
  p_cAttributes=> 'nowrap',
  p_cattributes_element=>'style="width:100%;"',
  p_tag_attributes  => '&P11105_DISABLED_HTML. style="width:100%;"',
  p_tag_attributes2=> 'style="width:100%;"',
  p_begin_on_new_line => 'YES',
  p_begin_on_new_field=> 'YES',
  p_colspan => 2,
...
wwv_flow_api.create_page_item(
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 14,
  p_item_plug_id => 14538621894271111+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default => 'U',
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Special Interest',
  p_pre_element_text=>'<div class="scrollChecklist" style="height:300px;">',
...
wwv_flow_api.create_page_item(
  ...
  p_cMaxlength=> 2000,
  p_cHeight=> 5,
  p_cAttributes=> 'style="padding: 7px 0px 0px 0px;" nowrap',
  p_cattributes_element=>'valign="top"',
  p_begin_on_new_line => 'YES',
  p_begin_on_new_field=> 'YES',
  p_colspan => 1,
  p_rowspan => 1,
...
wwv_flow_api.create_page_item(
  ...
  p_post_element_text=>'<br>'||chr(10)||
'<a id="clearUnits" class="htmlButton" href="javascript:clearUnits();">Clear</a>'||chr(10)||
'<a id="removeUnits" class="htmlButton" href="javascript:removeUnits();">Remove</a>'||chr(10)||
'<a id="addUnits" class="htmlButton" href="javascript:openLocator(''301'',''P11105_NOTIFY_UNITS_ADD'',''Y'',''&P11105_NOTIFY_UNITS.'',''OPEN'','''','''',''Choose Units to Notify...'',''UNITS'',''&P0_OBJ.'');">&BTN_ADD.</a>'||chr(10)||
'',
  p_source_type=> 'STATIC',
...
' where instr(:P11105_NOTIFY_UNITS, sid)>0',
  ...
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => 'style="width:250px;"');
...
wwv_flow_api.create_page_item(
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 11105,
  p_name=>'P11105_TIMELINESS_DATE_DISPLAY',
  p_data_type=> 'VARCHAR',
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 5,
  p_item_plug_id => 14538407003266821+wwv_flow_api.g_id_offset,
  ...
  p_item_default_type => 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Timeliness Target',
  p_post_element_text=>'<b>&P11105_TIMELINESS_DATE.</b>',
  p_source_type=> 'STATIC',
