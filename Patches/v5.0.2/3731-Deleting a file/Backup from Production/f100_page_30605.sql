...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   08:42 Friday March 18, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
'      var pageName = ''EVID_STATUS'';'||chr(10)||
'      var itemNames = ''P30610_STATUS_CHANGE,P30610_EVIDENCE_SID,P30610_STATU';

ph:=ph||'S_CHANGE_DESC'';'||chr(10)||
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110207120103',
  p_page_is_public_y_n=> 'N',
  p_protection_level=> 'N',
  p_page_comment  => '06-DEC-2010 J.FARIS - WCHG0000386 - updates to address widget, removed read-only condition from date received (not necessary when SAVE not available).');
...
begin
p:=p||'declare'||chr(10)||
'  delete_error exception;'||chr(10)||
'begin'||chr(10)||
'if osi_object.delete_object(:p30605_sid) <> ''Y'' then'||chr(10)||
'   raise delete_error;'||chr(10)||
'end if;'||chr(10)||
...
wwv_flow_api.create_page_process(
  p_id     => 9226330611694245 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30605,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '&FAILURE_MSG.',
  p_process_when_button_id=>9225702729648371 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '&SUCCESS_MSG.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
