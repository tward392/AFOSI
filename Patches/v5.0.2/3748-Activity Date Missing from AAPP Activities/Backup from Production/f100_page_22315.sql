...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:49 Tuesday March 15, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20101206144250',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:T_OSI_A_AAPP_ACTIVITY:P22315_SID:SID|U';
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:T_OSI_A_AAPP_ACTIVITY:P22315_SID:SID';
