...
--   Application:     100
--   Name:            Web-I2MS
--   Date and Time:   11:22 Friday March 4, 2011
--   Exported By:     TWARD
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_last_upd_yyyymmddhh24miss => '20110303131720',
...
'       end if;'||chr(10)||
''||chr(10)||
'       if length(:P101_PERSONNEL_NUM)=4 then';
...
p:=p||'           v_return,v_display_msg);'||chr(10)||
''||chr(10)||
