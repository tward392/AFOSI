...
(SID, ID, TITLE, CREATE_ON, CREATE_BY, 
 ...
 LEADERSHIP_APPROVED, READY_FOR_REVIEW, ACTIVITY_DATE_RANGE)
AS 
select a.sid, a.id, a.title, o.create_on, o.create_by, a.restriction, 
           ...
           leadership_approved,
           ready_for_review,
           decode(ot.code, 'ACT.RECORDS_CHECK', osi_records_check.get_review_date(a.sid),decode(ot.code, 'ACT.DOCUMENT_REVIEW', osi_document_review.get_review_date(a.sid), to_char(a.activity_date,'DD-Mon-YYYY'))) as activity_date_range
