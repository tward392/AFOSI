/*
    ...
    History:
        ...
        01-Nov-2012 Tim Ward   Removed initNav and dtHideExcept, not needed with new desktop pages and templates.

        03-Jan-2013 Tim Ward   Added the close Code to the DIalog initialization, this prevents
                                having to hit cancel multiple times after the wescape or the dialog
                                title bar X button are used to close the dialog initially.
*/
